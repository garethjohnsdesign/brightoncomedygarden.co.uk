...
"use strict";function m(e,t,n){var i,o=(t=t||ae).createElement("script");if(o.text=e,n)for(i in we)n[i]&&(o[i]=n[i]);t.head.appendChild(o).parentNode.removeChild(o)}function v(e){return null==e?e+"":"object"==typeof e||"function"==typeof e?fe[pe.call(e)]||"object":typeof e;
...
function i(){ae.removeEventListener("DOMContentLoaded",i),C.removeEventListener("load",i),Te.ready()}
...
function p(e){return e.replace(He,"ms-").replace(qe,o)}function r(){this.expando=Te.expando+r.uid++}function a(e){return"true"===e||"false"!==e&&("null"===e?null:
...
Fe.set(e,t,n)}else n=void 0;return n}function g(e,t,n,i){var o,r,a=20,s=i?function(){return i.cur()}:function(){return Te.css(e,t,"")},l=s(),u=n&&n[3]||(Te.cssNumber[t]?"":"px"),
...
Te.style(e,t,c+u),(1-r)*(1-(r=s()/l||.5))<=0&&(a=0),c/=r;c*=2,Te.style(e,t,c+u),
...
for(var n,i,o=[],r=0,a=e.length;r<a;r++)(i=e[r]).style&&(n=i.style.display,t?(
// Since we force visibility upon cascade-hidden elements, an immediate (and slow)
// check is required in this first loop unless we have a nonempty display value (either
// inline or about-to-be-restored)
"none"===n&&(o[r]=Ne.get(i,"display")||null,o[r]||(i.style.display="")),""===i.style.display&&Xe(i)&&(o[r]=y(i))):"none"!==n&&(o[r]="none",
// Remember what we're overwriting
Ne.set(i,"display",n)));
// Set the display of the elements in a second loop to avoid constant reflow
for(r=0;r<a;r++)null!=o[r]&&(e[r].style.display=o[r]);return e}function w(e,t){
...
function x(e,t){for(var n=0,i=e.length;n<i;n++)Ne.set(e[n],"globalEval",!t||Ne.get(t[n],"globalEval"))}function T(e,t,n,i,o){for(var r,a,s,l,u,c,d=t.createDocumentFragment(),f=[],p=0,h=e.length;p<h;p++)if((r=e[p])||0===r)
// Add nodes directly
if("object"===v(r))
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
Te.merge(f,r.nodeType?[r]:r);
// Convert non-html into a text node
else if(tt.test(r)){for(a=a||d.appendChild(t.createElement("div")),
// Deserialize a standard representation
s=(Ze.exec(r)||["",""])[1].toLowerCase(),l=et[s]||et._default,a.innerHTML=l[1]+Te.htmlPrefilter(r)+l[2],
// Descend through wrappers to the right content
c=l[0];c--;)a=a.lastChild;
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
...
a=d.firstChild).textContent=""}else f.push(t.createTextNode(r));
// Convert html into DOM nodes
// Remove wrapper from fragment
for(d.textContent="",p=0;r=f[p++];)
// Skip elements already in the context collection (trac-4087)
if(i&&-1<Te.inArray(r,i))o&&o.push(r);else
// Capture executables
if(u=Te.contains(r.ownerDocument,r),
// Append to fragment
a=w(d.appendChild(r),"script"),
// Preserve script evaluation history
u&&x(a),n)for(c=0;r=a[c++];)Je.test(r.type||"")&&n.push(r);return d}function k(){return!0}function E(){return!1}
// Support: IE <=9 only
// See #13393 for more info
function S(){try{return ae.activeElement}catch(e){}}function $(e,t,n,i,o,r){var a,s;
// Types can be a map of types/handlers
if("object"==typeof t){for(s in
// ( types-Object, selector, data )
"string"!=typeof n&&(
// ( types-Object, data )
i=i||n,n=void 0),t)$(e,s,n,i,t[s],r);return e}if(null==i&&null==o?(
// ( types, fn )
o=n,i=n=void 0):null==o&&("string"==typeof n?(
// ( types, selector, fn )
o=i,i=void 0):(
// ( types, data, fn )
o=i,i=n,n=void 0)),!1===o)o=E;else if(!o)return e;return 1===r&&(a=o,
// Use same guid so caller can remove using origFn
(o=function(e){
// Can use an empty set, since event contains the info
return Te().off(e),a.apply(this,arguments)}).guid=a.guid||(a.guid=Te.guid++)),e.each(function(){Te.event.add(this,t,o,i,n)})}
/*
...
function O(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function _(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function z(e,t){var n,i,o,r,a,s,l,u;if(1===t.nodeType){
// 1. Copy private data: events, handlers, etc.
if(Ne.hasData(e)&&(r=Ne.access(e),a=Ne.set(t,r),u=r.events))for(o in delete a.handle,a.events={},u)for(n=0,i=u[o].length;n<i;n++)Te.event.add(t,o,u[o][n]);
// 2. Copy user data
Fe.hasData(e)&&(s=Fe.access(e),l=Te.extend({},s),Fe.set(t,l))}}
// Fix IE bugs, see support tests
function P(e,t){var n=t.nodeName.toLowerCase();
// Fails to persist the checked state of a cloned checkbox or radio button.
"input"===n&&Qe.test(e.type)?t.checked=e.checked:"input"!==n&&"textarea"!==n||(t.defaultValue=e.defaultValue)}function M(n,i,o,r){
// Flatten any nested arrays
i=ue.apply([],i);var e,t,a,s,l,u,c=0,d=n.length,f=d-1,p=i[0],h=ye(p);
// We can't cloneNode fragments that contain checked, in WebKit
if(h||1<d&&"string"==typeof p&&!ge.checkClone&&dt.test(p))return n.each(function(e){var t=n.eq(e);h&&(i[0]=p.call(this,e,t.html())),M(t,i,o,r)});if(d&&(t=(e=T(i,n[0].ownerDocument,!1,n,r)).firstChild,1===e.childNodes.length&&(e=t),t||r)){
// Use the original fragment for the last item
// instead of the first because it can end up
// being emptied incorrectly in certain situations (#8070).
for(s=(a=Te.map(w(e,"script"),O)).length;c<d;c++)l=e,c!==f&&(l=Te.clone(l,!0,!0),
// Keep references to cloned scripts for later restoration
s&&
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
Te.merge(a,w(l,"script"))),o.call(n[c],l,c);if(s)
// Evaluate executable scripts on first document insertion
for(u=a[a.length-1].ownerDocument,
// Reenable scripts
Te.map(a,_),c=0;c<s;c++)l=a[c],Je.test(l.type||"")&&!Ne.access(l,"globalEval")&&Te.contains(u,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?
// Optional AJAX dependency, but won't run scripts if not present
Te._evalUrl&&Te._evalUrl(l.src):m(l.textContent.replace(ft,""),u,l))}return n}function L(e,t,n){for(var i,o=t?Te.filter(t,e):e,r=0;null!=(i=o[r]);r++)n||1!==i.nodeType||Te.cleanData(w(i)),i.parentNode&&(n&&Te.contains(i.ownerDocument,i)&&x(w(i,"script")),i.parentNode.removeChild(i));return e}function A(e,t,n){var i,o,r,a,
// Support: Firefox 51+
...
return(n=n||ht(e))&&(""!==(a=n.getPropertyValue(t)||n[t])||Te.contains(e.ownerDocument,e)||(a=Te.style(e,t)),
// A tribute to the "awesome hack by Dean Edwards"
// Android Browser returns percentage for some values,
// but width seems to be reliably pixels.
// This is against the CSSOM draft spec:
// https://drafts.csswg.org/cssom/#resolved-values
!ge.pixelBoxStyles()&&pt.test(a)&&mt.test(t)&&(
// Remember the original values
i=s.width,o=s.minWidth,r=s.maxWidth,
// Put in the new values to get a computed value out
s.minWidth=s.maxWidth=s.width=a,a=n.width,
// Revert the changed values
s.width=i,s.minWidth=o,s.maxWidth=r)),void 0!==a?
// Support: IE <=9 - 11 only
...
Math.max(0,i[2]-(n||0))+(i[3]||"px"):t}function R(e,t,n,i,o,r){var a="width"===t?1:0,s=0,l=0;
// Adjustment may not be necessary
if(n===(i?"border":"content"))return 0;for(;a<4;a+=2)
// Both box models exclude margin
"margin"===n&&(l+=Te.css(e,n+Ve[a],!0,o)),
// If we get here with a content-box, we're seeking "padding" or "border" or "margin"
i?(
// For "content", subtract padding
"content"===n&&(l-=Te.css(e,"padding"+Ve[a],!0,o)),
// For "content" or "padding", subtract border
"margin"!==n&&(l-=Te.css(e,"border"+Ve[a]+"Width",!0,o))):(
// Add padding
l+=Te.css(e,"padding"+Ve[a],!0,o),
// For "border" or "margin", add border
"padding"!==n?l+=Te.css(e,"border"+Ve[a]+"Width",!0,o):s+=Te.css(e,"border"+Ve[a]+"Width",!0,o));
// Account for positive content-box scroll gutter when requested by providing computedVal
return!i&&0<=r&&(
// offsetWidth/offsetHeight is a rounded sum of content, padding, scroll gutter, and border
// Assuming integer scroll gutter, subtract the rest and round down
l+=Math.max(0,Math.ceil(e["offset"+t[0].toUpperCase()+t.slice(1)]-r-l-s-.5))),l}function N(e,t,n){
// Start with computed style
var i=ht(e),o=A(e,t,i),r="border-box"===Te.css(e,"boxSizing",!1,i),a=r;
// Support: Firefox <=54
...
a=!0),(
// Normalize "" and auto
o=parseFloat(o)||0)+R(e,t,n||(r?"border":"content"),a,i,
// Provide the current computed size to request scroll gutter calculation (gh-3589)
o)+"px"}function F(e,t,n,i,o){return new F.prototype.init(e,t,n,i,o)}function B(){Ct&&(!1===ae.hidden&&C.requestAnimationFrame?C.requestAnimationFrame(B):C.setTimeout(B,Te.fx.interval),Te.fx.tick())}
...
for(t=t?1:0;i<4;i+=2-t)o["margin"+(n=Ve[i])]=o["padding"+n]=e;return t&&(o.opacity=o.width=e),o}function Y(e,t,n){for(var i,o=(U.tweeners[t]||[]).concat(U.tweeners["*"]),r=0,a=o.length;r<a;r++)if(i=o[r].call(n,t,e))
// We're done with this property
return i}function V(e,t,n){var i,o,r,a,s,l,u,c,d="width"in t||"height"in t,f=this,p={},h=e.style,m=e.nodeType&&Xe(e),v=Ne.get(e,"fxshow");
// Queue-skipping animations hijack the fx hooks
// Detect show/hide animations
for(i in n.queue||(null==(a=Te._queueHooks(e,"fx")).unqueued&&(a.unqueued=0,s=a.empty.fire,a.empty.fire=function(){a.unqueued||s()}),a.unqueued++,f.always(function(){
// Ensure the complete handler is called before this completes
f.always(function(){a.unqueued--,Te.queue(e,"fx").length||a.empty.fire()})})),t)if(o=t[i],kt.test(o)){if(delete t[i],r=r||"toggle"===o,o===(m?"hide":"show")){
// Pretend to be hidden if this is a "show" and
// there is still data from a stopped show/hide
if("show"!==o||!v||void 0===v[i])continue;m=!0}p[i]=v&&v[i]||Te.style(e,i)}
// Bail out if this is a no-op like .hide().hide()
if((l=!Te.isEmptyObject(t))||!Te.isEmptyObject(p))for(i in
...
m||b([e]),Ne.remove(e,"fxshow"),p)Te.style(e,i,p[i])})),
// Per-property setup
l=Y(m?v[i]:0,i,f),i in v||(v[i]=l.start,m&&(l.end=l.start,l.start=0))}function X(e,t){var n,i,o,r,a;
// camelCase, specialEasing and expand cssHook pass
for(n in e)if(o=t[i=p(n)],r=e[n],Array.isArray(r)&&(o=r[1],r=e[n]=r[0]),n!==i&&(e[i]=r,delete e[n]),(a=Te.cssHooks[i])&&"expand"in a)
// Not quite $.extend, this won't overwrite existing keys.
// Reusing 'index' because we have the correct "name"
for(n in r=a.expand(r),delete e[i],r)n in e||(e[n]=r[n],t[n]=o);else t[i]=o}function U(a,e,t){var n,s,i=0,o=U.prefilters.length,l=Te.Deferred().always(function(){
// Don't match elem in the :animated selector
delete r.elem}),r=function(){if(s)return!1;for(var e=Tt||G(),t=Math.max(0,u.startTime+u.duration-e),
// Support: Android 2.3 only
// Archaic crash bug won't allow us to use `1 - ( 0.5 || 0 )` (#12497)
n,i=1-(t/u.duration||0),o=0,r=u.tweens.length;o<r;o++)u.tweens[o].run(i);
// If there's more to do, yield
return l.notifyWith(a,[u,i,t]),i<1&&r?t:(
// If this was an empty animation, synthesize a final progress notification
r||l.notifyWith(a,[u,1,0]),
// Resolve the animation and report its conclusion
l.resolveWith(a,[u]),!1)},u=l.promise({elem:a,props:Te.extend({},e),opts:Te.extend(!0,{specialEasing:{},easing:Te.easing._default},t),originalProperties:e,originalOptions:t,startTime:Tt||G(),duration:t.duration,tweens:[],createTween:function(e,t){var n=Te.Tween(a,u.opts,e,t,u.opts.specialEasing[e]||u.opts.easing);return u.tweens.push(n),n},stop:function(e){var t=0,
// If we are going to the end, we want to run all the tweens
// otherwise we skip this part
n=e?u.tweens.length:0;if(s)return this;for(s=!0;t<n;t++)u.tweens[t].run(1);
// Resolve when we played the last frame; otherwise, reject
return e?(l.notifyWith(a,[u,1,0]),l.resolveWith(a,[u,e])):l.rejectWith(a,[u,e]),this}}),c=u.props;for(X(c,u.opts.specialEasing);i<o;i++)if(n=U.prefilters[i].call(u,a,c,u.opts))return ye(n.stop)&&(Te._queueHooks(u.elem,u.opts.queue).stop=n.stop.bind(n)),n;return Te.map(c,Y,u),ye(u.opts.start)&&u.opts.start.call(a,u),
// Attach callbacks from options
u.progress(u.opts.progress).done(u.opts.done,u.opts.complete).fail(u.opts.fail).always(u.opts.always),Te.fx.timer(Te.extend(r,{elem:a,anim:u,queue:u.opts.queue})),u}
...
function te(t,o,r,a){function s(e){var i;return l[e]=!0,Te.each(t[e]||[],function(e,t){var n=t(o,r,a);return"string"!=typeof n||u||l[n]?u?!(i=n):void 0:(o.dataTypes.unshift(n),s(n),!1)}),i}var l={},u=t===Qt;return s(o.dataTypes[0])||!l["*"]&&s("*")}
...
for(o in n){if(!l[0]||e.converters[o+" "+l[0]]){r=o;break}a||(a=o)}
 ...
 */function oe(e,t,n,i){var o,r,a,s,l,u={},
...
if(a&&e.throws)t=a(t);else try{t=a(t)}catch(e){return{state:"parsererror",error:a?e:"No conversion from "+l+" to "+r}}}return{state:"success",data:t}}var re=[],ae=C.document,se=Object.getPrototypeOf,le=re.slice,ue=re.concat,ce=re.push,de=re.indexOf,fe={},pe=fe.toString,he=fe.hasOwnProperty,me=he.toString,ve=me.call(Object),ge={},ye=function e(t){
...
push:ce,sort:re.sort,splice:re.splice},Te.extend=Te.fn.extend=function(e){var t,n,i,o,r,a,s=e||{},l=1,u=arguments.length,c=!1;
...
c&&o&&(Te.isPlainObject(o)||(r=Array.isArray(o)))?(a=r?(r=!1,i&&Array.isArray(i)?i:[]):i&&Te.isPlainObject(i)?i:{},
// Never move original objects, clone them
s[n]=Te.extend(c,a,o)):void 0!==o&&(s[n]=o));
...
makeArray:function(e,t){var n=t||[];return null!=e&&(s(Object(e))?Te.merge(n,"string"==typeof e?[e]:e):ce.call(n,e)),n},inArray:function(e,t,n){return null==t?-1:de.call(t,e,n)},
// Support: Android <=4.0 only, PhantomJS 1 only
// push.apply(_, arraylike) throws on ancient WebKit
merge:function(e,t){for(var n=+t.length,i=0,o=e.length;i<n;i++)e[o++]=t[i];return e.length=o,e},grep:function(e,t,n){
// Go through the array, only saving the items
// that pass the validator function
for(var i,o=[],r=0,a=e.length,s=!n;r<a;r++)(i=!t(e[r],r))!==s&&o.push(e[r]);return o},
// arg is for internal usage only
map:function(e,t,n){var i,o,r=0,a=[];
...
support:ge}),"function"==typeof Symbol&&(Te.fn[Symbol.iterator]=re[Symbol.iterator]),
 ...
 * Date: 2016-08-08
 */
function(n){function w(e,t,n,i){var o,r,a,s,l,u,c,d=t&&t.ownerDocument,
...
// TODO: identify versions
// getElementById can match elements by name instead of ID
if(d&&(a=d.getElementById(o))&&q(t,a)&&a.id===o)return n.push(a),n;
// Type selector
...
(s=t.getAttribute("id"))?s=s.replace(xe,Te):t.setAttribute("id",s=R),r=(
// Prefix every selector in the list
u=S(e)).length;r--;)u[r]="#"+s+" "+h(u[r]);c=u.join(","),
 ...
 * @param {Function} fn
 */function s(a){return l(function(r){return r=+r,l(function(e,t){
...
function(e,t,n){var i,o,r,a=[F,f];
// We can't set arbitrary data on XML nodes, so they don't benefit from combinator caching
if(n){for(;e=e[l];)if((1===e.nodeType||d)&&s(e,t,n))return!0}else for(;e=e[l];)if(1===e.nodeType||d)if(
// Support: IE <9 only
// Defend against cloned attroperties (jQuery gh-1709)
o=(r=e[R]||(e[R]={}))[e.uniqueID]||(r[e.uniqueID]={}),u&&u===e.nodeName.toLowerCase())e=e[l]||e;else{if((i=o[c])&&i[0]===F&&i[1]===f)
// Assign to newCache so results back-propagate to previous elements
return a[2]=i[2];
// A match means we're done; a fail means we have to keep checking
if((
// Reuse newcache so results back-propagate to previous elements
o[c]=a)[2]=s(e,t,n))return!0}return!1}}function f(o){return 1<o.length?function(e,t,n){for(var i=o.length;i--;)if(!o[i](e,t,n))return!1;return!0}:o[0]}function y(e,t,n){for(var i=0,o=t.length;i<o;i++)w(e,t[i],n);return n}function x(e,t,n,i,o){for(var r,a=[],s=0,l=e.length,u=null!=t;s<l;s++)(r=e[s])&&(n&&!n(r,i,o)||(a.push(r),u&&t.push(s)));return a}function b(p,h,m,v,g,e){return v&&!v[R]&&(v=b(v)),g&&!g[R]&&(g=b(g,e)),l(function(e,t,n,i){var o,r,a,s=[],l=[],u=t.length,
...
r=o.length;r--;)(a=o[r])&&(f[l[r]]=!(d[l[r]]=a));if(e){if(g||p){if(g){for(
// Get the final matcherOut by condensing this intermediate into postFinder contexts
o=[],r=f.length;r--;)(a=f[r])&&
// Restore matcherIn since elem is not yet a final match
o.push(d[r]=a);g(null,f=[],o,i)}
// Move matched elements from seed to results to keep them synchronized
for(r=f.length;r--;)(a=f[r])&&-1<(o=g?ee(e,a):s[r])&&(e[o]=!(t[o]=a))}
// Add elements to results, through postFinder if defined
}else f=x(f===t?f.splice(u,f.length):f),g?g(null,t,f,i):Z.apply(t,f)})}function m(e){for(var o,t,n,i=e.length,r=C.relative[e[0].type],a=r||C.relative[" "],s=r?1:0,
// The foundational matcher ensures that elements are reachable from top-level context(s)
l=d(function(e){return e===o},a,!0),u=d(function(e){return-1<ee(o,e)},a,!0),c=[function(e,t,n){var i=!r&&(n||t!==O)||((o=t).nodeType?l(e,t,n):u(e,t,n));
// Avoid hanging onto element (issue #299)
return o=null,i}];s<i;s++)if(t=C.relative[e[s].type])c=[d(f(c),t)];else{
// Return special upon seeing a positional matcher
if((t=C.filter[e[s].type].apply(null,e[s].matches))[R]){for(
// Find the next relative operator (if any) for proper handling
n=++s;n<i&&!C.relative[e[n].type];n++);return b(1<s&&f(c),1<s&&h(
// If the preceding token was a descendant combinator, insert an implicit any-element `*`
e.slice(0,s-1).concat({value:" "===e[s-2].type?"*":""})).replace(se,"$1"),t,s<n&&m(e.slice(s,n)),n<i&&m(e=e.slice(n)),n<i&&h(e))}c.push(t)}return f(c)}function v(v,g){var y=0<g.length,b=0<v.length,e=function(e,t,n,i,o){var r,a,s,l=0,u="0",c=e&&[],d=[],f=O,
...
for(o&&(O=t===M||t||o);u!==m&&null!=(r=p[u]);u++){if(b&&r){for(a=0,t||r.ownerDocument===M||(P(r),n=!A);s=v[a++];)if(s(r,t||M,n)){i.push(r);break}o&&(F=h)}
...
// numerically zero.
if(l+=u,y&&u!==l){for(a=0;s=g[a++];)s(c,d,t,n);if(e){
...
return o&&(F=h,O=f),c};return y?l(e):e}var g,T,C,k,E,S,$,j,O,_,z,
// Local document vars
P,M,L,A,D,I,H,q,
...
C.find.ID=function(e,t){if(void 0!==t.getElementById&&A){var n,i,o,r=t.getElementById(e);if(r){if((
...
H.call(e,"[s!='']:x"),I.push("!=",re)}),D=D.length&&new RegExp(D.join("|")),I=I.length&&new RegExp(I.join("|")),
/* Contains
	---------------------------------------------------------------------- */
...
if(e===t)return z=!0,0;var n,i=0,o=e.parentNode,r=t.parentNode,a=[e],s=[t];
// Parentless nodes are either documents or disconnected
if(!o||!r)return e===M?-1:t===M?1:o?-1:r?1:_?ee(_,e)-ee(_,t):0;
// If the nodes are siblings, we can do a quick check
// Otherwise we need full lists of their ancestors for comparison
if(o===r)return u(e,t);for(n=e;n=n.parentNode;)a.unshift(n);for(n=t;n=n.parentNode;)s.unshift(n);
// Walk down the tree looking for a discrepancy
for(;a[i]===s[i];)i++;return i?
// Do a sibling check if the nodes have a common ancestor
u(a[i],s[i]):
// Otherwise nodes in our document sort first
a[i]===N?-1:s[i]===N?1:0}),M},w.matches=function(e,t){return w(e,null,null,t)},w.matchesSelector=function(e,t){if(
...
i=n&&X.call(C.attrHandle,t.toLowerCase())?n(e,t,!A):void 0;return void 0!==i?i:T.attributes||!A?e.getAttribute(t):(i=e.getAttributeNode(t))&&i.specified?i.value:null},w.escape=function(e){return(e+"").replace(xe,Te)},w.error=function(e){throw new Error("Syntax error, unrecognized expression: "+e)},
/**
...
if(z=!T.detectDuplicates,_=!T.sortStable&&e.slice(0),e.sort(V),z){for(;t=e[o++];)t===e[o]&&(i=n.push(o));for(;i--;)e.splice(n[i],1)}
...
// Shortcut for :nth-*(n)
function(e){return!!e.parentNode}:function(e,t,n){var i,o,r,a,s,l,u=g!==y?"nextSibling":"previousSibling",c=e.parentNode,d=b&&e.nodeName.toLowerCase(),f=!n&&!b,p=!1;if(c){
// :(first|last|only)-(child|of-type)
if(g){for(;u;){for(a=e;a=a[u];)if(b?a.nodeName.toLowerCase()===d:1===a.nodeType)return!1;
...
// Support: IE <9 only
// Defend against cloned attroperties (jQuery gh-1709)
o=(r=(a=c)[R]||(a[R]={}))[a.uniqueID]||(r[a.uniqueID]={}))[h]||[])[0]===F&&i[1])&&i[2],a=s&&c.childNodes[s];a=++s&&a&&a[u]||(
// Fallback to seeking `elem` from the start
p=s=0)||l.pop();)
// When found, cache indexes on `parent` and break
if(1===a.nodeType&&++p&&a===e){o[h]=[F,s,p];break}}else
// xml :nth-child(...)
...
o=(r=(
// ...in a gzip-friendly way
a=e)[R]||(a[R]={}))[a.uniqueID]||(r[a.uniqueID]={}))[h]||[])[0]===F&&i[1]),!1===p)
// Use the same loop as above to seek `elem` from the start
for(;(a=++s&&a&&a[u]||(p=s=0)||l.pop())&&((b?a.nodeName.toLowerCase()!==d:1!==a.nodeType)||!++p||(
// Cache the index of each encountered element
f&&((
// Support: IE <9 only
// Defend against cloned attroperties (jQuery gh-1709)
o=(r=a[R]||(a[R]={}))[a.uniqueID]||(r[a.uniqueID]={}))[h]=[F,p]),a!==e)););
// Incorporate the offset, then check against cycle size
return(p-=v)===m||p%m==0&&0<=p/m}}},PSEUDO:function(e,r){
...
1<a.length?(t=[e,e,"",r],C.setFilters.hasOwnProperty(e.toLowerCase())?l(function(e,t){for(var n,i=a(e,r),o=i.length;o--;)e[n=ee(e,i[o])]=!(t[n]=i[o])}):function(e){return a(e,0,t)}):a}},pseudos:{
...
for(var o,r=s(e,null,i,[]),a=e.length;a--;)(o=r[a])&&(e[a]=!(t[a]=o))}):function(e,t,n){return i[0]=e,s(i,null,n,o),
 ...
 */
j=w.select=function(e,t,n,i){var o,r,a,s,l,u="function"==typeof e&&e,c=!i&&S(e=u.selector||e);
// Try to minimize operations if there is only one selector in the list and no seed
// (the latter of which guarantees us context)
if(n=n||[],1===c.length){if(2<(
// Reduce context if the leading compound selector is an ID
r=c[0]=c[0].slice(0)).length&&"ID"===(a=r[0]).type&&9===t.nodeType&&A&&C.relative[r[1].type]){if(!(t=(C.find.ID(a.matches[0].replace(be,we),t)||[])[0]))return n;
// Precompiled matchers will still verify ancestry, so step up a level
u&&(t=t.parentNode),e=e.slice(r.shift().value.length)}
// Fetch a seed set for right-to-left matching
for(o=pe.needsContext.test(e)?0:r.length;o--&&(a=r[o],!C.relative[s=a.type]);)if((l=C.find[s])&&(i=l(a.matches[0].replace(be,we),ye.test(r[0].type)&&p(t.parentNode)||t))){if(
// If seed is empty or no tokens remain, we can return early
r.splice(o,1),!(e=i.length&&h(r)))return Z.apply(n,i),n;break}}
...
Te.merge(this,Te.parseHTML(i[1],t&&t.nodeType?t.ownerDocument||t:ae,!0)),je.test(i[1])&&Te.isPlainObject(t))for(i in t)
...
Oe=Te(ae);var Pe=/^(?:parents|prev(?:Until|All))/,
// Methods guaranteed to produce a unique set when starting from a unique set
Me={children:!0,contents:!0,next:!0,prev:!0};Te.fn.extend({has:function(e){var t=Te(e,this),n=t.length;return this.filter(function(){for(var e=0;e<n;e++)if(Te.contains(this,t[e]))return!0})},closest:function(e,t){var n,i=0,o=this.length,r=[],a="string"!=typeof e&&Te(e);
// Positional selectors never match, since there's no _selection_ context
if(!$e.test(e))for(;i<o;i++)for(n=this[i];n&&n!==t;n=n.parentNode)
// Always skip document fragments
if(n.nodeType<11&&(a?-1<a.index(n):
// Don't pass non-elements to Sizzle
1===n.nodeType&&Te.find.matchesSelector(n,e))){r.push(n);break}return this.pushStack(1<r.length?Te.uniqueSort(r):r)},
...
!1===r[s].apply(e[0],e[1])&&i.stopOnFalse&&(
...
e&&!n&&(s=r.length-1,a.push(e)),function n(e){Te.each(e,function(e,t){ye(t)?i.unique&&u.has(t)||r.push(t):t&&t.length&&"string"!==v(t)&&
// Inspect recursively
n(t)})}(arguments),e&&!n&&l()),this},
// Remove a callback from the list
remove:function(){return Te.each(arguments,function(e,t){for(var n;-1<(n=Te.inArray(t,r,n));)r.splice(n,1),
// Handle firing indexes
n<=s&&s--}),this},
// Check if a given callback is in the list.
// If no argument is given, return whether or not list has callbacks attached.
has:function(e){return e?-1<Te.inArray(e,r):0<r.length},
// Remove all callbacks from the list
empty:function(){return r&&(r=[]),this},
// Disable .fire and .add
// Abort any current/pending executions
// Clear all callbacks and values
disable:function(){return o=a=[],r=e="",this},disabled:function(){return!r},
// Disable .fire
// Also disable .add unless we have memory (since it would have no effect)
// Abort any pending executions
lock:function(){return o=a=[],e||n||(r=e=""),this},locked:function(){return!!o},
// Call all callbacks with the given context and arguments
fireWith:function(e,t){return o||(t=[e,(t=t||[]).slice?t.slice():t],a.push(t),n||l()),this},
// Call all the callbacks with the given arguments
fire:function(){return u.fireWith(this,arguments),this},
// To know if the callbacks have already been called at least once
fired:function(){return!!t}};return u},Te.extend({Deferred:function(e){var r=[
...
pipe:function(){var o=arguments;return Te.Deferred(function(i){Te.each(r,function(e,t){
// Map tuples (progress, done, fail) to arguments (done, fail, progress)
var n=ye(o[t[4]])&&o[t[4]];
// deferred.progress(function() { bind to newDefer or newDefer.notify })
// deferred.done(function() { bind to newDefer or newDefer.resolve })
// deferred.fail(function() { bind to newDefer or newDefer.reject })
s[t[1]](function(){var e=n&&n.apply(this,arguments);e&&ye(e.promise)?e.promise().progress(i.notify).done(i.resolve).fail(i.reject):i[t[0]+"With"](this,n?[e]:arguments)})}),o=null}).promise()},then:function(t,n,i){function l(o,r,a,s){return function(){var n=this,i=arguments,e=function(){var e,t;
...
s?t.call(e,l(u,r,d,s),l(u,r,f,s)):(
// ...and disregard older resolution values
u++,t.call(e,l(u,r,d,s),l(u,r,f,s),l(u,r,d,r.notifyWith))):(
...
t=s?e:function(){try{e()}catch(e){Te.Deferred.exceptionHook&&Te.Deferred.exceptionHook(e,t.stackTrace),
...
// Only substitute handlers pass on context
// and multiple values (non-spec behavior)
a!==f&&(n=void 0,i=[e]),r.rejectWith(n,i))}};
...
promise:function(e){return null!=e?Te.extend(e,a):a}},s={};
// Add list-specific methods
// All done!
return Te.each(r,function(e,t){var n=t[2],i=t[5];
...
a=function(t){return function(e){i[t]=this,o[t]=1<arguments.length?le.call(arguments):e,--n||r.resolveWith(i,o)}};
// Single- and empty arguments are adopted like Promise.resolve
if(n<=1&&(l(e,r.done(a(t)).resolve,r.reject,!n),"pending"===r.state()||ye(o[t]&&o[t].then)))return r.then();
// Multiple arguments are aggregated like Promise.all array elements
for(;t--;)l(o[t],a(t),r.reject);return r.promise()}});
...
De.resolveWith(ae,[Te])}}),Te.ready.then=De.then,"complete"===ae.readyState||"loading"!==ae.readyState&&!ae.documentElement.doScroll?
...
var Ie=function(e,t,n,i,o,r,a){var s=0,l=e.length,u=null==n;
// Sets many values
if("object"===v(n))for(s in o=!0,n)Ie(e,t,s,n[s],!0,r,a);
// Sets one value
else if(void 0!==i&&(o=!0,ye(i)||(a=!0),u&&(
// Bulk operations run against the entire set
t=a?(t.call(e,i),null):(u=t,function(e,t,n){return u.call(Te(e),n)})),t))for(;s<l;s++)t(e[s],n,a?i:i.call(e[s],s,t(e[s],n)));return o?e:
// Gets
u?t.call(e):l?t(e[0],n):r},He=/^-ms-/,qe=/-([a-z])/g,Re=function(e){
// Accepts only:
//  - Node
//    - Node.ELEMENT_NODE
//    - Node.DOCUMENT_NODE
...
e.nodeType?e[this.expando]=void 0:delete e[this.expando])}},hasData:function(e){var t=e[this.expando];return void 0!==t&&!Te.isEmptyObject(t)}};var Ne=new r,Fe=new r,Be=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Ge=/[A-Z]/g;Te.extend({hasData:function(e){return Fe.hasData(e)||Ne.hasData(e)},data:function(e,t,n){return Fe.access(e,t,n)},removeData:function(e,t){Fe.remove(e,t)},
// TODO: Now that all calls to _data and _removeData have been replaced
// with direct calls to dataPriv methods, these can be deprecated.
_data:function(e,t,n){return Ne.access(e,t,n)},_removeData:function(e,t){Ne.remove(e,t)}}),Te.fn.extend({data:function(n,e){var t,i,o,r=this[0],a=r&&r.attributes;
// Gets all values
if(void 0!==n)
...
Fe.set(this,n,e)})},null,e,1<arguments.length,null,!0);if(this.length&&(o=Fe.get(r),1===r.nodeType&&!Ne.get(r,"hasDataAttrs"))){for(t=a.length;t--;)
// Support: IE 11 only
// The attrs elements can be null (#14894)
a[t]&&0===(i=a[t].name).indexOf("data-")&&(i=p(i.slice(5)),h(r,i,o[i]));Ne.set(r,"hasDataAttrs",!0)}return o},removeData:function(e){return this.each(function(){Fe.remove(this,e)})}}),Te.extend({queue:function(e,t,n){var i;if(e)return t=(t||"fx")+"queue",i=Ne.get(e,t),
// Speed up dequeue by getting out quickly if this is just a lookup
n&&(!i||Array.isArray(n)?i=Ne.access(e,t,Te.makeArray(n)):i.push(n)),i||[]},dequeue:function(e,t){t=t||"fx";var n=Te.queue(e,t),i=n.length,o=n.shift(),r=Te._queueHooks(e,t),a=function(){Te.dequeue(e,t)};
...
promise:function(e,t){var n,i=1,o=Te.Deferred(),r=this,a=this.length,s=function(){--i||o.resolveWith(r,[r])};for("string"!=typeof e&&(t=e,e=void 0),e=e||"fx";a--;)(n=Ne.get(r[a],e+"queueHooks"))&&n.empty&&(i++,n.empty.add(s));return s(),o.promise(t)}});var We=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,Ye=new RegExp("^(?:([+-])=|)("+We+")([a-z%]*)$","i"),Ve=["Top","Right","Bottom","Left"],Xe=function(e,t){
...
// in the document.
Te.contains(e.ownerDocument,e)&&"none"===Te.css(e,"display")},Ue=function(e,t,n,i){var o,r,a={};
// Remember the old values, and insert the new ones
for(r in t)a[r]=e.style[r],e.style[r]=t[r];
// Revert the old values
for(r in o=n.apply(e,i||[]),t)e.style[r]=a[r];return o},Ke={};Te.fn.extend({show:function(){return b(this,!0)},hide:function(){return b(this)},toggle:function(e){return"boolean"==typeof e?e?this.show():this.hide():this.each(function(){Xe(this)?Te(this).show():Te(this).hide()})}});var Qe=/^(?:checkbox|radio)$/i,Ze=/<([a-z][^\/\0>\x20\t\r\n\f]+)/i,Je=/^$|^module$|\/(?:java|ecma)script/i,et={
// Support: IE <=9 only
...
it.innerHTML="<textarea>x</textarea>",ge.noCloneChecked=!!it.cloneNode(!0).lastChild.defaultValue;var rt=ae.documentElement,at=/^key/,st=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,lt=/^([^.]*)(?:\.(.+)|)/;Te.event={global:{},add:function(t,e,n,i,o){var r,a,s,l,u,c,d,f,p,h,m,v=Ne.get(t);
...
o&&Te.find.matchesSelector(rt,o),
...
c=Te.extend({type:p,origType:m,data:i,handler:n,guid:n.guid,selector:o,needsContext:o&&Te.expr.match.needsContext.test(o),namespace:h.join(".")},r),
// Init the event handler queue if we're the first
(f=l[p])||((f=l[p]=[]).delegateCount=0,
// Only use addEventListener if the special events handler returns false
d.setup&&!1!==d.setup.call(t,i,h,a)||t.addEventListener&&t.addEventListener(p,a)),d.add&&(d.add.call(t,c),c.handler.guid||(c.handler.guid=n.guid)),
// Add to the element's handler list, delegates in front
o?f.splice(f.delegateCount++,0,c):f.push(c),
// Keep track of which events have ever been used, for event optimization
Te.event.global[p]=!0)},
// Detach an event or set of events from an element
remove:function(e,t,n,i,o){var r,a,s,l,u,c,d,f,p,h,m,v=Ne.hasData(e)&&Ne.get(e);if(v&&(l=v.events)){for(u=(
// Once for each type.namespace in types; type may be omitted
t=(t||"").match(Le)||[""]).length;u--;)
// Unbind all events (on this namespace, if provided) for the element
if(p=m=(s=lt.exec(t[u])||[])[1],h=(s[2]||"").split(".").sort(),p){for(d=Te.event.special[p]||{},f=l[p=(i?d.delegateType:d.bindType)||p]||[],s=s[2]&&new RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"),
// Remove matching events
a=r=f.length;r--;)c=f[r],!o&&m!==c.origType||n&&n.guid!==c.guid||s&&!s.test(c.namespace)||i&&i!==c.selector&&("**"!==i||!c.selector)||(f.splice(r,1),c.selector&&f.delegateCount--,d.remove&&d.remove.call(e,c));
// Remove generic event handler if we removed something and no more handlers exist
// (avoids potential for endless recursion during removal of special event handlers)
a&&!f.length&&(d.teardown&&!1!==d.teardown.call(e,h,v.handle)||Te.removeEvent(e,p,v.handle),delete l[p])}else for(p in l)Te.event.remove(e,p+t[u],n,i,!0);
// Remove data and the expando if it's no longer used
Te.isEmptyObject(l)&&Ne.remove(e,"handle events")}},dispatch:function(e){
// Make a writable jQuery.Event from the native event object
var t=Te.event.fix(e),n,i,o,r,a,s,l=new Array(arguments.length),u=(Ne.get(this,"events")||{})[t.type]||[],c=Te.event.special[t.type]||{};for(
...
// Determine handlers
s=Te.event.handlers.call(this,t,u),
// Run delegates first; they may want to stop propagation beneath us
n=0;(r=s[n++])&&!t.isPropagationStopped();)for(t.currentTarget=r.elem,i=0;(a=r.handlers[i++])&&!t.isImmediatePropagationStopped();)
// Triggered event must either 1) have no namespace, or 2) have namespace(s)
// a subset or equal to those in the bound event (both can have no namespace).
t.rnamespace&&!t.rnamespace.test(a.namespace)||(t.handleObj=a,t.data=a.data,void 0!==(o=((Te.event.special[a.origType]||{}).handle||a.handler).apply(r.elem,l))&&!1===(t.result=o)&&(t.preventDefault(),t.stopPropagation()));
// Call the postDispatch hook for the mapped type
return c.postDispatch&&c.postDispatch.call(this,t),t.result}},handlers:function(e,t){var n,i,o,r,a,s=[],l=t.delegateCount,u=e.target;
...
if(1===u.nodeType&&("click"!==e.type||!0!==u.disabled)){for(r=[],a={},n=0;n<l;n++)void 0===a[
// Don't conflict with Object.prototype properties (#13203)
o=(i=t[n]).selector+" "]&&(a[o]=i.needsContext?-1<Te(o,this).index(u):Te.find(o,this,null,[u]).length),a[o]&&r.push(i);r.length&&s.push({elem:u,handlers:r})}
...
!e.which&&void 0!==t&&st.test(e.type)?1&t?1:2&t?3:4&t?2:0:e.which}},Te.event.addProp),
...
Te.each({mouseenter:"mouseover",mouseleave:"mouseout",pointerenter:"pointerover",pointerleave:"pointerout"},function(e,r){Te.event.special[e]={delegateType:r,bindType:r,handle:function(e){var t,n=this,i=e.relatedTarget,o=e.handleObj;
// For mouseenter/leave call the handler if related is outside the target.
// NB: No relatedTarget if the mouse left/entered the browser window
return i&&(i===n||Te.contains(n,i))||(e.type=o.origType,t=o.handler.apply(this,arguments),e.type=r),t}}}),Te.fn.extend({on:function(e,t,n,i){return $(this,e,t,n,i)},one:function(e,t,n,i){return $(this,e,t,n,i,1)},off:function(e,t,n){var i,o;if(e&&e.preventDefault&&e.handleObj)
...
dt=/checked\s*(?:[^=]|=\s*.checked.)/i,ft=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;Te.extend({htmlPrefilter:function(e){return e.replace(ut,"<$1></$2>")},clone:function(e,t,n){var i,o,r,a,s=e.cloneNode(!0),l=Te.contains(e.ownerDocument,e);
// Fix IE cloning issues
if(!(ge.noCloneChecked||1!==e.nodeType&&11!==e.nodeType||Te.isXMLDoc(e)))for(
// We eschew Sizzle here for performance reasons: https://jsperf.com/getall-vs-sizzle/2
a=w(s),i=0,o=(r=w(e)).length;i<o;i++)P(r[i],a[i]);
// Copy the events from the original to the clone
if(t)if(n)for(r=r||w(e),a=a||w(s),i=0,o=r.length;i<o;i++)z(r[i],a[i]);else z(e,s);
// Preserve script evaluation history
// Return the cloned set
return 0<(a=w(s,"script")).length&&x(a,!l&&w(e,"script")),s},cleanData:function(e){for(var t,n,i,o=Te.event.special,r=0;void 0!==(n=e[r]);r++)if(Re(n)){if(t=n[Ne.expando]){if(t.events)for(i in t.events)o[i]?Te.event.remove(n,i):Te.removeEvent(n,i,t.handle);
// Support: Chrome <=35 - 45+
...
},n)}}),Te.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(e,a){Te.fn[e]=function(e){for(var t,n=[],i=Te(e),o=i.length-1,r=0;r<=o;r++)t=r===o?this:this.clone(!0),Te(i[r])[a](t),
// Support: Android <=4.0 only, PhantomJS 1 only
...
var t=e.ownerDocument.defaultView;return t&&t.opener||(t=C),t.getComputedStyle(e)},mt=new RegExp(Ve.join("|"),"i");!function(){
// Executing both pixelPosition & boxSizingReliable tests require only one layout
// so they're executed at the same time to save the second computation.
function e(){
// This is a singleton, we need to execute it only once
if(l){s.style.cssText="position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0",l.style.cssText="position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%",rt.appendChild(s).appendChild(l);var e=C.getComputedStyle(l);n="1%"!==e.top,
...
l.style.position="absolute",o=36===l.offsetWidth||"absolute",rt.removeChild(s),
// Nullify the div so it wouldn't be stored in the memory and
// it will also be a sign that checks already performed
l=null}}function t(e){return Math.round(parseFloat(e))}var n,i,o,r,a,s=ae.createElement("div"),l=ae.createElement("div");
...
vt=/^(none|table(?!-c[ea]).+)/,gt=/^--/,yt={position:"absolute",visibility:"hidden",display:"block"},bt={letterSpacing:"0",fontWeight:"400"},wt=["Webkit","Moz","ms"],xt=ae.createElement("div").style;Te.extend({
...
var o,r,a,s=p(t),l=gt.test(t),u=e.style;
...
a=Te.cssHooks[t]||Te.cssHooks[s],void 0===n)
...
"number"===r&&(n+=o&&o[3]||(Te.cssNumber[s]?"":"px")),
// background-* props affect original clone's values
ge.clearCloneStyle||""!==n||0!==t.indexOf("background")||(u[t]="inherit"),
// If a hook was provided, use that value, otherwise just set the specified value
a&&"set"in a&&void 0===(n=a.set(e,n,i))||(l?u.setProperty(t,n):u[t]=n))}},css:function(e,t,n,i){var o,r,a,s=p(t),l;
// Make sure that we're working with the right name. We don't
...
a=Te.cssHooks[t]||Te.cssHooks[s])&&"get"in a&&(o=a.get(e,!0,n)),
// Otherwise, if a way to get the computed value exists, use that
void 0===o&&(o=A(e,t,i)),
// Convert "normal" to computed value
"normal"===o&&t in bt&&(o=bt[t]),""===n||n?(r=parseFloat(o),!0===n||isFinite(r)?r||0:o):o}}),Te.each(["height","width"],function(e,s){Te.cssHooks[s]={get:function(e,t,n){if(t)
...
e.getClientRects().length&&e.getBoundingClientRect().width?N(e,s,n):Ue(e,yt,function(){return N(e,s,n)})},set:function(e,t,n){var i,o=ht(e),r="border-box"===Te.css(e,"boxSizing",!1,o),a=n&&R(e,s,n,r,o);
// Account for unreliable border-box dimensions by comparing offset* to computed and
// faking a content-box to get border and padding (gh-3699)
return r&&ge.scrollboxSize()===o.position&&(a-=Math.ceil(e["offset"+s[0].toUpperCase()+s.slice(1)]-parseFloat(o[s])-R(e,s,"border",!1,o)-.5)),
// Convert to pixels if value adjustment is needed
a&&(i=Ye.exec(t))&&"px"!==(i[3]||"px")&&(e.style[s]=t,t=Te.css(e,s)),q(e,t,a)}}}),Te.cssHooks.marginLeft=D(ge.reliableMarginLeft,function(e,t){if(t)return(parseFloat(A(e,"marginLeft"))||e.getBoundingClientRect().left-Ue(e,{marginLeft:0},function(){return e.getBoundingClientRect().left}))+"px"}),
// These hooks are used by animate to expand properties
Te.each({margin:"",padding:"",border:"Width"},function(o,r){Te.cssHooks[o+r]={expand:function(e){for(var t=0,n={},
// Assumes a single number if not a string
i="string"==typeof e?e.split(" "):[e];t<4;t++)n[o+Ve[t]+r]=i[t]||i[t-2]||i[0];return n}},"margin"!==o&&(Te.cssHooks[o+r].set=q)}),Te.fn.extend({css:function(e,t){return Ie(this,function(e,t,n){var i,o,r={},a=0;if(Array.isArray(t)){for(i=ht(e),o=t.length;a<o;a++)r[t[a]]=Te.css(e,t[a],!1,i);return r}return void 0!==n?Te.style(e,t,n):Te.css(e,t)},e,t,1<arguments.length)}}),(Te.Tween=F).prototype={constructor:F,init:function(e,t,n,i,o,r){this.elem=e,this.prop=n,this.easing=o||Te.easing._default,this.options=t,this.start=this.now=this.cur(),this.end=i,this.unit=r||(Te.cssNumber[n]?"":"px")},cur:function(){var e=F.propHooks[this.prop];return e&&e.get?e.get(this):F.propHooks._default.get(this)},run:function(e){var t,n=F.propHooks[this.prop];return this.options.duration?this.pos=t=Te.easing[this.easing](e,this.options.duration*e,0,1,this.options.duration):this.pos=t=e,this.now=(this.end-this.start)*t+this.start,this.options.step&&this.options.step.call(this.elem,this.now,this),n&&n.set?n.set(this):F.propHooks._default.set(this),this}},F.prototype.init.prototype=F.prototype,F.propHooks={_default:{get:function(e){var t;
...
Te.fx.step={};var Tt,Ct,kt=/^(?:toggle|show|hide)$/,Et=/queueHooks$/,St,$t,jt;Te.Animation=Te.extend(U,{tweeners:{"*":[function(e,t){var n=this.createTween(e,t);return g(n.elem,e,Ye.exec(t),n),n}]},tweener:function(e,t){for(var n,i=0,o=(e=ye(e)?(t=e,["*"]):e.match(Le)).length;i<o;i++)n=e[i],U.tweeners[n]=U.tweeners[n]||[],U.tweeners[n].unshift(t)},prefilters:[V],prefilter:function(e,t){t?U.prefilters.unshift(e):U.prefilters.push(e)}}),Te.speed=function(e,t,n){var i=e&&"object"==typeof e?Te.extend({},e):{complete:n||!n&&t||ye(e)&&e,duration:e,easing:n&&t||t&&!ye(t)&&t};
...
return this.filter(Xe).css("opacity",0).show().end().animate({opacity:t},e,n,i)},animate:function(t,e,n,i){var o=Te.isEmptyObject(t),r=Te.speed(e,n,i),a=function(){
// Operate on a copy of prop so per-property easing won't be lost
var e=U(this,Te.extend({},t),r);
// Empty animations, or finishing resolves immediately
(o||Ne.get(this,"finish"))&&e.stop(!0)};return a.finish=a,o||!1===r.queue?this.each(a):this.queue(r.queue,a)},stop:function(o,e,r){var a=function(e){var t=e.stop;delete e.stop,t(r)};return"string"!=typeof o&&(r=e,e=o,o=void 0),e&&!1!==o&&this.queue(o||"fx",[]),this.each(function(){var e=!0,t=null!=o&&o+"queueHooks",n=Te.timers,i=Ne.get(this);if(t)i[t]&&i[t].stop&&a(i[t]);else for(t in i)i[t]&&i[t].stop&&Et.test(t)&&a(i[t]);for(t=n.length;t--;)n[t].elem!==this||null!=o&&n[t].queue!==o||(n[t].anim.stop(r),e=!1,n.splice(t,1));
// Start the next in the queue if the last step wasn't forced.
// Timers currently will call their complete callbacks, which
// will dequeue but only if they were gotoEnd.
!e&&r||Te.dequeue(this,o)})},finish:function(a){return!1!==a&&(a=a||"fx"),this.each(function(){var e,t=Ne.get(this),n=t[a+"queue"],i=t[a+"queueHooks"],o=Te.timers,r=n?n.length:0;
// Enable finishing flag on private data
// Look for any active animations, and finish them
for(t.finish=!0,
// Empty the queue first
Te.queue(this,a,[]),i&&i.stop&&i.stop.call(this,!0),e=o.length;e--;)o[e].elem===this&&o[e].queue===a&&(o[e].anim.stop(!0),o.splice(e,1));
...
Te.fn.delay=function(i,e){return i=Te.fx&&Te.fx.speeds[i]||i,e=e||"fx",this.queue(e,function(e,t){var n=C.setTimeout(e,i);t.stop=function(){C.clearTimeout(n)}})},St=ae.createElement("input"),jt=ae.createElement("select").appendChild(ae.createElement("option")),St.type="checkbox",
...
St=ae.createElement("input")).value="t",St.type="radio",ge.radioValue="t"===St.value;var Ot,_t=Te.expr.attrHandle;Te.fn.extend({attr:function(e,t){return Ie(this,Te.attr,e,t,1<arguments.length)},removeAttr:function(e){return this.each(function(){Te.removeAttr(this,e)})}}),Te.extend({attr:function(e,t,n){var i,o,r=e.nodeType;
...
1===r&&Te.isXMLDoc(e)||(o=Te.attrHooks[t.toLowerCase()]||(Te.expr.match.bool.test(t)?Ot:void 0)),void 0!==n?null===n?void Te.removeAttr(e,t):o&&"set"in o&&void 0!==(i=o.set(e,n,t))?i:(e.setAttribute(t,n+""),n):o&&"get"in o&&null!==(i=o.get(e,t))?i:null==(i=Te.find.attr(e,t))?void 0:i)},attrHooks:{type:{set:function(e,t){if(!ge.radioValue&&"radio"===t&&u(e,"input")){var n=e.value;return e.setAttribute("type",t),n&&(e.value=n),t}}}},removeAttr:function(e,t){var n,i=0,
...
Te.removeAttr(e,n):e.setAttribute(n,n),n}},Te.each(Te.expr.match.bool.source.match(/\w+/g),function(e,t){var a=_t[t]||Te.find.attr;_t[t]=function(e,t,n){var i,o,r=t.toLowerCase();return n||(
// Avoid an infinite loop by temporarily removing this function from the getter
o=_t[r],_t[r]=i,i=null!=a(e,t,n)?r:null,_t[r]=o),i}});var zt=/^(?:input|select|textarea|button)$/i,Pt=/^(?:a|area)$/i;Te.fn.extend({prop:function(e,t){return Ie(this,Te.prop,e,t,1<arguments.length)},removeProp:function(e){return this.each(function(){delete this[Te.propFix[e]||e]})}}),Te.extend({prop:function(e,t,n){var i,o,r=e.nodeType;
// Don't get/set properties on text, comment and attribute nodes
if(3!==r&&8!==r&&2!==r)return 1===r&&Te.isXMLDoc(e)||(
...
/* eslint no-unused-expressions: "off" */
var t=e.parentNode;t&&(t.selectedIndex,t.parentNode&&t.parentNode.selectedIndex)}}),Te.each(["tabIndex","readOnly","maxLength","cellSpacing","cellPadding","rowSpan","colSpan","useMap","frameBorder","contentEditable"],function(){Te.propFix[this.toLowerCase()]=this}),Te.fn.extend({addClass:function(t){var e,n,i,o,r,a,s,l=0;if(ye(t))return this.each(function(e){Te(this).addClass(t.call(this,e,Q(this)))});if((e=Z(t)).length)for(;n=this[l++];)if(o=Q(n),i=1===n.nodeType&&" "+K(o)+" "){for(a=0;r=e[a++];)i.indexOf(" "+r+" ")<0&&(i+=r+" ");
// Only assign if different to avoid unneeded rendering.
o!==(s=K(i))&&n.setAttribute("class",s)}return this},removeClass:function(t){var e,n,i,o,r,a,s,l=0;if(ye(t))return this.each(function(e){Te(this).removeClass(t.call(this,e,Q(this)))});if(!arguments.length)return this.attr("class","");if((e=Z(t)).length)for(;n=this[l++];)if(o=Q(n),
// This expression is here for better compressibility (see addClass)
i=1===n.nodeType&&" "+K(o)+" "){for(a=0;r=e[a++];)
// Remove *all* instances
for(;-1<i.indexOf(" "+r+" ");)i=i.replace(" "+r+" "," ");
// Only assign if different to avoid unneeded rendering.
o!==(s=K(i))&&n.setAttribute("class",s)}return this},toggleClass:function(o,t){var r=typeof o,a="string"===r||Array.isArray(o);return"boolean"==typeof t&&a?t?this.addClass(o):this.removeClass(o):ye(o)?this.each(function(e){Te(this).toggleClass(o.call(this,e,Q(this),t),t)}):this.each(function(){var e,t,n,i;if(a)for(
...
K(Te.text(e))}},select:{get:function(e){var t,n,i,o=e.options,r=e.selectedIndex,a="select-one"===e.type,s=a?null:[],l=a?r+1:o.length;
...
t=Te(n).val(),a)return t;
// Multi-Selects return an array
s.push(t)}return s},set:function(e,t){for(var n,i,o=e.options,r=Te.makeArray(t),a=o.length;a--;)
/* eslint-disable no-cond-assign */
((i=o[a]).selected=-1<Te.inArray(Te.valHooks.option.get(i),r))&&(n=!0)
...
ge.focusin="onfocusin"in C;var Lt=/^(?:focusinfocus|focusoutblur)$/,At=function(e){e.stopPropagation()};Te.extend(Te.event,{trigger:function(e,t,n,i){var o,r,a,s,l,u,c,d,f=[n||ae],p=he.call(e,"type")?e.type:e,h=he.call(e,"namespace")?e.namespace.split("."):[];
// Don't do events on text and comment nodes
if(r=d=a=n=n||ae,3!==n.nodeType&&8!==n.nodeType&&!Lt.test(p+Te.event.triggered)&&(-1<p.indexOf(".")&&(
// Namespaced trigger; create a regexp to match event type in handle()
p=(h=p.split(".")).shift(),h.sort()),l=p.indexOf(":")<0&&"on"+p,
// Trigger bitmask: & 1 for native handlers; & 2 for jQuery (always true)
(
// Caller can pass in a jQuery.Event object, Object, or just an event type string
e=e[Te.expando]?e:new Te.Event(p,"object"==typeof e&&e)).isTrigger=i?2:3,e.namespace=h.join("."),e.rnamespace=e.namespace?new RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,
// Clean up the event in case it is being reused
e.result=void 0,e.target||(e.target=n),
// Clone any incoming data and prepend the event, creating the handler arg list
t=null==t?[e]:Te.makeArray(t,[e]),
// Allow special events to draw outside the lines
c=Te.event.special[p]||{},i||!c.trigger||!1!==c.trigger.apply(n,t))){
// Determine event propagation path in advance, per W3C events spec (#9951)
// Bubble up to document, then to window; watch for a global ownerDocument var (#9724)
if(!i&&!c.noBubble&&!be(n)){for(s=c.delegateType||p,Lt.test(s+p)||(r=r.parentNode);r;r=r.parentNode)f.push(r),a=r;
// Only add window if we got to document (e.g., not plain obj or detached DOM)
a===(n.ownerDocument||ae)&&f.push(a.defaultView||a.parentWindow||C)}
// Fire handlers on the event path
for(o=0;(r=f[o++])&&!e.isPropagationStopped();)d=r,e.type=1<o?s:c.bindType||p,(
// jQuery handler
u=(Ne.get(r,"events")||{})[e.type]&&Ne.get(r,"handle"))&&u.apply(r,t),(
// Native handler
u=l&&r[l])&&u.apply&&Re(r)&&(e.result=u.apply(r,t),!1===e.result&&e.preventDefault());return e.type=p,
...
Te.event.triggered=p,e.isPropagationStopped()&&d.addEventListener(p,At),n[p](),e.isPropagationStopped()&&d.removeEventListener(p,At),Te.event.triggered=void 0,a&&(n[l]=a)),e.result}
...
Jt=ae.createElement("a");Jt.href=Dt.href,Te.extend({
...
function n(e,t,n,i){var o,r,a,s,l,u=t;
...
// if no content
204===e||"HEAD"===v.type?u="nocontent":304===e?u="notmodified":(u=s.state,r=s.data,o=!(a=s.error))):(
...
T.statusCode(x),x=void 0,m&&y.trigger(o?"ajaxSuccess":"ajaxError",[T,v,o?r:a]),
// Complete
...
v.dataTypes=(v.dataType||"*").toLowerCase().match(Le)||[""],null==v.crossDomain){o=ae.createElement("a");
...
T.setRequestHeader("Accept",v.dataTypes[0]&&v.accepts[v.dataTypes[0]]?v.accepts[v.dataTypes[0]]+("*"!==v.dataTypes[0]?", "+Zt+"; q=0.01":""):v.accepts["*"]),v.headers)T.setRequestHeader(r,v.headers[r]);
...
if(T.readyState=1,
// Send global event
m&&y.trigger("ajaxSend",[T,v]),h)return T;
// Timeout
v.async&&0<v.timeout&&(p=C.setTimeout(function(){T.abort("timeout")},v.timeout));try{h=!1,c.send(s,n)}catch(e){
...
1223:204},tn=Te.ajaxSettings.xhr();ge.cors=!!tn&&"withCredentials"in tn,ge.ajax=tn=!!tn,Te.ajaxTransport(function(o){var r,a;
...
// Callback
r=function(e){return function(){r&&(r=a=i.onload=i.onerror=i.onabort=i.ontimeout=i.onreadystatechange=null,"abort"===e?i.abort():"error"===e?
// Support: IE <=9 only
...
// Listen to events
i.onload=r(),a=i.onerror=i.ontimeout=r("error"),
// Support: IE 9 only
...
ae.head.appendChild(i[0])},abort:function(){o&&o()}}});var nn=[],on=/(=)\?(?=&|$)|\?\?/,rn;
// Default jsonp settings
Te.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=nn.pop()||Te.expando+"_"+It++;return this[e]=!0,e}}),
// Detect, normalize options and install callbacks for jsonp requests
Te.ajaxPrefilter("json jsonp",function(e,t,n){var i,o,r,a=!1!==e.jsonp&&(on.test(e.url)?"url":"string"==typeof e.data&&0===(e.contentType||"").indexOf("application/x-www-form-urlencoded")&&on.test(e.data)&&"data");
...
a?e[a]=e[a].replace(on,"$1"+i):!1!==e.jsonp&&(e.url+=(Ht.test(e.url)?"&":"?")+e.jsonp+"="+i),
// Use data converter to retrieve json after script execution
e.converters["script json"]=function(){return r||Te.error(i+" was not called"),r[0]},
// Force json dataType
e.dataTypes[0]="json",
// Install callback
...
ge.createHTMLDocument=((rn=ae.implementation.createHTMLDocument("").body).innerHTML="<form></form><form></form>",2===rn.childNodes.length),
...
i=(t=ae.implementation.createHTMLDocument("")).createElement("base")).href=ae.location.href,t.head.appendChild(i)):t=ae),r=!n&&[],(o=je.exec(e))?[t.createElement(o[1])]:(o=T([e],t,r),r&&r.length&&Te(r).remove(),Te.merge([],o.childNodes)));var i,o,r},
/**
 * Load a url into a page
 */
Te.fn.load=function(e,t,n){var i,o,r,a=this,s=e.indexOf(" ");return-1<s&&(i=K(e.slice(s)),e=e.slice(0,s)),
// If it's a function
ye(t)?(
// We assume that it's the callback
n=t,t=void 0):t&&"object"==typeof t&&(o="POST"),
// If we have elements to modify, make the request
0<a.length&&Te.ajax({url:e,
// If "type" variable is undefined, then "GET" method will be used.
// Make value of this field explicit since
// user can override it through ajaxSetup method
type:o||"GET",dataType:"html",data:t}).done(function(e){
// Save response for use in complete callback
r=arguments,a.html(i?
...
Te.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(e,t){Te.fn[t]=function(e){return this.on(t,e)}}),Te.expr.pseudos.animated=function(t){return Te.grep(Te.timers,function(e){return t===e.elem}).length},Te.offset={setOffset:function(e,t,n){var i,o,r,a,s,l,u,c=Te.css(e,"position"),d=Te(e),f={};
// Set position first, in-case top/left are set even on static elem
"static"===c&&(e.style.position="relative"),s=d.offset(),r=Te.css(e,"top"),l=Te.css(e,"left"),
// Need to be able to calculate position if either
// top or left is auto and position is either absolute or fixed
o=(u=("absolute"===c||"fixed"===c)&&-1<(r+l).indexOf("auto"))?(a=(i=d.position()).top,i.left):(a=parseFloat(r)||0,parseFloat(l)||0),ye(t)&&(
// Use jQuery.extend here to allow modification of coordinates argument (gh-1848)
t=t.call(e,n,Te.extend({},s))),null!=t.top&&(f.top=t.top-s.top+a),null!=t.left&&(f.left=t.left-s.left+o),"using"in t?t.using.call(e,f):d.css(f)}},Te.fn.extend({
...
offsetParent:function(){return this.map(function(){for(var e=this.offsetParent;e&&"static"===Te.css(e,"position");)e=e.offsetParent;return e||rt})}}),
// Create scrollLeft and scrollTop methods
Te.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(t,o){var r="pageYOffset"===o;Te.fn[t]=function(e){return Ie(this,function(e,t,n){
...
return t=A(e,n),pt.test(t)?Te(e).position()[n]+"px":t})}),
// Create innerHeight, innerWidth, height, width, outerHeight and outerWidth methods
Te.each({Height:"height",Width:"width"},function(a,s){Te.each({padding:"inner"+a,content:s,"":"outer"+a},function(i,r){
// Margin is only for outerHeight, outerWidth
Te.fn[r]=function(e,t){var n=arguments.length&&(i||"boolean"!=typeof e),o=i||(!0===e||!0===t?"margin":"border");return Ie(this,function(e,t,n){var i;return be(e)?0===r.indexOf("outer")?e["inner"+a]:e.document.documentElement["client"+a]:
...
Te.style(e,t,n,o)},s,n?e:void 0,n)}})}),Te.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "),function(e,n){
...
(o=function(){return e.apply(t||this,i.concat(le.call(arguments)))}).guid=e.guid=e.guid||Te.guid++,o},Te.holdReady=function(e){e?Te.readyWait++:Te.ready(!0)},Te.isArray=Array.isArray,Te.parseJSON=JSON.parse,Te.nodeName=u,Te.isFunction=ye,Te.isWindow=be,Te.camelCase=p,Te.type=v,Te.now=Date.now,Te.isNumeric=function(e){
...
sn=C.$;return Te.noConflict=function(e){return C.$===Te&&(C.$=sn),e&&C.jQuery===Te&&(C.jQuery=an),Te},
// Expose jQuery and $ identifiers, even in AMD
// (#7102#comment:10, https://github.com/jquery/jquery/pull/557)
// and CommonJS for browser emulators (#13566)
e||(C.jQuery=C.$=Te),Te}),function e(t,n){"object"==typeof exports&&"object"==typeof module?module.exports=n():"function"==typeof define&&define.amd?define([],n):"object"==typeof exports?exports.Swup=n():t.Swup=n()}(window,function(){/******/
return function(n){
/******/
...
/**
         ...
         */
this.getUrl=j.default,this.cache=new c.default,this.link=new f.default,this.transitionEndEvent=(0,h.default)(),this.getDataFromHtml=y.default,this.getPage=v.default,this.scrollTo=_.default,this.loadPage=w.default,this.renderPage=T.default,this.createState=k.default,this.triggerEvent=S.default,this.classify=P.default,this.doScrolling=L.default,this.markSwupElements=D.default,this.on=H.default,this.off=R.default,this.updateTransition=F.default,this.preloadPage=G.default,this.preloadPages=Y.default,this.usePlugin=X.default,this.log=K.default,this.enable=this.enable,this.destroy=this.destroy,
// attach instance to window in debug mode
this.options.debugMode&&(window.swup=this),this.getUrl(),this.enable()}return a(i,[{key:"enable",value:function e(){var t=this;
/**
             * support check
...
if(!(0,h.default)())return void console.warn("transitionEnd detection is not supported");
// check Promise support
if(this.transitionEndEvent=(0,h.default)(),"undefined"==typeof Promise||-1===Promise.toString().indexOf("[native code]"))return void console.warn("Promise is not supported")}
...
// load page
this.loadPage({url:n.getAddress(),customTransition:r},!1)}}}},{key:"linkMouseoverHandler",value:function e(r){var a=this;if(this.triggerEvent("hoverLink",r),this.options.preload){var s=new f.default;s.setPath(r.delegateTarget.href),s.getAddress()==this.currentUrl||this.cache.exists(s.getAddress())||null!=this.preloadPromise||(this.preloadPromise=new Promise(function(i,o){a.getPage({url:s.getAddress()},function(e,t){if(500===t.status)return a.triggerEvent("serverError",r),void o(s.getAddress());
// get json data
var n=a.getDataFromHtml(e,t);null!=n?(n.url=s.getAddress(),a.cache.cacheUrl(n,a.options.debugMode),a.triggerEvent("pagePreloaded",r),i(),a.preloadPromise=null):o(s.getAddress())})}),this.preloadPromise.route=s.getAddress())}}},{key:"formSubmitHandler",value:function e(t){
// no control key pressed
...
// create base url
var r=o.getAddress()||window.location.href,a=n.querySelectorAll("input, select");-1==r.indexOf("?")?r+="?":r+="&",
// add form data to url
a.forEach(function(e){"checkbox"==e.type||"radio"==e.type?e.checked&&(r+=encodeURIComponent(e.name)+"="+encodeURIComponent(e.value)+"&"):r+=encodeURIComponent(e.name)+"="+encodeURIComponent(e.value)+"&"}),
// remove last "&"
r=r.slice(0,-1),
// remove page from cache
this.cache.remove(r),
 ...
 * @return {Object}
 */
function i(e,t,n,i,o){var r=a.apply(this,arguments);return e.addEventListener(n,r,o),{destroy:function(){e.removeEventListener(n,r,o)}}}
/**
 ...
 * @param {Function} callback
 * @return {Function}
 */function a(t,n,e,i){return function(e){e.delegateTarget=o(e.target,n),e.delegateTarget&&i.call(t,e)}}var o=n(5);e.exports=i},
/* 5 */
/***/function(e,t){
/**
...
/* 8 */
/***/function(e,t,n){"use strict";var a=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}return e};e.exports=function(e,t){var n=1<arguments.length&&void 0!==t&&t,i={url:window.location.pathname+window.location.search,method:"GET",data:null},o=a({},i,e),r=new XMLHttpRequest;return r.onreadystatechange=function(){4===r.readyState&&(500!==r.status?n(r.responseText,r):n(null,r))},r.open(o.method,o.url,!0),r.setRequestHeader("X-Requested-With","swup"),r.send(o.data),r}},
/* 9 */
/***/function(e,t,n){"use strict";var l=n(0);e.exports=function(e,t){var n=this,i=e.replace("<body",'<div id="swupBody"').replace("</body>","</div>"),o=document.createElement("div"),r;o.innerHTML=i;for(var a=[],s=0;s<this.options.elements.length;s++){if(null==o.querySelector(this.options.elements[s]))return console.warn("Element "+this.options.elements[s]+" is not found in cached page."),null;(0,l.queryAll)(this.options.elements[s]).forEach(function(e,t){(0,l.queryAll)(n.options.elements[s],o)[t].dataset.swup=a.length,a.push((0,l.queryAll)(n.options.elements[s],o)[t].outerHTML)})}return{title:o.querySelector("title").innerText,pageClass:o.querySelector("#swupBody").className,originalContent:e,blocks:a,responseURL:null!=t?t.responseURL:window.location.href}}},
/* 10 */
/***/function(e,t,n){"use strict";var s=n(0),l=Array.prototype.forEach;e.exports=function(r,e){var a=this;
// scrolling
...
var n=(0,s.queryAll)(this.options.animationSelector);
// create pop element with or without anchor
if(l.call(n,function(n){var e=new Promise(function(t){n.addEventListener(a.transitionEndEvent,function(e){n==e.target&&t()})});t.push(e)}),Promise.all(t).then(function(){a.triggerEvent("animationOutDone")}),null!=this.scrollToElement)var i=r.url+this.scrollToElement;else var i=r.url;e||this.createState(i)}else
// proceed without animating
this.triggerEvent("animationSkipped");if(this.cache.exists(r.url)){var o=new Promise(function(e){e()});this.triggerEvent("pageRetrievedFromCache")}else if(this.preloadPromise&&this.preloadPromise.route==r.url)var o=this.preloadPromise;else var o=new Promise(function(i,o){a.getPage(r,function(e,t){if(500===t.status)return a.triggerEvent("serverError"),void o(r.url);
// get json data
var n=a.getDataFromHtml(e,t);null!=n?(n.url=r.url,
// render page
a.cache.cacheUrl(n,a.options.debugMode),a.triggerEvent("pageLoaded"),i()):o(r.url)})});Promise.all(t.concat([o])).then(function(){
// render page
a.renderPage(a.cache.getPage(r.url),e),a.preloadPromise=null}).catch(function(e){
// rewrite the skipPopStateHandling function to redirect manually when the history.go is processed
a.options.skipPopStateHandling=function(){return window.location=e,!0},
// go back to the actual page were still at
window.history.go(-1)})}},
/* 11 */
/***/function(e,t,n){"use strict";function i(e){return e&&e.__esModule?e:{default:e}}var s=n(0),o,l=i(n(1)),u=Array.prototype.forEach;e.exports=function(e,t){var i=this;document.documentElement.classList.remove("is-leaving");
...
// detect animation end
var r=(0,s.queryAll)(this.options.animationSelector),a=[];u.call(r,function(n){var e=new Promise(function(t){n.addEventListener(i.transitionEndEvent,function(e){n==e.target&&t()})});a.push(e)}),
//preload pages if possible
this.preloadPages(),t&&!this.options.animateHistoryBrowsing||Promise.all(a).then(function(){i.triggerEvent("animationInDone"),
...
/* 15 */
/***/function(e,t,n){"use strict";e.exports=function(e,t,n){function i(){return document.body.scrollTop||document.documentElement.scrollTop}function o(){var e=f-u,t;return v(e*l),u+=c*=s,e}var r=this,a=2<arguments.length&&void 0!==n?n:this.options.animateScroll,s=1-this.options.scrollFriction,l=this.options.scrollAcceleration,u=0,c=0,d=0,f=0,p=0,h=null,m=function e(){var t=o();g(),1===p&&u<d||-1===p&&d<u?h=requestAnimationFrame(e):(window.scrollTo(0,d),r.triggerEvent("scrollDone"))},v=function e(t){c+=t},g=function e(){window.scrollTo(0,u)};window.addEventListener("mousewheel",function(e){h&&(cancelAnimationFrame(h),h=null)},{passive:!0});var y=function e(t,n){u=i(),f=t+(p=t<u?-1:1),c=0,u!=(d=t)?m():r.triggerEvent("scrollDone")};this.triggerEvent("scrollStart"),0==a?(window.scrollTo(0,t),this.triggerEvent("scrollDone")):y(t)}},
/* 16 */
...
/******/])}),function e(t,n){if("object"==typeof exports&&"object"==typeof module)module.exports=n(require("jquery"));else if("function"==typeof define&&define.amd)define(["jquery"],n);else{var i="object"==typeof exports?n(require("jquery")):n(t.jQuery);for(var o in i)("object"==typeof exports?exports:t)[o]=i[o]}}(window,function(n){/******/
return function(n){
/******/
/******/ // The require function
/******/function o(e){
...
/* harmony reexport (safe) */n.d(t,"ResponsiveAccordionTabs",function(){return D.ResponsiveAccordionTabs}),r.Foundation.addToJquery(o.a),// Add Foundation Utils to Foundation global namespace for backwards
// compatibility.
r.Foundation.rtl=a.rtl,r.Foundation.GetYoDigits=a.GetYoDigits,r.Foundation.transitionend=a.transitionend,r.Foundation.RegExpEscape=a.RegExpEscape,r.Foundation.onLoad=a.onLoad,r.Foundation.Box=s.Box,r.Foundation.onImagesLoaded=l.onImagesLoaded,r.Foundation.Keyboard=u.Keyboard,r.Foundation.MediaQuery=c.MediaQuery,r.Foundation.Motion=d.Motion,r.Foundation.Move=d.Move,r.Foundation.Nest=f.Nest,r.Foundation.Timer=p.Timer,// Touch and Triggers previously were almost purely sede effect driven,
// so no need to add it to Foundation, just init them.
h.Touch.init(o.a),m.Triggers.init(o.a,r.Foundation),c.MediaQuery._init(),r.Foundation.plugin(v.Abide,"Abide"),r.Foundation.plugin(g.Accordion,"Accordion"),r.Foundation.plugin(y.AccordionMenu,"AccordionMenu"),r.Foundation.plugin(b.Drilldown,"Drilldown"),r.Foundation.plugin(w.Dropdown,"Dropdown"),r.Foundation.plugin(x.DropdownMenu,"DropdownMenu"),r.Foundation.plugin(T.Equalizer,"Equalizer"),r.Foundation.plugin(C.Interchange,"Interchange"),r.Foundation.plugin(k.Magellan,"Magellan"),r.Foundation.plugin(E.OffCanvas,"OffCanvas"),r.Foundation.plugin(S.Orbit,"Orbit"),r.Foundation.plugin($.ResponsiveMenu,"ResponsiveMenu"),r.Foundation.plugin(j.ResponsiveToggle,"ResponsiveToggle"),r.Foundation.plugin(O.Reveal,"Reveal"),r.Foundation.plugin(_.Slider,"Slider"),r.Foundation.plugin(z.SmoothScroll,"SmoothScroll"),r.Foundation.plugin(P.Sticky,"Sticky"),r.Foundation.plugin(M.Tabs,"Tabs"),r.Foundation.plugin(L.Toggler,"Toggler"),r.Foundation.plugin(A.Tooltip,"Tooltip"),r.Foundation.plugin(D.ResponsiveAccordionTabs,"ResponsiveAccordionTabs"),
...
/* */
function(e){function o(){return r(this,o),s(this,u(o).apply(this,arguments))}return c(o,e),a(o,[{key:"_setup",
/**
...
i.each(function(e,t){var n=p()(t);void 0===n.attr("for")&&n.attr("for",a)})}// For each error targeting $el, set [role=alert] if it is not set.
...
/* */
function(e){function i(){return o(this,i),s(this,u(i).apply(this,arguments))}return c(i,e),a(i,[{key:"_setup",
/**
...
r=t.parents("li").first().next("li").find("a").first()))}),h.Keyboard.handleKey(n,"AccordionMenu",{open:function e(){a.is(":hidden")&&(s.down(a),a.find("li").first().find("a").first().focus())},close:function e(){a.length&&!a.is(":hidden")?
// close active sub of this item
s.up(a):t.parent("[data-submenu]").length&&(
// close currently open sub
s.up(t.parent("[data-submenu]")),t.parents("li").first().find("a").first().focus())},up:function e(){return o.focus(),!0},down:function e(){return r.focus(),!0},toggle:function e(){return!s.options.submenuToggle&&(t.children("[data-submenu]").length?(s.toggle(t.children("[data-submenu]")),!0):void 0)},closeAll:function e(){s.hideAll()},handled:function e(t){t&&n.preventDefault(),n.stopImmediatePropagation()}})})}
/**
...
/* harmony import */var i=n(/*! jquery */"jquery"),c=/* */n.n(i),o=n(/*! ./foundation.core.utils */"./js/foundation.core.utils.js"),d=n(/*! ./foundation.util.mediaQuery */"./js/foundation.util.mediaQuery.js"),r,f={version:"6.5.3",
/**
...
/**
   ...
   */
reInit:function e(t){var n=t instanceof c.a;try{if(n)t.each(function(){c()(this).data("zfPlugin")._init()});else{var i=s(t),o=this,r;({object:function e(t){t.forEach(function(e){e=u(e),c()("[data-"+e+"]").foundation("_init")})},string:function e(){t=u(t),c()("[data-"+t+"]").foundation("_init")},undefined:function e(){this.object(Object.keys(o._plugins))}})[i](t)}}catch(e){console.error(e)}finally{return t}},
/**
...
/**
     ...
     */
var t=function e(n){var t=s(n),i=a(".no-js");if(i.length&&i.removeClass("no-js"),"undefined"===t)
...
r[n].apply(a(t).data("zfPlugin"),o)})}return this};return a.fn.foundation=t,a}};
...
// Thank you: http://stackoverflow.com/a/8955580
function a(e){return e.replace(/([a-z])([A-Z])/g,"$1-$2").toLowerCase()}function s(e){return void 0!==e.constructor.name?a(e.constructor.name):a(e.className)}
/***/n.r(t),
...
/**
     * Fires when the plugin has initialized.
     * @event Plugin#init
     */,this.$element.trigger("init.zf.".concat(n))}return r(i,[{key:"destroy",value:function e(){this._destroy();var t=s(this);for(var n in this.$element.removeAttr("data-".concat(t)).removeData("zfPlugin")
/**
       * Fires when the plugin has been destroyed.
       * @event Plugin#destroyed
 ...
 */function l(a,e
/***/){var t=1<arguments.length&&void 0!==e?e:{},n=t.ignoreLeaveWindow,s=void 0!==n&&n,i=t.ignoreReappear,l=void 0!==i&&i;return function e(n){for(var t=arguments.length,i=new Array(1<t?t-1:0),o=1;o<t;o++)i[o-1]=arguments[o];var r=a.bind.apply(a,[this,n].concat(i));// The mouse left: call the given callback if the mouse entered elsewhere
if(null!==n.relatedTarget)return r();// Otherwise, check if the mouse actually left the window.
// In firefox if the user switched between windows, the window sill have the focus by the time
// the event is triggered. We have to debounce the event to test this case.
setTimeout(function e(){if(!s&&document.hasFocus&&!document.hasFocus())return r();// Otherwise, wait for the mouse to reeapear outside of the element,
...
0===e&&o.options.autoHeight&&o.$wrapper.css("height",p()(this).data("calcHeight"));var t=e==r.length-1;// Add transitionsend listener to last child (root due to reverse order) to open target menu's first link
...
/* */
function(e){function i(){return o(this,i),s(this,d(i).apply(this,arguments))}return f(i,e),a(i,[{key:"_setup",
/**
...
d._isRtl()?
// right aligned
p.a.extend(c,{down:a,up:s,next:u,previous:l}):
// left aligned
p.a.extend(c,{down:a,up:s,next:l,previous:u}):
// horizontal menu
d._isRtl()?
// right aligned
p.a.extend(c,{next:s,previous:a,down:l,up:u}):
// left aligned
p.a.extend(c,{next:a,previous:s,down:l,up:u}):
// not tabs -> one sub
d._isRtl()?
// right aligned
p.a.extend(c,{next:u,previous:l,down:a,up:s}):
// left aligned
p.a.extend(c,{next:l,previous:u,down:a,up:s}),v.Keyboard.handleKey(n,"DropdownMenu",c)})}
/**
     * Adds an event handler to the body to close any dropdowns on a click.
     * @function
     * @private
...
/**
     ...
     */},{key:"_show",value:function e(n){var t=this.$tabs.index(this.$tabs.filter(function(e,t){return 0<p()(t).find(n).length})),i=n.parent("li.is-dropdown-submenu-parent").siblings("li.is-dropdown-submenu-parent");this._hide(i,t),n.css("visibility","hidden").addClass("js-dropdown-active").parent("li.is-dropdown-submenu-parent").addClass("is-active");var o=y.Box.ImNotTouchingYou(n,null,!0);if(!o){var r="left"===this.options.alignment?"-right":"-left",a=n.parent(".is-dropdown-submenu-parent");a.removeClass("opens".concat(r)).addClass("opens-".concat(this.options.alignment)),(o=y.Box.ImNotTouchingYou(n,null,!0))||a.removeClass("opens-".concat(this.options.alignment)).addClass("opens-inner"),this.changed=!0}n.css("visibility",""),this.options.closeOnClick&&this._addBodyHandler()
/**
...
i[o]=[];for(var r=0,a=this.$watched.length;r<a;r++){this.$watched[r].style.height="auto";//maybe could use this.$watched[i].offsetTop
var s=p()(this.$watched[r]).offset().top;s!=n&&(i[++o]=[],n=s),i[o].push([this.$watched[r],this.$watched[r].offsetHeight])}for(var l=0,u=i.length;l<u;l++){var c=p()(i[l]).map(function(){return this[1]}).get(),d=Math.max.apply(null,c);i[l].push(d)}t(i)}
/**
...
/**
       * Fires before the heights are applied
       */
this.$element.trigger("preequalized.zf.equalizer");for(var n=0,i=t.length;n<i;n++){var o=t[n].length,r=t[n][o-1];if(o<=2)p()(t[n][0][0]).css({height:"auto"});else{
/**
          * Fires before the heights per row are applied
          * @event Equalizer#preequalizedrow
          */
this.$element.trigger("preequalizedrow.zf.equalizer");for(var a=0,s=o-1;a<s;a++)p()(t[n][a][0]).css({height:r});
/**
...
/* */
function(e){function l(){return o(this,l),s(this,u(l).apply(this,arguments))}return c(l,e),a(l,[{key:"_setup",
/**
...
/**
     ...
     */},{key:"_generateRules",value:function e(t){var n=[],i;for(var o in i="string"==typeof(i=this.options.rules?this.options.rules:this.$element.data("interchange"))?i.match(/\[.*?, .*?\]/g):i)if(i.hasOwnProperty(o)){var r=i[o].slice(1,-1).split(", "),a=r.slice(0,-1).join(""),s=r[r.length-1];l.SPECIAL_QUERIES[s]&&(s=l.SPECIAL_QUERIES[s]),n.push({path:a,query:s})}this.rules=n}
/**
...
var a=this.$active,s="";void 0!==t?(this.$active=this.$links.filter('[href="#'+this.$targets.eq(t).data("magellan-target")+'"]'),this.$active.length&&(s=this.$active[0].getAttribute("href"))):this.$active=p()();var l=!(!this.$active.length&&!a.length||this.$active.is(a)),u=s!==window.location.hash;// Update the hash (it may have changed with the same active link)
...
var o,r=new RegExp(Object(h.RegExpEscape)(this.options.revealClass)+"([^\\s]+)","g").exec(this.$element[0].className);r&&(this.options.isRevealed=!0,this.options.revealOn=this.options.revealOn||r[1]),// Ensure the `reveal-on-*` class is set.
...
var n=0,i,o=0,r=this;this.$slides.each(function(){i=this.getBoundingClientRect().height,p()(this).attr("data-slide",o),// hide all slides but the active one
/mui/g.test(p()(this)[0].className)||r.$slides.filter(".is-active")[0]===r.$slides.eq(o)[0]||p()(this).css({display:"none"}),n=n<i?i:n,o++}),o===this.$slides.length&&(this.$wrapper.css({height:n}),//only change the wrapper height property once.
t&&t(n))}
/**
...
/* */
function(e){function t(){return o(this,t),s(this,u(t).apply(this,arguments))}return c(t,e),a(t,[{key:"_init",
/**
...
// slightly off.
},{key:"_getVOffset",value:function e(){return this.options.vOffset}},{key:"_getHOffset",value:function e(){return this.options.hOffset}},{key:"_setPosition",value:function e(t,n,i){if("false"===t.attr("aria-expanded"))return!1;var o=p.Box.GetDimensions(n),r=p.Box.GetDimensions(t);if(this.options.allowOverlap||(
...
/* */
function(e){function t(){return o(this,t),s(this,u(t).apply(this,arguments))}return c(t,e),a(t,[{key:"_setup",
/**
...
;i<n.length;i++){var o=n[i].split("-"),r=1<o.length?o[0]:"small",a=1<o.length?o[1]:o[0];null!==b[a]&&(t[r]=b[a])}this.rules=t}this._getAllOptions(),p.a.isEmptyObject(this.rules)||this._checkMediaQueries()}},{key:"_getAllOptions",value:function e(){
//get all defaults and options
var t=this;for(var n in t.allOptions={},b)if(b.hasOwnProperty(n)){var i=b[n];try{var o=p()("<ul></ul>"),r=new i.plugin(o,t.options);for(var a in r.options)if(r.options.hasOwnProperty(a)&&"zfPlugin"!==a){var s=r.options[a];t.allOptions[a]=s}r.destroy()}catch(e){}}}
/**
...
if(h.MediaQuery._init(),"string"==typeof this.rules){// Iterate through every rule found
for(var t={},n=this.rules.split(" "),i=0// Parse rules from "classes" pulled from data attribute
;i<n.length;i++){var o=n[i].split("-"),r=1<o.length?o[0]:"small",a=1<o.length?o[1]:o[0];null!==w[a]&&(t[r]=w[a])}this.rules=t}p.a.isEmptyObject(this.rules)||this._checkMediaQueries(),// Add data-mutate since children may need it.
...
if(0===this.handles.index(t)){var a=parseFloat(this.$handle2.attr("aria-valuenow"));n=a<=n?a-this.options.step:n}else{var s=parseFloat(this.$handle.attr("aria-valuenow"));n=n<=s?s+this.options.step:n}var l=this,u=this.options.vertical,c=u?"height":"width",d=u?"top":"left",f=t[0].getBoundingClientRect()[c],p=this.$element[0].getBoundingClientRect()[c],
//percentage of bar min/max value based on click or drag point
h=this._pctOfBar(n),
//number of actual pixels to shift the handle, based on the percentage obtained above
m,
//percentage of bar to shift the handle
v=(100*C((p-f)*h,p)).toFixed(this.options.decimal);//fixing the decimal value for the location number, is passed to other methods as a fixed floating-point value
...
w=~~(100*C(f,p));//if left handle, the math is slightly different than if it's the right handle, and the left/top property needs to be changed for the fill bar
if(y)
...
t.preventDefault();var a=this,s=this.options.vertical,l=s?"height":"width",u=s?"top":"left",c=s?t.pageY:t.pageX,d=this.$handle[0].getBoundingClientRect()[l]/2,f=this.$element[0].getBoundingClientRect()[l],p=s?x()(window).scrollTop():x()(window).scrollLeft(),h=this.$element.offset()[u];// touch events emulated by the touch util give position relative to screen, add window.scroll to event coordinates...
// best way to guess this is simulated is if clientY == pageY
t.clientY===t.pageY&&(c+=p);var m=c-h,v,g=C(v=m<0?0:f<m?f:m,f),y,b;if(o=this._value(g),// turn everything around for RTL, yay math!
Object(T.rtl)()&&!this.options.vertical&&(o=this.options.end-o),o=a._adjustValue(null,o),//boolean flag for the setHandlePos fn, specifically for vertical sliders
...
/**
     ...
     */},{key:"_adjustValue",value:function e(t,n){var i,o=this.options.step,r=parseFloat(o/2),a,s,l;return 0===(a=0<=(i=t?parseFloat(t.attr("aria-valuenow")):n)?i%o:o+i%o)?i:i=(s=i-a)+r<=i?l=s+o:s}
/**
...
/**
     ...
     */},{key:"_eventsForHandle",value:function e(t){var r=this,n,i,o=function e(t){var n=r.inputs.index(x()(this));r._handleEvent(t,r.handles.eq(n),x()(this).val())};if(// IE only triggers the change event when the input loses focus which strictly follows the HTML specification
// listen for the enter key and trigger a change
// @see https://html.spec.whatwg.org/multipage/input.html#common-input-element-events
this.inputs.off("keyup.zf.slider").on("keyup.zf.slider",function(e){13==e.keyCode&&o.call(this,e)}),this.inputs.off("change.zf.slider").on("change.zf.slider",o),this.options.clickSelect&&this.$element.off("click.zf.slider").on("click.zf.slider",function(e){if(r.$element.data("dragging"))return!1;x()(e.target).is("[data-slider-handle]")||(r.options.doubleSided?r._handleEvent(e):r._handleEvent(e,r.$handle))}),this.options.draggable){this.handles.addTouch();var a=x()("body");t.off("mousedown.zf.slider").on("mousedown.zf.slider",function(e){t.addClass("is-dragging"),r.$fill.addClass("is-dragging"),//
r.$element.data("dragging",!0),n=x()(e.currentTarget),a.on("mousemove.zf.slider",function(e){e.preventDefault(),r._handleEvent(e,n)}).on("mouseup.zf.slider",function(e){r._handleEvent(e,n),t.removeClass("is-dragging"),r.$fill.removeClass("is-dragging"),r.$element.data("dragging",!1),a.off("mousemove.zf.slider mouseup.zf.slider")})}).on("selectstart.zf.slider touchmove.zf.slider",function(e){e.preventDefault()})}t.off("keydown.zf.slider").on("keydown.zf.slider",function(t){var n=x()(this),e=r.options.doubleSided?r.handles.index(n):0,i=parseFloat(r.inputs.eq(e).val()),o;// handle keyboard event with keyboard util
h.Keyboard.handleKey(t,"Slider",{decrease:function e(){o=i-r.options.step},increase:function e(){o=i+r.options.step},decrease_fast:function e(){o=i-10*r.options.step},increase_fast:function e(){o=i+10*r.options.step},min:function e(){o=r.options.start},max:function e(){o=r.options.end},handled:function e(){
...
/**
     ...
     * @function
     */
value:function e(t,n,i){var o=1<arguments.length&&void 0!==n?n:l.defaults,r=2<arguments.length?i:void 0,a=p()(t);// Do nothing if target does not exist to prevent errors
if(!a.length)return!1;var s=Math.round(a.offset().top-o.threshold/2-o.offset);p()("html, body").stop(!0).animate({scrollTop:s},o.animationDuration,o.animationEasing,function(){"function"==typeof r&&r()})}}]),l}(n(/*! ./foundation.core.plugin */"./js/foundation.core.plugin.js").Plugin);
/* harmony import */
/**
 * Default settings for plugin.
 */
...
/**
     ...
     * @function
     * @private
     */},{key:"_parsePoints",value:function e(){for(var t,n,i=[""==this.options.topAnchor?1:this.options.topAnchor,""==this.options.btmAnchor?document.documentElement.scrollHeight:this.options.btmAnchor],o={},r=0,a=i.length;r<a&&i[r];r++){var s;if("number"==typeof i[r])s=i[r];else{var l=i[r].split(":"),u=h()("#".concat(l[0]));s=u.offset().top,l[1]&&"bottom"===l[1].toLowerCase()&&(s+=u[0].getBoundingClientRect().height)}o[r]=s}this.points=o}
/**
...
/**
     ...
     * @private
     */},{key:"_removeSticky",value:function e(t){var n=this.options.stickTo,i="top"===n,o={},r=(this.points?this.points[1]-this.points[0]:this.anchorHeight)-this.elemHeight,a,s=i?"bottom":"top",l=t?"top":"bottom";o[i?"marginTop":"marginBottom"]=0,o.bottom="auto",o.top=t?0:r,this.isStuck=!1,this.$element.removeClass("is-stuck is-at-".concat(n)).addClass("is-anchored is-at-".concat(l)).css(o)
/**
...
/**
     ...
     * @private
     */},{key:"_init",value:function e(){var r=this,a=this;if(this._isInitializing=!0,this.$element.attr({role:"tablist"}),this.$tabTitles=this.$element.find(".".concat(this.options.linkClass)),this.$tabContent=p()('[data-tabs-content="'.concat(this.$element[0].id,'"]')),this.$tabTitles.each(function(){var e=p()(this),t=e.find("a"),n=e.hasClass("".concat(a.options.linkActiveClass)),i=t.attr("data-tabs-target")||t[0].hash.slice(1),o=t[0].id?t[0].id:"".concat(i,"-label"),r=p()("#".concat(i));e.attr({role:"presentation"}),t.attr({role:"tab","aria-controls":i,"aria-selected":n,id:o,tabindex:n?"0":"-1"}),r.attr({role:"tabpanel","aria-labelledby":o}),// Save up the initial hash to return to it later when going back in history
n&&(a._initialAnchor="#".concat(i)),n||r.attr("aria-hidden","true"),n&&a.options.autoFocus&&(a.onLoadListener=Object(h.onLoad)(p()(window),function(){p()("html, body").animate({scrollTop:e.offset().top},a.options.deepLinkSmudgeDelay,function(){t.focus()})}))}),this.options.matchHeight){var t=this.$tabContent.find("img");t.length?Object(v.onImagesLoaded)(t,this._setHeight.bind(this)):this._setHeight()}// Current context-bound function to open tabs on page load or history hashchange
...
r._initialAnchor&&(e=r._initialAnchor)}var t=e&&p()(e),n=e&&r.$element.find('[href$="'+e+'"]'),i=!(!t.length||!n.length);if(// If there is an anchor for the hash, select it
t&&t.length&&n&&n.length?r.selectTab(t,!0):r._collapse(),i){
// Roll up a little to show the titles
if(r.options.deepLinkSmudge){var o=r.$element.offset();p()("html, body").animate({scrollTop:o.top},r.options.deepLinkSmudgeDelay)}
/**
           * Fires when the plugin has deeplinked at pageload
           * @event Tabs#deeplink
...
/**
     ...
     * @private
     */},{key:"_addKeyHandler",value:function e(){var a=this;this.$tabTitles.off("keydown.zf.tabs").on("keydown.zf.tabs",function(t){if(9!==t.which){var n=p()(this),i=n.parent("ul").children("li"),o,r;i.each(function(e){p()(this).is(n)&&(r=a.options.wrapOnKeys?(o=0===e?i.last():i.eq(e-1),e===i.length-1?i.first():i.eq(e+1)):(o=i.eq(Math.max(0,e-1)),i.eq(Math.min(e+1,i.length-1))))}),// handle keyboard event with keyboard util
m.Keyboard.handleKey(t,"Tabs",{open:function e(){n.find('[role="tab"]').focus(),a._handleTabChange(n)},previous:function e(){o.find('[role="tab"]').focus(),a._handleTabChange(o)},next:function e(){r.find('[role="tab"]').focus(),a._handleTabChange(r)},handled:function e(){t.stopPropagation(),t.preventDefault()}})}})}
/**
...
var r=this.$element[0].id,n=p()('[data-open~="'.concat(r,'"], [data-close~="').concat(r,'"], [data-toggle~="').concat(r,'"]'));// - aria-expanded: according to the element visibility.
n.attr("aria-expanded",!this.$element.is(":hidden")),// - aria-controls: adding the element id to it if not already in it.
n.each(function(e,t){var n=p()(t),i=n.attr("aria-controls")||"",o;new RegExp("\\b".concat(Object(v.RegExpEscape)(r),"\\b")).test(i)||n.attr("aria-controls",i?"".concat(i," ").concat(r):r)})}
/**
...
/***/function(e,t,n){"use strict";function i(e,t,n,i,o){return 0===r(e,t,n,i,o)}function r(e,t,n,i,o){var r=d(e),a,s,l,u;if(t){var c=d(t);s=c.height+c.offset.top-(r.offset.top+r.height),a=r.offset.top-c.offset.top,l=r.offset.left-c.offset.left,u=c.width+c.offset.left-(r.offset.left+r.width)}else s=r.windowDims.height+r.windowDims.offset.top-(r.offset.top+r.height),a=r.offset.top-r.windowDims.offset.top,l=r.offset.left-r.windowDims.offset.left,u=r.windowDims.width-(r.offset.left+r.width);return s=o?0:Math.min(s,0),a=Math.min(a,0),l=Math.min(l,0),u=Math.min(u,0),n?l+u:i?a+s:Math.sqrt(a*a+s*s+l*l+u*u)}
/**
...
})}function a(e){var t=s[e.which||e.keyCode]||String.fromCharCode(e.which).toUpperCase();// Remove un-printable characters, e.g. for `fromCharCode` calls for CTRL only events
...
/**
   ...
   */
handleKey:function e(t,n,i){var o=f[n],r=this.parseKey(t),a,s,l;if(!o)return console.warn("Component not defined!");if((l=i[s=(
...
/**
   ...
   */
trapFocus:function e(t){var n=r(t),i=n.eq(0),o=n.eq(-1);t.on("keydown.zf.trapfocus",function(e){e.target===o[0]&&"TAB"===a(e)?(e.preventDefault(),i.focus()):e.target===i[0]&&"SHIFT_TAB"===a(e)&&(e.preventDefault(),o.focus())})},
/**
...
/* harmony import */var i=n(/*! jquery */"jquery"),s=/* */n.n(i),r={default:"only screen",landscape:"only screen and (orientation: landscape)",portrait:"only screen and (orientation: portrait)",retina:"only screen and (-webkit-min-device-pixel-ratio: 2),only screen and (min--moz-device-pixel-ratio: 2),only screen and (-o-min-device-pixel-ratio: 2/1),only screen and (min-device-pixel-ratio: 2),only screen and (min-resolution: 192dpi),only screen and (min-resolution: 2dppx)"};
...
/**
   ...
   * @private
   */
_init:function e(){var t=this,n;s()("meta.foundation-mq").length||s()('<meta class="foundation-mq">').appendTo(document.head);var i=s()(".foundation-mq").css("font-family"),o;for(var r in o=a(i))o.hasOwnProperty(r)&&t.queries.push({name:r,value:"only screen and (min-width: ".concat(o[r],")")});this.current=this._getCurrentSize(),this._watcher()},
/**
...
a=e-s,i.apply(n),a<t?r=window.requestAnimationFrame(o,n):(window.cancelAnimationFrame(r),n.trigger("finished.zf.animate",[n]).triggerHandler("finished.zf.animate",[n]))}var r,a,s=null;// console.log('called');
...
function r(){t[0].style.transitionDuration=0,t.removeClass("".concat(a," ").concat(s," ").concat(n))}if((t=l()(t).eq(0)).length){var a=e?c[0]:c[1],s=e?d[0]:d[1];// Set up the animation
r(),t.addClass(n).css("transition","none"),requestAnimationFrame(function(){t.addClass(a),e&&t.show()}),// Start the animation
...
/* harmony import */var r=n(/*! jquery */"jquery"),l=/* */n.n(r),u=n(/*! ./foundation.core.utils */"./js/foundation.core.utils.js"),c=["mui-enter","mui-leave"],d=["mui-enter-active","mui-leave-active"],a={animateIn:function e(t,n,i){o(!0,t,n,i)},animateOut:function e(t,n,i){o(!1,t,n,i)}};
/* harmony import */},
...
/* harmony import */var i=n(/*! jquery */"jquery"),u=/* */n.n(i),o={Feather:function e(t,n){var i=1<arguments.length&&void 0!==n?n:"zf";t.attr("role","menubar");var o=t.find("li").attr({role:"menuitem"}),r="is-".concat(i,"-submenu"),a="".concat(r,"-item"),s="is-".concat(i,"-submenu-parent"),l="accordion"!==i;// Accordions handle their own ARIA attriutes.
...
"drilldown"===i&&e.attr({"aria-expanded":!1})),t.addClass("submenu ".concat(r)).attr({"data-submenu":"",role:"menubar"}),"drilldown"===i&&t.attr({"aria-hidden":!0})),e.parent("[data-submenu]").length&&e.addClass("is-submenu-item ".concat(a))})},Burn:function e(t,n){var//items = menu.find('li'),
...
r=Object.keys(t.data())[0]||"timer",a=-1,s,l;this.isPaused=!1,this.restart=function(){a=-1,clearTimeout(l),this.start()},this.start=function(){this.isPaused=!1,// if(!elem.data('paused')){ return false; }//maybe implement this sanity check if used for other things.
clearTimeout(l),a=a<=0?o:a,t.data("paused",!1),s=Date.now(),l=setTimeout(function(){e.infinite&&i.restart(),n&&"function"==typeof n&&n()},a),t.trigger("timerstart.zf.".concat(r))},this.pause=function(){this.isPaused=!0,//if(elem.data('paused')){ return false; }//maybe implement this sanity check if used for other things.
clearTimeout(l),t.data("paused",!0);var e=Date.now();a-=e-s,t.trigger("timerpaused.zf.".concat(r))}}
/***/n.r(t),
...
if(this.removeEventListener("touchmove",s),this.removeEventListener("touchend",a),!w){var t=f.a.Event("tap",y||e);f()(this).trigger(t)}y=null,w=b=!1}function s(e){if(f.a.spotSwipe.preventDefault&&e.preventDefault(),b){var t=e.touches[0].pageX,n=e.touches[0].pageY,i=h-t,o=m-n,r;w=!0,g=(new Date).getTime()-v,Math.abs(i)>=f.a.spotSwipe.moveThreshold&&g<=f.a.spotSwipe.timeThreshold&&(r=0<i?"left":"right"),// else if(Math.abs(dy) >= $.spotSwipe.moveThreshold && elapsedTime <= $.spotSwipe.timeThreshold) {
//   dir = dy > 0 ? 'down' : 'up';
// }
r&&(e.preventDefault(),a.apply(this,arguments),f()(this).trigger(f.a.Event("swipe",e),r).trigger(f.a.Event("swipe".concat(r),e)))}}function l(e){1==e.touches.length&&(h=e.touches[0].pageX,m=e.touches[0].pageY,y=e,w=!(b=!0),v=(new Date).getTime(),this.addEventListener("touchmove",s,!1),this.addEventListener("touchend",a,!1))}function u(){this.addEventListener&&this.addEventListener("touchstart",l,!1)}function c(){this.removeEventListener("touchstart",l)}n.r(t),
...
n(e)})});var n=function e(t){var n,i=t.changedTouches[0],o,r={touchstart:"mousedown",touchmove:"mousemove",touchend:"mouseup"}[t.type],a;"MouseEvent"in window&&"function"==typeof window.MouseEvent?a=new window.MouseEvent(r,{bubbles:!0,cancelable:!0,screenX:i.screenX,screenY:i.screenY,clientX:i.clientX,clientY:i.clientY}):(a=document.createEvent("MouseEvent")).initMouseEvent(r,!0,!0,window,1,i.screenX,i.screenY,i.clientX,i.clientY,!1,!1,!1,!1,0
/*left*/,null),i.target.dispatchEvent(a)}}},p.init=function(e){void 0===e.spotSwipe&&(p.setupSpotSwipe(e),p.setupTouchHandler(e))}},
...
// String
if("string"==typeof e){var o,r,a=e.trim();if(0<=a.indexOf("<")&&0<=a.indexOf(">")){var s="div";for(0===a.indexOf("<li")&&(s="ul"),0===a.indexOf("<tr")&&(s="tbody"),0!==a.indexOf("<td")&&0!==a.indexOf("<th")||(s="tr"),0===a.indexOf("<tbody")&&(s="table"),0===a.indexOf("<option")&&(s="select"),(r=Me.createElement(s)).innerHTML=a,i=0;i<r.childNodes.length;i+=1)n.push(r.childNodes[i])}else for(
// Other selectors
...
for(i=0;i<e.length;i+=1)n.push(e[i]);return new Ae(n)}function r(e){for(var t=[],n=0;n<e.length;n+=1)-1===t.indexOf(e[n])&&t.push(e[n]);return t}
...
// eslint-disable-next-line
function a(e){for(var t=0;t<this.length;t+=1)this[t].removeAttribute(e);return this}function s(e,t){var n;if(void 0!==t){
// Set value
...
if(e.target===this)for(t.call(this,e),r=0;r<i.length;r+=1)o.off(i[r],n)}var i=["webkitTransitionEnd","transitionend"],o=this,r;if(t)for(r=0;r<i.length;r+=1)o.on(i[r],n);return this}function h(e){if(0<this.length){if(e){
// eslint-disable-next-line
...
// eslint-disable-next-line
var t=this.styles();return this[0].offsetHeight+parseFloat(t.getPropertyValue("margin-top"))+parseFloat(t.getPropertyValue("margin-bottom"))}return this[0].offsetHeight}return null}function v(){if(0<this.length){var e=this[0],t=e.getBoundingClientRect(),n=Me.body,i=e.clientTop||n.clientTop||0,o=e.clientLeft||n.clientLeft||0,r=e===Le?Le.scrollY:e.scrollTop,a=e===Le?Le.scrollX:e.scrollLeft;return{top:t.top+r-i,left:t.left+a-o}}return null}function g(){return this[0]?Le.getComputedStyle(this[0],null):{}}function y(e,t){var n;if(1===arguments.length){if("string"!=typeof e){for(n=0;n<this.length;n+=1)
// eslint-disable-next-line
...
// eslint-disable-next-line
function x(e){if(void 0===e)return this[0]?this[0].textContent.trim():null;for(var t=0;t<this.length;t+=1)this[t].textContent=e;return this}function T(e){var t=this[0],n,i;if(!t||void 0===e)return!1;if("string"==typeof e){if(t.matches)return t.matches(e);if(t.webkitMatchesSelector)return t.webkitMatchesSelector(e);if(t.msMatchesSelector)return t.msMatchesSelector(e);for(n=P(e),i=0;i<n.length;i+=1)if(n[i]===t)return!0;return!1}if(e===Me)return t===Me;if(e===Le)return t===Le;if(e.nodeType||e instanceof Ae){for(n=e.nodeType?[e]:e,i=0;i<n.length;i+=1)if(n[i]===t)return!0;return!1}return!1}function C(){var e=this[0],t;if(e){
// eslint-disable-next-line
for(t=0;null!==(e=e.previousSibling);)1===e.nodeType&&(t+=1);return t}}
// eslint-disable-next-line
function k(e){if(void 0===e)return this;var t=this.length,n;return new Ae(t-1<e?[]:e<0?(n=t+e)<0?[]:[this[n]]:[this[e]])}function E(){for(var e=[],t=arguments.length,n;t--;)e[t]=arguments[t];for(var i=0;i<e.length;i+=1){n=e[i];for(var o=0;o<this.length;o+=1)if("string"==typeof n){var r=Me.createElement("div");for(r.innerHTML=n;r.firstChild;)this[o].appendChild(r.firstChild)}else if(n instanceof Ae)for(var a=0;a<n.length;a+=1)this[o].appendChild(n[a]);else this[o].appendChild(n)}return this}function S(e){var t,n;for(t=0;t<this.length;t+=1)if("string"==typeof e){var i=Me.createElement("div");for(i.innerHTML=e,n=i.childNodes.length-1;0<=n;n-=1)this[t].insertBefore(i.childNodes[n],this[t].childNodes[0])}else if(e instanceof Ae)for(n=0;n<e.length;n+=1)this[t].insertBefore(e[n],this[t].childNodes[0]);else this[t].insertBefore(e,this[t].childNodes[0]);return this}function $(e){return 0<this.length?e?this[0].nextElementSibling&&P(this[0].nextElementSibling).is(e)?new Ae([this[0].nextElementSibling]):new Ae([]):this[0].nextElementSibling?new Ae([this[0].nextElementSibling]):new Ae([]):new Ae([])}function j(e){var t=[],n=this[0];if(!n)return new Ae([]);for(;n.nextElementSibling;){var i=n.nextElementSibling;// eslint-disable-line
e?P(i).is(e)&&t.push(i):t.push(i),n=i}return new Ae(t)}function O(e){if(0<this.length){var t=this[0];return e?t.previousElementSibling&&P(t.previousElementSibling).is(e)?new Ae([t.previousElementSibling]):new Ae([]):t.previousElementSibling?new Ae([t.previousElementSibling]):new Ae([])}return new Ae([])}function _(e){var t=[],n=this[0];if(!n)return new Ae([]);for(;n.previousElementSibling;){var i=n.previousElementSibling;// eslint-disable-line
e?P(i).is(e)&&t.push(i):t.push(i),n=i}return new Ae(t)}function z(e){// eslint-disable-line
for(var t=[],n=0;n<this.length;n+=1)null!==this[n].parentNode&&(e?P(this[n].parentNode).is(e)&&t.push(this[n].parentNode):t.push(this[n].parentNode));return P(r(t))}function M(e){// eslint-disable-line
for(var t=[],n=0;n<this.length;n+=1)// eslint-disable-line
for(var i=this[n].parentNode;i;)e?P(i).is(e)&&t.push(i):t.push(i),i=i.parentNode;return P(r(t))}function L(e){var t=this;// eslint-disable-line
...
for(var t=[],n=0;n<this.length;n+=1)for(var i=this[n].childNodes,o=0;o<i.length;o+=1)e?1===i[o].nodeType&&P(i[o]).is(e)&&t.push(i[o]):1===i[o].nodeType&&t.push(i[o]);return new Ae(r(t))}function I(){for(var e=0;e<this.length;e+=1)this[e].parentNode&&this[e].parentNode.removeChild(this[e]);return this}function H(){for(var e=[],t=arguments.length;t--;)e[t]=arguments[t];var n=this,i,o;for(i=0;i<e.length;i+=1){var r=P(e[i]);for(o=0;o<r.length;o+=1)n[n.length]=r[o],n.length+=1}return n}function q(){var e=this,t,n,i=e.$el;t=void 0!==e.params.width?e.params.width:i[0].clientWidth,n=void 0!==e.params.height?e.params.height:i[0].clientHeight,0===t&&e.isHorizontal()||0===n&&e.isVertical()||(
// Subtract paddings
t=t-parseInt(i.css("padding-left"),10)-parseInt(i.css("padding-right"),10),n=n-parseInt(i.css("padding-top"),10)-parseInt(i.css("padding-bottom"),10),Ie.extend(e,{width:t,height:n,size:e.isHorizontal()?t:n}))}function R(){var e=this,t=e.params,n=e.$wrapperEl,i=e.size,o=e.rtlTranslate,r=e.wrongRTL,a=e.virtual&&t.virtual.enabled,s=a?e.virtual.slides.length:e.slides.length,l=n.children("."+e.params.slideClass),u=a?e.virtual.slides.length:l.length,c=[],d=[],f=[],p=t.slidesOffsetBefore;"function"==typeof p&&(p=t.slidesOffsetBefore.call(e));var h=t.slidesOffsetAfter;"function"==typeof h&&(h=t.slidesOffsetAfter.call(e));var m=e.snapGrid.length,v=e.snapGrid.length,g=t.spaceBetween,y=-p,b=0,w=0;if(void 0!==i){var x,T;"string"==typeof g&&0<=g.indexOf("%")&&(g=parseFloat(g.replace("%",""))/100*i),e.virtualSize=-g,
// reset margins
o?l.css({marginLeft:"",marginTop:""}):l.css({marginRight:"",marginBottom:""}),1<t.slidesPerColumn&&(x=Math.floor(u/t.slidesPerColumn)===u/e.params.slidesPerColumn?u:Math.ceil(u/t.slidesPerColumn)*t.slidesPerColumn,"auto"!==t.slidesPerView&&"row"===t.slidesPerColumnFill&&(x=Math.max(x,t.slidesPerView*t.slidesPerColumn)));for(var C=t.slidesPerColumn,k=x/C,E=Math.floor(u/t.slidesPerColumn),S=0,$;S<u;S+=1){T=0;var j=l.eq(S);if(1<t.slidesPerColumn){
// Set slides order
var O=void 0,_=void 0,z=void 0;"column"===t.slidesPerColumnFill?(z=S-(_=Math.floor(S/C))*C,(E<_||_===E&&z===C-1)&&C<=(z+=1)&&(z=0,_+=1),O=_+z*x/C,j.css({"-webkit-box-ordinal-group":O,"-moz-box-ordinal-group":O,"-ms-flex-order":O,"-webkit-order":O,order:O})):_=S-(z=Math.floor(S/k))*k,j.css("margin-"+(e.isHorizontal()?"top":"left"),0!==z&&t.spaceBetween&&t.spaceBetween+"px").attr("data-swiper-column",_).attr("data-swiper-row",z)}if("none"!==j.css("display")){// eslint-disable-line
if("auto"===t.slidesPerView){var P=Le.getComputedStyle(j[0],null),M=j[0].style.transform,L=j[0].style.webkitTransform;if(M&&(j[0].style.transform="none"),L&&(j[0].style.webkitTransform="none"),t.roundLengths)T=e.isHorizontal()?j.outerWidth(!0):j.outerHeight(!0);else
// eslint-disable-next-line
if(e.isHorizontal()){var A=parseFloat(P.getPropertyValue("width")),D=parseFloat(P.getPropertyValue("padding-left")),I=parseFloat(P.getPropertyValue("padding-right")),H=parseFloat(P.getPropertyValue("margin-left")),q=parseFloat(P.getPropertyValue("margin-right")),R=P.getPropertyValue("box-sizing");T=R&&"border-box"===R?A+H+q:A+D+I+H+q}else{var N=parseFloat(P.getPropertyValue("height")),F=parseFloat(P.getPropertyValue("padding-top")),B=parseFloat(P.getPropertyValue("padding-bottom")),G=parseFloat(P.getPropertyValue("margin-top")),W=parseFloat(P.getPropertyValue("margin-bottom")),Y=P.getPropertyValue("box-sizing");T=Y&&"border-box"===Y?N+G+W:N+F+B+G+W}M&&(j[0].style.transform=M),L&&(j[0].style.webkitTransform=L),t.roundLengths&&(T=Math.floor(T))}else T=(i-(t.slidesPerView-1)*g)/t.slidesPerView,t.roundLengths&&(T=Math.floor(T)),l[S]&&(e.isHorizontal()?l[S].style.width=T+"px":l[S].style.height=T+"px");l[S]&&(l[S].swiperSlideSize=T),f.push(T),t.centeredSlides?(y=y+T/2+b/2+g,0===b&&0!==S&&(y=y-i/2-g),0===S&&(y=y-i/2-g),Math.abs(y)<.001&&(y=0),t.roundLengths&&(y=Math.floor(y)),w%t.slidesPerGroup==0&&c.push(y),d.push(y)):(t.roundLengths&&(y=Math.floor(y)),w%t.slidesPerGroup==0&&c.push(y),d.push(y),y=y+T+g),e.virtualSize+=T+g,b=T,w+=1}}if(e.virtualSize=Math.max(e.virtualSize,i)+h,o&&r&&("slide"===t.effect||"coverflow"===t.effect)&&n.css({width:e.virtualSize+t.spaceBetween+"px"}),He.flexbox&&!t.setWrapperSize||(e.isHorizontal()?n.css({width:e.virtualSize+t.spaceBetween+"px"}):n.css({height:e.virtualSize+t.spaceBetween+"px"})),1<t.slidesPerColumn&&(e.virtualSize=(T+t.spaceBetween)*x,e.virtualSize=Math.ceil(e.virtualSize/t.slidesPerColumn)-t.spaceBetween,e.isHorizontal()?n.css({width:e.virtualSize+t.spaceBetween+"px"}):n.css({height:e.virtualSize+t.spaceBetween+"px"}),t.centeredSlides)){$=[];for(var V=0;V<c.length;V+=1){var X=c[V];t.roundLengths&&(X=Math.floor(X)),c[V]<e.virtualSize+c[0]&&$.push(X)}c=$}
...
if("number"==typeof e?t.setTransition(e):!0===e&&t.setTransition(t.params.speed),"auto"!==t.params.slidesPerView&&1<t.params.slidesPerView)for(o=0;o<Math.ceil(t.params.slidesPerView);o+=1){var r=t.activeIndex+o;if(r>t.slides.length)break;n.push(t.slides.eq(r)[0])}else n.push(t.slides.eq(t.activeIndex)[0]);
// Find new height from highest slide in view
for(o=0;o<n.length;o+=1)if(void 0!==n[o]){var a=n[o].offsetHeight;i=i<a?a:i}
// Update Height
i&&t.$wrapperEl.css("height",i+"px")}function F(){for(var e=this,t=e.slides,n=0;n<t.length;n+=1)t[n].swiperSlideOffset=e.isHorizontal()?t[n].offsetLeft:t[n].offsetTop}function B(e){void 0===e&&(e=this&&this.translate||0);var t=this,n=t.params,i=t.slides,o=t.rtlTranslate;if(0!==i.length){void 0===i[0].swiperSlideOffset&&t.updateSlidesOffset();var r=-e;o&&(r=e),
// Visible Slides
i.removeClass(n.slideVisibleClass),t.visibleSlidesIndexes=[],t.visibleSlides=[];for(var a=0;a<i.length;a+=1){var s=i[a],l=(r+(n.centeredSlides?t.minTranslate():0)-s.swiperSlideOffset)/(s.swiperSlideSize+n.spaceBetween);if(n.watchSlidesVisibility){var u=-(r-s.swiperSlideOffset),c=u+t.slidesSizesGrid[a],d;(0<=u&&u<t.size||0<c&&c<=t.size||u<=0&&c>=t.size)&&(t.visibleSlides.push(s),t.visibleSlidesIndexes.push(a),i.eq(a).addClass(n.slideVisibleClass))}s.progress=o?-l:l}t.visibleSlides=P(t.visibleSlides)}}function G(e){void 0===e&&(e=this&&this.translate||0);var t=this,n=t.params,i=t.maxTranslate()-t.minTranslate(),o=t.progress,r=t.isBeginning,a=t.isEnd,s=r,l=a;a=0===i?r=!(o=0):(r=(o=(e-t.minTranslate())/i)<=0,1<=o),Ie.extend(t,{progress:o,isBeginning:r,isEnd:a}),(n.watchSlidesProgress||n.watchSlidesVisibility)&&t.updateSlidesProgress(e),r&&!s&&t.emit("reachBeginning toEdge"),a&&!l&&t.emit("reachEnd toEdge"),(s&&!r||l&&!a)&&t.emit("fromEdge"),t.emit("progress",o)}function W(){var e=this,t=e.slides,n=e.params,i=e.$wrapperEl,o=e.activeIndex,r=e.realIndex,a=e.virtual&&n.virtual.enabled,s;t.removeClass(n.slideActiveClass+" "+n.slideNextClass+" "+n.slidePrevClass+" "+n.slideDuplicateActiveClass+" "+n.slideDuplicateNextClass+" "+n.slideDuplicatePrevClass),
// Active classes
(s=a?e.$wrapperEl.find("."+n.slideClass+'[data-swiper-slide-index="'+o+'"]'):t.eq(o)).addClass(n.slideActiveClass),n.loop&&(
// Duplicate to all looped slides
s.hasClass(n.slideDuplicateClass)?i.children("."+n.slideClass+":not(."+n.slideDuplicateClass+')[data-swiper-slide-index="'+r+'"]').addClass(n.slideDuplicateActiveClass):i.children("."+n.slideClass+"."+n.slideDuplicateClass+'[data-swiper-slide-index="'+r+'"]').addClass(n.slideDuplicateActiveClass));
// Next Slide
...
r.normalizeSlideIndex&&(u<0||void 0===u)&&(u=0)}if((c=0<=o.indexOf(n)?o.indexOf(n):Math.floor(u/r.slidesPerGroup))>=o.length&&(c=o.length-1),u!==a){
// Get real index
var f=parseInt(t.slides.eq(u).attr("data-swiper-slide-index")||u,10);Ie.extend(t,{snapIndex:c,realIndex:f,previousIndex:a,activeIndex:u}),t.emit("activeIndexChange"),t.emit("snapIndexChange"),s!==f&&t.emit("realIndexChange"),t.emit("slideChange")}else c!==l&&(t.snapIndex=c,t.emit("snapIndexChange"))}function V(e){var t=this,n=t.params,i=P(e.target).closest("."+n.slideClass)[0],o=!1;if(i)for(var r=0;r<t.slides.length;r+=1)t.slides[r]===i&&(o=!0);if(!i||!o)return t.clickedSlide=void 0,void(t.clickedIndex=void 0);t.clickedSlide=i,t.virtual&&t.params.virtual.enabled?t.clickedIndex=parseInt(P(i).attr("data-swiper-slide-index"),10):t.clickedIndex=P(i).index(),n.slideToClickedSlide&&void 0!==t.clickedIndex&&t.clickedIndex!==t.activeIndex&&t.slideToClickedSlide()}function X(e){void 0===e&&(e=this.isHorizontal()?"x":"y");var t=this,n=t.params,i=t.rtlTranslate,o=t.translate,r=t.$wrapperEl;if(n.virtualTranslate)return i?-o:o;var a=Ie.getTranslate(r[0],e);return i&&(a=-a),a||0}function U(e,t){var n=this,i=n.rtlTranslate,o=n.params,r=n.$wrapperEl,a=n.progress,s=0,l=0,u=0,c;n.isHorizontal()?s=i?-e:e:l=e,o.roundLengths&&(s=Math.floor(s),l=Math.floor(l)),o.virtualTranslate||(He.transforms3d?r.transform("translate3d("+s+"px, "+l+"px, 0px)"):r.transform("translate("+s+"px, "+l+"px)")),n.previousTranslate=n.translate,n.translate=n.isHorizontal()?s:l;var d=n.maxTranslate()-n.minTranslate();(c=0===d?0:(e-n.minTranslate())/d)!==a&&n.updateProgress(e),n.emit("setTranslate",n.translate,t)}function K(){return-this.snapGrid[0]}function Q(){return-this.snapGrid[this.snapGrid.length-1]}function Z(e,t){var n=this;n.$wrapperEl.transition(e),n.emit("setTransition",e,t)}function J(e,t){void 0===e&&(e=!0);var n=this,i=n.activeIndex,o=n.params,r=n.previousIndex;o.autoHeight&&n.updateAutoHeight();var a=t;if(a||(a=r<i?"next":i<r?"prev":"reset"),n.emit("transitionStart"),e&&i!==r){if("reset"===a)return void n.emit("slideResetTransitionStart");n.emit("slideChangeTransitionStart"),"next"===a?n.emit("slideNextTransitionStart"):n.emit("slidePrevTransitionStart")}}function ee(e,t){void 0===e&&(e=!0);var n=this,i=n.activeIndex,o=n.previousIndex;n.animating=!1,n.setTransition(0);var r=t;if(r||(r=o<i?"next":i<o?"prev":"reset"),n.emit("transitionEnd"),e&&i!==o){if("reset"===r)return void n.emit("slideResetTransitionEnd");n.emit("slideChangeTransitionEnd"),"next"===r?n.emit("slideNextTransitionEnd"):n.emit("slidePrevTransitionEnd")}}function te(e,t,n,i){void 0===e&&(e=0),void 0===t&&(t=this.params.speed),void 0===n&&(n=!0);var o=this,r=e;r<0&&(r=0);var a=o.params,s=o.snapGrid,l=o.slidesGrid,u=o.previousIndex,c=o.activeIndex,d=o.rtlTranslate;if(o.animating&&a.preventInteractionOnTransition)return!1;var f=Math.floor(r/a.slidesPerGroup);f>=s.length&&(f=s.length-1),(c||a.initialSlide||0)===(u||0)&&n&&o.emit("beforeSlideChangeStart");var p=-s[f],h;
// Update progress
// Normalize slideIndex
if(o.updateProgress(p),a.normalizeSlideIndex)for(var m=0;m<l.length;m+=1)-Math.floor(100*p)>=Math.floor(100*l[m])&&(r=m);
// Directions locks
if(o.initialized&&r!==c){if(!o.allowSlideNext&&p<o.translate&&p<o.minTranslate())return!1;if(!o.allowSlidePrev&&p>o.translate&&p>o.maxTranslate()&&(c||0)!==r)return!1}
// Update Index
return h=c<r?"next":r<c?"prev":"reset",d&&-p===o.translate||!d&&p===o.translate?(o.updateActiveIndex(r),
// Update Height
a.autoHeight&&o.updateAutoHeight(),o.updateSlidesClasses(),"slide"!==a.effect&&o.setTranslate(p),"reset"!==h&&(o.transitionStart(n,h),o.transitionEnd(n,h)),!1):(0!==t&&He.transition?(o.setTransition(t),o.setTranslate(p),o.updateActiveIndex(r),o.updateSlidesClasses(),o.emit("beforeTransitionStart",t,i),o.transitionStart(n,h),o.animating||(o.animating=!0,o.onSlideToWrapperTransitionEnd||(o.onSlideToWrapperTransitionEnd=function e(t){o&&!o.destroyed&&t.target===this&&(o.$wrapperEl[0].removeEventListener("transitionend",o.onSlideToWrapperTransitionEnd),o.$wrapperEl[0].removeEventListener("webkitTransitionEnd",o.onSlideToWrapperTransitionEnd),o.onSlideToWrapperTransitionEnd=null,delete o.onSlideToWrapperTransitionEnd,o.transitionEnd(n,h))}),o.$wrapperEl[0].addEventListener("transitionend",o.onSlideToWrapperTransitionEnd),o.$wrapperEl[0].addEventListener("webkitTransitionEnd",o.onSlideToWrapperTransitionEnd))):(o.setTransition(0),o.setTranslate(p),o.updateActiveIndex(r),o.updateSlidesClasses(),o.emit("beforeTransitionStart",t,i),o.transitionStart(n,h),o.transitionEnd(n,h)),!0)}function ne(e,t,n,i){void 0===e&&(e=0),void 0===t&&(t=this.params.speed),void 0===n&&(n=!0);var o=this,r=e;return o.params.loop&&(r+=o.loopedSlides),o.slideTo(r,t,n,i)}
/* eslint no-unused-vars: "off" */function ie(e,t,n){void 0===e&&(e=this.params.speed),void 0===t&&(t=!0);var i=this,o=i.params,r=i.animating;return o.loop?!r&&(i.loopFix(),
// eslint-disable-next-line
...
/* eslint no-unused-vars: "off" */function oe(e,t,n){function i(e){return e<0?-Math.floor(Math.abs(e)):Math.floor(e)}void 0===e&&(e=this.params.speed),void 0===t&&(t=!0);var o=this,r=o.params,a=o.animating,s=o.snapGrid,l=o.slidesGrid,u=o.rtlTranslate;if(r.loop){if(a)return!1;o.loopFix(),
// eslint-disable-next-line
...
/* eslint no-unused-vars: "off" */function re(e,t,n){void 0===e&&(e=this.params.speed),void 0===t&&(t=!0);var i=this;return i.slideTo(i.activeIndex,e,t,n)}
/* eslint no-unused-vars: "off" */function ae(e,t,n){void 0===e&&(e=this.params.speed),void 0===t&&(t=!0);var i=this,o=i.activeIndex,r=Math.floor(o/i.params.slidesPerGroup);if(r<i.snapGrid.length-1){var a=i.rtlTranslate?i.translate:-i.translate,s=i.snapGrid[r],l;(i.snapGrid[r+1]-s)/2<a-s&&(o=i.params.slidesPerGroup)}return i.slideTo(o,e,t,n)}function se(){var e=this,t=e.params,n=e.$wrapperEl,i="auto"===t.slidesPerView?e.slidesPerViewDynamic():t.slidesPerView,o=e.clickedIndex,r;if(t.loop){if(e.animating)return;r=parseInt(P(e.clickedSlide).attr("data-swiper-slide-index"),10),t.centeredSlides?o<e.loopedSlides-i/2||o>e.slides.length-e.loopedSlides+i/2?(e.loopFix(),o=n.children("."+t.slideClass+'[data-swiper-slide-index="'+r+'"]:not(.'+t.slideDuplicateClass+")").eq(0).index(),Ie.nextTick(function(){e.slideTo(o)})):e.slideTo(o):o>e.slides.length-i?(e.loopFix(),o=n.children("."+t.slideClass+'[data-swiper-slide-index="'+r+'"]:not(.'+t.slideDuplicateClass+")").eq(0).index(),Ie.nextTick(function(){e.slideTo(o)})):e.slideTo(o)}else e.slideTo(o)}function le(){var i=this,e=i.params,t=i.$wrapperEl;
// Remove duplicated slides
t.children("."+e.slideClass+"."+e.slideDuplicateClass).remove();var o=t.children("."+e.slideClass);if(e.loopFillGroupWithBlank){var n=e.slidesPerGroup-o.length%e.slidesPerGroup;if(n!==e.slidesPerGroup){for(var r=0;r<n;r+=1){var a=P(Me.createElement("div")).addClass(e.slideClass+" "+e.slideBlankClass);t.append(a)}o=t.children("."+e.slideClass)}}"auto"!==e.slidesPerView||e.loopedSlides||(e.loopedSlides=o.length),i.loopedSlides=parseInt(e.loopedSlides||e.slidesPerView,10),i.loopedSlides+=e.loopAdditionalSlides,i.loopedSlides>o.length&&(i.loopedSlides=o.length);var s=[],l=[];o.each(function(e,t){var n=P(t);e<i.loopedSlides&&l.push(t),e<o.length&&e>=o.length-i.loopedSlides&&s.push(t),n.attr("data-swiper-slide-index",e)});for(var u=0;u<l.length;u+=1)t.append(P(l[u].cloneNode(!0)).addClass(e.slideDuplicateClass));for(var c=s.length-1;0<=c;c-=1)t.prepend(P(s[c].cloneNode(!0)).addClass(e.slideDuplicateClass))}function ue(){var e=this,t=e.params,n=e.activeIndex,i=e.slides,o=e.loopedSlides,r=e.allowSlidePrev,a=e.allowSlideNext,s=e.snapGrid,l=e.rtlTranslate,u;e.allowSlidePrev=!0,e.allowSlideNext=!0;var c,d=-s[n]-e.getTranslate(),f;
...
u=-i.length+n+o,u+=o,e.slideTo(u,0,!1,!0)&&0!==d&&e.setTranslate((l?-e.translate:e.translate)-d)}e.allowSlidePrev=r,e.allowSlideNext=a}function ce(){var e=this,t=e.$wrapperEl,n=e.params,i=e.slides;t.children("."+n.slideClass+"."+n.slideDuplicateClass+",."+n.slideClass+"."+n.slideBlankClass).remove(),i.removeAttr("data-swiper-slide-index")}function de(e){var t=this;if(!(He.touch||!t.params.simulateTouch||t.params.watchOverflow&&t.isLocked)){var n=t.el;n.style.cursor="move",n.style.cursor=e?"-webkit-grabbing":"-webkit-grab",n.style.cursor=e?"-moz-grabbin":"-moz-grab",n.style.cursor=e?"grabbing":"grab"}}function fe(){var e=this;He.touch||e.params.watchOverflow&&e.isLocked||(e.el.style.cursor="")}function pe(e){var t=this,n=t.$wrapperEl,i=t.params;if(i.loop&&t.loopDestroy(),"object"==typeof e&&"length"in e)for(var o=0;o<e.length;o+=1)e[o]&&n.append(e[o]);else n.append(e);i.loop&&t.loopCreate(),i.observer&&He.observer||t.update()}function he(e){var t=this,n=t.params,i=t.$wrapperEl,o=t.activeIndex;n.loop&&t.loopDestroy();var r=o+1;if("object"==typeof e&&"length"in e){for(var a=0;a<e.length;a+=1)e[a]&&i.prepend(e[a]);r=o+e.length}else i.prepend(e);n.loop&&t.loopCreate(),n.observer&&He.observer||t.update(),t.slideTo(r,0,!1)}function me(e,t){var n=this,i=n.$wrapperEl,o=n.params,r,a=n.activeIndex;o.loop&&(a-=n.loopedSlides,n.loopDestroy(),n.slides=i.children("."+o.slideClass));var s=n.slides.length;if(e<=0)n.prependSlide(t);else if(s<=e)n.appendSlide(t);else{for(var l=e<a?a+1:a,u=[],c=s-1;e<=c;c-=1){var d=n.slides.eq(c);d.remove(),u.unshift(d)}if("object"==typeof t&&"length"in t){for(var f=0;f<t.length;f+=1)t[f]&&i.append(t[f]);l=e<a?a+t.length:a}else i.append(t);for(var p=0;p<u.length;p+=1)i.append(u[p]);o.loop&&n.loopCreate(),o.observer&&He.observer||n.update(),o.loop?n.slideTo(l+n.loopedSlides,0,!1):n.slideTo(l,0,!1)}}function ve(e){var t=this,n=t.params,i=t.$wrapperEl,o,r=t.activeIndex;n.loop&&(r-=t.loopedSlides,t.loopDestroy(),t.slides=i.children("."+n.slideClass));var a=r,s;if("object"==typeof e&&"length"in e){for(var l=0;l<e.length;l+=1)s=e[l],t.slides[s]&&t.slides.eq(s).remove(),s<a&&(a-=1);a=Math.max(a,0)}else s=e,t.slides[s]&&t.slides.eq(s).remove(),s<a&&(a-=1),a=Math.max(a,0);n.loop&&t.loopCreate(),n.observer&&He.observer||t.update(),n.loop?t.slideTo(a+t.loopedSlides,0,!1):t.slideTo(a,0,!1)}function ge(){for(var e=this,t=[],n=0;n<e.slides.length;n+=1)t.push(n);e.removeSlide(t)}function ye(e){var t=this,n=t.touchEventsData,i=t.params,o=t.touches;if(!t.animating||!i.preventInteractionOnTransition){var r=e;if(r.originalEvent&&(r=r.originalEvent),n.isTouchEvent="touchstart"===r.type,(n.isTouchEvent||!("which"in r)||3!==r.which)&&!(!n.isTouchEvent&&"button"in r&&0<r.button||n.isTouched&&n.isMoved))if(i.noSwiping&&P(r.target).closest(i.noSwipingSelector?i.noSwipingSelector:"."+i.noSwipingClass)[0])t.allowClick=!0;else if(!i.swipeHandler||P(r).closest(i.swipeHandler)[0]){o.currentX="touchstart"===r.type?r.targetTouches[0].pageX:r.pageX,o.currentY="touchstart"===r.type?r.targetTouches[0].pageY:r.pageY;var a=o.currentX,s=o.currentY,l=i.edgeSwipeDetection||i.iOSEdgeSwipeDetection,u=i.edgeSwipeThreshold||i.iOSEdgeSwipeThreshold;if(!l||!(a<=u||a>=Le.screen.width-u)){if(Ie.extend(n,{isTouched:!0,isMoved:!1,allowTouchCallbacks:!0,isScrolling:void 0,startMoving:void 0}),o.startX=a,o.startY=s,n.touchStartTime=Ie.now(),t.allowClick=!0,t.updateSize(),t.swipeDirection=void 0,0<i.threshold&&(n.allowThresholdMove=!1),"touchstart"!==r.type){var c=!0;P(r.target).is(n.formElements)&&(c=!1),Me.activeElement&&P(Me.activeElement).is(n.formElements)&&Me.activeElement!==r.target&&Me.activeElement.blur();var d=c&&t.allowTouchMove&&i.touchStartPreventDefault;(i.touchStartForcePreventDefault||d)&&r.preventDefault()}t.emit("touchStart",r)}}}}function be(e){var t=this,n=t.touchEventsData,i=t.params,o=t.touches,r=t.rtlTranslate,a=e;if(a.originalEvent&&(a=a.originalEvent),n.isTouched){if(!n.isTouchEvent||"mousemove"!==a.type){var s="touchmove"===a.type?a.targetTouches[0].pageX:a.pageX,l="touchmove"===a.type?a.targetTouches[0].pageY:a.pageY;if(a.preventedByNestedSwiper)return o.startX=s,void(o.startY=l);if(!t.allowTouchMove)
// isMoved = true;
...
(150<v||300<Ie.now()-p.time)&&(t.velocity=0)}else t.velocity=0;t.velocity*=i.freeModeMomentumVelocityRatio,n.velocities.length=0;var g=1e3*i.freeModeMomentumRatio,y=t.velocity*g,b=t.translate+y;r&&(b=-b);var w=!1,x,T=20*Math.abs(t.velocity)*i.freeModeMomentumBounceRatio,C;if(b<t.maxTranslate())i.freeModeMomentumBounce?(b+t.maxTranslate()<-T&&(b=t.maxTranslate()-T),x=t.maxTranslate(),w=!0,n.allowMomentumBounce=!0):b=t.maxTranslate(),i.loop&&i.centeredSlides&&(C=!0);else if(b>t.minTranslate())i.freeModeMomentumBounce?(b-t.minTranslate()>T&&(b=t.minTranslate()+T),x=t.minTranslate(),w=!0,n.allowMomentumBounce=!0):b=t.minTranslate(),i.loop&&i.centeredSlides&&(C=!0);else if(i.freeModeSticky){for(var k,E=0;E<l.length;E+=1)if(l[E]>-b){k=E;break}b=-(b=Math.abs(l[k]-b)<Math.abs(l[k-1]-b)||"next"===t.swipeDirection?l[k]:l[k-1])}
// Fix duration
if(C&&t.once("transitionEnd",function(){t.loopFix()}),0!==t.velocity)g=r?Math.abs((-b-t.translate)/t.velocity):Math.abs((b-t.translate)/t.velocity);else if(i.freeModeSticky)return void t.slideToClosest();i.freeModeMomentumBounce&&w?(t.updateProgress(x),t.setTransition(g),t.setTranslate(b),t.transitionStart(!0,t.swipeDirection),t.animating=!0,a.transitionEnd(function(){t&&!t.destroyed&&n.allowMomentumBounce&&(t.emit("momentumBounce"),t.setTransition(i.speed),t.setTranslate(x),a.transitionEnd(function(){t&&!t.destroyed&&t.transitionEnd()}))})):t.velocity?(t.updateProgress(b),t.setTransition(g),t.setTranslate(b),t.transitionStart(!0,t.swipeDirection),t.animating||(t.animating=!0,a.transitionEnd(function(){t&&!t.destroyed&&t.transitionEnd()}))):t.updateProgress(b),t.updateActiveIndex(),t.updateSlidesClasses()}else if(i.freeModeSticky)return void t.slideToClosest();(!i.freeModeMomentum||d>=i.longSwipesMs)&&(t.updateProgress(),t.updateActiveIndex(),t.updateSlidesClasses())}
// Find current slide
else{for(var S=0,$=t.slidesSizesGrid[0],j=0;j<s.length;j+=i.slidesPerGroup)void 0!==s[j+i.slidesPerGroup]?f>=s[j]&&f<s[j+i.slidesPerGroup]&&($=s[(S=j)+i.slidesPerGroup]-s[j]):f>=s[j]&&(S=j,$=s[s.length-1]-s[s.length-2]);
// Find current slide size
var O=(f-s[S])/$;if(d>i.longSwipesMs){
// Long touches
if(!i.longSwipes)return void t.slideTo(t.activeIndex);"next"===t.swipeDirection&&(O>=i.longSwipesRatio?t.slideTo(S+i.slidesPerGroup):t.slideTo(S)),"prev"===t.swipeDirection&&(O>1-i.longSwipesRatio?t.slideTo(S+i.slidesPerGroup):t.slideTo(S))}else{
// Short swipes
if(!i.shortSwipes)return void t.slideTo(t.activeIndex);"next"===t.swipeDirection&&t.slideTo(S+i.slidesPerGroup),"prev"===t.swipeDirection&&t.slideTo(S)}}}function xe(){var e=this,t=e.params,n=e.el;if(!n||0!==n.offsetWidth){
// Breakpoints
t.breakpoints&&e.setBreakpoint();
// Save locks
var i=e.allowSlideNext,o=e.allowSlidePrev,r=e.snapGrid;if(
...
e.allowSlidePrev=o,e.allowSlideNext=i,e.params.watchOverflow&&r!==e.snapGrid&&e.checkOverflow()}}function Te(e){var t=this;t.allowClick||(t.params.preventClicks&&e.preventDefault(),t.params.preventClicksPropagation&&t.animating&&(e.stopPropagation(),e.stopImmediatePropagation()))}function Ce(){var e=this,t=e.params,n=e.touchEvents,i=e.el,o=e.wrapperEl;e.onTouchStart=ye.bind(e),e.onTouchMove=be.bind(e),e.onTouchEnd=we.bind(e),e.onClick=Te.bind(e);var r="container"===t.touchEventsTarget?i:o,a=!!t.nested;if(He.touch||!He.pointerEvents&&!He.prefixedPointerEvents){if(He.touch){var s=!("touchstart"!==n.start||!He.passiveListener||!t.passiveListeners)&&{passive:!0,capture:!1};r.addEventListener(n.start,e.onTouchStart,s),r.addEventListener(n.move,e.onTouchMove,He.passiveListener?{passive:!1,capture:a}:a),r.addEventListener(n.end,e.onTouchEnd,s)}(t.simulateTouch&&!Xe.ios&&!Xe.android||t.simulateTouch&&!He.touch&&Xe.ios)&&(r.addEventListener("mousedown",e.onTouchStart,!1),Me.addEventListener("mousemove",e.onTouchMove,a),Me.addEventListener("mouseup",e.onTouchEnd,!1))}
// Prevent Links Clicks
else r.addEventListener(n.start,e.onTouchStart,!1),Me.addEventListener(n.move,e.onTouchMove,a),Me.addEventListener(n.end,e.onTouchEnd,!1);(t.preventClicks||t.preventClicksPropagation)&&r.addEventListener("click",e.onClick,!0),
// Resize handler
e.on(Xe.ios||Xe.android?"resize orientationchange observerUpdate":"resize observerUpdate",xe,!0)}function ke(){var e=this,t=e.params,n=e.touchEvents,i=e.el,o=e.wrapperEl,r="container"===t.touchEventsTarget?i:o,a=!!t.nested;if(He.touch||!He.pointerEvents&&!He.prefixedPointerEvents){if(He.touch){var s=!("onTouchStart"!==n.start||!He.passiveListener||!t.passiveListeners)&&{passive:!0,capture:!1};r.removeEventListener(n.start,e.onTouchStart,s),r.removeEventListener(n.move,e.onTouchMove,a),r.removeEventListener(n.end,e.onTouchEnd,s)}(t.simulateTouch&&!Xe.ios&&!Xe.android||t.simulateTouch&&!He.touch&&Xe.ios)&&(r.removeEventListener("mousedown",e.onTouchStart,!1),Me.removeEventListener("mousemove",e.onTouchMove,a),Me.removeEventListener("mouseup",e.onTouchEnd,!1))}
// Prevent Links Clicks
else r.removeEventListener(n.start,e.onTouchStart,!1),Me.removeEventListener(n.move,e.onTouchMove,a),Me.removeEventListener(n.end,e.onTouchEnd,!1);(t.preventClicks||t.preventClicksPropagation)&&r.removeEventListener("click",e.onClick,!0),
// Resize handler
e.off(Xe.ios||Xe.android?"resize orientationchange observerUpdate":"resize observerUpdate",xe)}function Ee(){var e=this,t=e.activeIndex,n=e.initialized,i=e.loopedSlides;void 0===i&&(i=0);var o=e.params,r=o.breakpoints;if(r&&(!r||0!==Object.keys(r).length)){
// Set breakpoint for window width and update parameters
var a=e.getBreakpoint(r);if(a&&e.currentBreakpoint!==a){var s=a in r?r[a]:void 0;s&&["slidesPerView","spaceBetween","slidesPerGroup"].forEach(function(e){var t=s[e];void 0!==t&&(s[e]="slidesPerView"!==e||"AUTO"!==t&&"auto"!==t?"slidesPerView"===e?parseFloat(t):parseInt(t,10):"auto")});var l=s||e.originalParams,u=o.loop&&l.slidesPerView!==o.slidesPerView;Ie.extend(e.params,l),Ie.extend(e,{allowTouchMove:e.params.allowTouchMove,allowSlideNext:e.params.allowSlideNext,allowSlidePrev:e.params.allowSlidePrev}),e.currentBreakpoint=a,u&&n&&(e.loopDestroy(),e.loopCreate(),e.updateSlides(),e.slideTo(t-i+e.loopedSlides,0,!1)),e.emit("breakpoint",l)}}}function Se(e){var t=this;
// Get breakpoint for window width
if(e){var n=!1,i=[];Object.keys(e).forEach(function(e){i.push(e)}),i.sort(function(e,t){return parseInt(e,10)-parseInt(t,10)});for(var o=0;o<i.length;o+=1){var r=i[o];t.params.breakpointsInverse?r<=Le.innerWidth&&(n=r):r>=Le.innerWidth&&!n&&(n=r)}return n||"max"}}function $e(){var e=this,t=e.classNames,n=e.params,i=e.rtl,o=e.$el,r=[];r.push(n.direction),n.freeMode&&r.push("free-mode"),He.flexbox||r.push("no-flexbox"),n.autoHeight&&r.push("autoheight"),i&&r.push("rtl"),1<n.slidesPerColumn&&r.push("multirow"),Xe.android&&r.push("android"),Xe.ios&&r.push("ios"),
// WP8 Touch Events Fix
(Qe.isIE||Qe.isEdge)&&(He.pointerEvents||He.prefixedPointerEvents)&&r.push("wp8-"+n.direction),r.forEach(function(e){t.push(n.containerModifierClass+e)}),o.addClass(t.join(" "))}function je(){var e=this,t=e.$el,n=e.classNames;t.removeClass(n.join(" "))}function Oe(e,t,n,i,o,r){function a(){r&&r()}var s;e.complete&&o?
// image already loaded...
a():t?((s=new Le.Image).onload=a,s.onerror=a,i&&(s.sizes=i),n&&(s.srcset=n),t&&(s.src=t)):a()}function _e(){function e(){null!=t&&t&&!t.destroyed&&(void 0!==t.imagesLoaded&&(t.imagesLoaded+=1),t.imagesLoaded===t.imagesToLoad.length&&(t.params.updateOnImagesReady&&t.update(),t.emit("imagesReady")))}var t=this;t.imagesToLoad=t.$el.find("img");for(var n=0;n<t.imagesToLoad.length;n+=1){var i=t.imagesToLoad[n];t.loadImage(i,i.currentSrc||i.getAttribute("src"),i.srcset||i.getAttribute("srcset"),i.sizes||i.getAttribute("sizes"),!0,e)}}function ze(){var e=this,t=e.isLocked;e.isLocked=1===e.snapGrid.length,e.allowSlideNext=!e.isLocked,e.allowSlidePrev=!e.isLocked,
// events
...
P.fn=Ae.prototype,P.Class=Ae,P.Dom7=Ae;var De={addClass:e,removeClass:t,hasClass:n,toggleClass:i,attr:o,removeAttr:a,data:s,transform:l,transition:u,on:c,off:d,trigger:f,transitionEnd:p,outerWidth:h,outerHeight:m,offset:v,css:y,each:b,html:w,text:x,is:T,index:C,eq:k,append:E,prepend:S,next:$,nextAll:j,prev:O,prevAll:_,parent:z,parents:M,closest:L,find:A,children:D,remove:I,add:H,styles:g};Object.keys(De).forEach(function(e){P.fn[e]=De[e]});var Ie={deleteProps:function e(t){var n=t;Object.keys(n).forEach(function(e){try{n[e]=null}catch(e){
// no getter for object
}try{delete n[e]}catch(e){
// something got wrong
}})},nextTick:function e(t,n){return void 0===n&&(n=0),setTimeout(t,n)},now:function e(){return Date.now()},getTranslate:function e(t,n){var i,o,r;void 0===n&&(n="x");var a=Le.getComputedStyle(t,null);return Le.WebKitCSSMatrix?(6<(o=a.transform||a.webkitTransform).split(",").length&&(o=o.split(", ").map(function(e){return e.replace(",",".")}).join(", ")),
// Some old versions of Webkit choke when 'none' is passed; pass
// empty string instead in this case
r=new Le.WebKitCSSMatrix("none"===o?"":o)):i=(r=a.MozTransform||a.OTransform||a.MsTransform||a.msTransform||a.transform||a.getPropertyValue("transform").replace("translate(","matrix(1, 0, 0, 1,")).toString().split(","),"x"===n&&(
// Latest Chrome and webkits Fix
o=Le.WebKitCSSMatrix?r.m41:16===i.length?parseFloat(i[12]):parseFloat(i[4])),"y"===n&&(
// Latest Chrome and webkits Fix
o=Le.WebKitCSSMatrix?r.m42:16===i.length?parseFloat(i[13]):parseFloat(i[5])),o||0},parseUrlQuery:function e(t){var n={},i=t||Le.location.href,o,r,a,s;if("string"==typeof i&&i.length)for(s=(r=(i=-1<i.indexOf("?")?i.replace(/\S*\?/,""):"").split("&").filter(function(e){return""!==e})).length,o=0;o<s;o+=1)a=r[o].replace(/#\S+/g,"").split("="),n[decodeURIComponent(a[0])]=void 0===a[1]?void 0:decodeURIComponent(a[1])||"";return n},isObject:function e(t){return"object"==typeof t&&null!==t&&t.constructor&&t.constructor===Object},extend:function e(){for(var t=[],n=arguments.length;n--;)t[n]=arguments[n];for(var i=Object(t[0]),o=1;o<t.length;o+=1){var r=t[o];if(null!=r)for(var a=Object.keys(Object(r)),s=0,l=a.length;s<l;s+=1){var u=a[s],c=Object.getOwnPropertyDescriptor(r,u);void 0!==c&&c.enumerable&&(Ie.isObject(i[u])&&Ie.isObject(r[u])?Ie.extend(i[u],r[u]):!Ie.isObject(i[u])&&Ie.isObject(r[u])?(i[u]={},Ie.extend(i[u],r[u])):i[u]=r[u])}}return i}},He=function e(){var o=Me.createElement("div");return{touch:Le.Modernizr&&!0===Le.Modernizr.touch||function e(){return!!(0<Le.navigator.maxTouchPoints||"ontouchstart"in Le||Le.DocumentTouch&&Me instanceof Le.DocumentTouch)}(),pointerEvents:!!(Le.navigator.pointerEnabled||Le.PointerEvent||"maxTouchPoints"in Le.navigator),prefixedPointerEvents:!!Le.navigator.msPointerEnabled,transition:function e(){var t=o.style;return"transition"in t||"webkitTransition"in t||"MozTransition"in t}(),transforms3d:Le.Modernizr&&!0===Le.Modernizr.csstransforms3d||function e(){var t=o.style;return"webkitPerspective"in t||"MozPerspective"in t||"OPerspective"in t||"MsPerspective"in t||"perspective"in t}(),flexbox:function e(){for(var t=o.style,n="alignItems webkitAlignItems webkitBoxAlign msFlexAlign mozBoxAlign webkitFlexDirection msFlexDirection mozBoxDirection mozBoxOrient webkitBoxDirection webkitBoxOrient".split(" "),i=0;i<n.length;i+=1)if(n[i]in t)return!0;return!1}(),observer:function e(){return"MutationObserver"in Le||"WebkitMutationObserver"in Le}(),passiveListener:function e(){var t=!1;try{var n=Object.defineProperty({},"passive",{
// eslint-disable-next-line
...
// Events
n.eventsListeners={},n.params&&n.params.on&&Object.keys(n.params.on).forEach(function(e){n.on(e,n.params.on[e])})},Re={components:{configurable:!0}};qe.prototype.on=function e(t,n,i){var o=this;if("function"!=typeof n)return o;var r=i?"unshift":"push";return t.split(" ").forEach(function(e){o.eventsListeners[e]||(o.eventsListeners[e]=[]),o.eventsListeners[e][r](n)}),o},qe.prototype.once=function e(n,i,t){function o(){for(var e=[],t=arguments.length;t--;)e[t]=arguments[t];i.apply(r,e),r.off(n,o)}var r=this;return"function"!=typeof i?r:r.on(n,o,t)},qe.prototype.off=function e(t,i){var o=this;return o.eventsListeners&&t.split(" ").forEach(function(n){void 0===i?o.eventsListeners[n]=[]:o.eventsListeners[n]&&o.eventsListeners[n].length&&o.eventsListeners[n].forEach(function(e,t){e===i&&o.eventsListeners[n].splice(t,1)})}),o},qe.prototype.emit=function e(){for(var t=[],n=arguments.length;n--;)t[n]=arguments[n];var i=this,o,r,a,s;return i.eventsListeners&&(a="string"==typeof t[0]||Array.isArray(t[0])?(o=t[0],r=t.slice(1,t.length),i):(o=t[0].events,r=t[0].data,t[0].context||i),(Array.isArray(o)?o:o.split(" ")).forEach(function(e){if(i.eventsListeners&&i.eventsListeners[e]){var t=[];i.eventsListeners[e].forEach(function(e){t.push(e)}),t.forEach(function(e){e.apply(a,r)})}})),i},qe.prototype.useModulesParams=function e(n){var i=this;i.modules&&Object.keys(i.modules).forEach(function(e){var t=i.modules[e];
// Extend params
...
n.create&&n.create.bind(o)(t)})},Re.components.set=function(e){var t=this;t.use&&t.use(e)},qe.installModule=function e(t){for(var n=[],i=arguments.length-1;0<i--;)n[i]=arguments[i+1];var o=this;o.prototype.modules||(o.prototype.modules={});var r=t.name||Object.keys(o.prototype.modules).length+"_"+Ie.now();
// Prototype
return(o.prototype.modules[r]=t).proto&&Object.keys(t.proto).forEach(function(e){o.prototype[e]=t.proto[e]}),
// Class
t.static&&Object.keys(t.static).forEach(function(e){o[e]=t.static[e]}),
// Callback
t.install&&t.install.apply(o,n),o},qe.use=function e(t){for(var n=[],i=arguments.length-1;0<i--;)n[i]=arguments[i+1];var o=this;return Array.isArray(t)?(t.forEach(function(e){return o.installModule(e)}),o):o.installModule.apply(o,[t].concat(n))},Object.defineProperties(qe,Re);var Ne={updateSize:q,updateSlides:R,updateAutoHeight:N,updateSlidesOffset:F,updateSlidesProgress:B,updateProgress:G,updateSlidesClasses:W,updateActiveIndex:Y,updateClickedSlide:V},Fe={getTranslate:X,setTranslate:U,minTranslate:K,maxTranslate:Q},Be={setTransition:Z,transitionStart:J,transitionEnd:ee},Ge={slideTo:te,slideToLoop:ne,slideNext:ie,slidePrev:oe,slideReset:re,slideToClosest:ae,slideToClickedSlide:se},We={loopCreate:le,loopFix:ue,loopDestroy:ce},Ye={setGrabCursor:de,unsetGrabCursor:fe},Ve={appendSlide:pe,prependSlide:he,addSlide:me,removeSlide:ve,removeAllSlides:ge},Xe=function e(){var t=Le.navigator.userAgent,n={ios:!1,android:!1,androidChrome:!1,desktop:!1,windows:!1,iphone:!1,ipod:!1,ipad:!1,cordova:Le.cordova||Le.phonegap,phonegap:Le.cordova||Le.phonegap},i=t.match(/(Windows Phone);?[\s\/]+([\d.]+)?/),o=t.match(/(Android);?[\s\/]+([\d.]+)?/),r=t.match(/(iPad).*OS\s([\d_]+)/),a=t.match(/(iPod)(.*OS\s([\d_]+))?/),s=!r&&t.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
// Minimal UI
if(
// Windows
i&&(n.os="windows",n.osVersion=i[2],n.windows=!0),
// Android
o&&!i&&(n.os="android",n.osVersion=o[2],n.android=!0,n.androidChrome=0<=t.toLowerCase().indexOf("chrome")),(r||s||a)&&(n.os="ios",n.ios=!0),
// iOS
s&&!a&&(n.osVersion=s[2].replace(/_/g,"."),n.iphone=!0),r&&(n.osVersion=r[2].replace(/_/g,"."),n.ipad=!0),a&&(n.osVersion=a[3]?a[3].replace(/_/g,"."):null,n.iphone=!0),
// iOS 8+ changed UA
...
// Callbacks
runCallbacksOnInit:!0},nt={update:Ne,translate:Fe,transition:Be,slide:Ge,loop:We,grabCursor:Ye,manipulation:Ve,events:Ue,breakpoints:Ke,checkOverflow:{checkOverflow:ze},classes:{addClasses:$e,removeClasses:je},images:{loadImage:Oe,preloadImages:_e}},it={},ot=/* */function(c){function d(){for(var e,t=[],n=arguments.length,i,o;n--;)t[n]=arguments[n];(o=1===t.length&&t[0].constructor&&t[0].constructor===Object?t[0]:(i=(e=t)[0],e[1]))||(o={}),o=Ie.extend({},o),i&&!o.el&&(o.el=i),c.call(this,o),Object.keys(nt).forEach(function(t){Object.keys(nt[t]).forEach(function(e){d.prototype[e]||(d.prototype[e]=nt[t][e])})});
// Swiper Instance
var r=this;void 0===r.modules&&(r.modules={}),Object.keys(r.modules).forEach(function(e){var t=r.modules[e];if(t.params){var n=Object.keys(t.params)[0],i=t.params[n];if("object"!=typeof i||null===i)return;if(!(n in o&&"enabled"in i))return;!0===o[n]&&(o[n]={enabled:!0}),"object"!=typeof o[n]||"enabled"in o[n]||(o[n].enabled=!0),o[n]||(o[n]={enabled:!1})}});
// Extend defaults with modules params
var a=Ie.extend({},tt);r.useModulesParams(a),
// Extend defaults with passed params
r.params=Ie.extend({},a,it,o),r.originalParams=Ie.extend({},r.params),r.passedParams=Ie.extend({},o);
// Find el
var s=(
// Save Dom lib
r.$=P)(r.params.el);if(i=s[0]){if(1<s.length){var l=[];return s.each(function(e,t){var n=Ie.extend({},o,{el:t});l.push(new d(n))}),l}i.swiper=r,s.data("swiper",r);
// Find Wrapper
var u=s.children("."+r.params.wrapperClass);
// Extend Swiper
// Return app instance
return Ie.extend(r,{$el:s,el:i,$wrapperEl:u,wrapperEl:u[0],
// Classes
classNames:[],
// Slides
slides:P(),slidesGrid:[],snapGrid:[],slidesSizesGrid:[],
// isDirection
isHorizontal:function e(){return"horizontal"===r.params.direction},isVertical:function e(){return"vertical"===r.params.direction},
// RTL
rtl:"rtl"===i.dir.toLowerCase()||"rtl"===s.css("direction"),rtlTranslate:"horizontal"===r.params.direction&&("rtl"===i.dir.toLowerCase()||"rtl"===s.css("direction")),wrongRTL:"-webkit-box"===u.css("display"),
// Indexes
...
// Locks
allowSlideNext:r.params.allowSlideNext,allowSlidePrev:r.params.allowSlidePrev,
// Touch Events
touchEvents:function e(){var t=["touchstart","touchmove","touchend"],n=["mousedown","mousemove","mouseup"];return He.pointerEvents?n=["pointerdown","pointermove","pointerup"]:He.prefixedPointerEvents&&(n=["MSPointerDown","MSPointerMove","MSPointerUp"]),r.touchEventsTouch={start:t[0],move:t[1],end:t[2]},r.touchEventsDesktop={start:n[0],move:n[1],end:n[2]},He.touch||!r.params.simulateTouch?r.touchEventsTouch:r.touchEventsDesktop}(),touchEventsData:{isTouched:void 0,isMoved:void 0,allowTouchCallbacks:void 0,touchStartTime:void 0,isScrolling:void 0,currentTranslate:void 0,startTranslate:void 0,allowThresholdMove:void 0,
...
allowClick:!0,
// Touches
allowTouchMove:r.params.allowTouchMove,touches:{startX:0,startY:0,currentX:0,currentY:0,diff:0},
// Images
imagesToLoad:[],imagesLoaded:0}),
// Install Modules
r.useModules(),
// Init
r.params.init&&r.init(),r}}c&&(d.__proto__=c),d.prototype=Object.create(c&&c.prototype);var e={extendedDefaults:{configurable:!0},defaults:{configurable:!0},Class:{configurable:!0},$:{configurable:!0}};return(d.prototype.constructor=d).prototype.slidesPerViewDynamic=function e(){var t=this,n=t.params,i=t.slides,o=t.slidesGrid,r=t.size,a=t.activeIndex,s=1;if(n.centeredSlides){for(var l=i[a].swiperSlideSize,u,c=a+1;c<i.length;c+=1)i[c]&&!u&&(s+=1,r<(l+=i[c].swiperSlideSize)&&(u=!0));for(var d=a-1;0<=d;d-=1)i[d]&&!u&&(s+=1,r<(l+=i[d].swiperSlideSize)&&(u=!0))}else for(var f=a+1;f<i.length;f+=1)o[f]-o[a]<r&&(s+=1);return s},d.prototype.update=function e(){function t(){var e=n.rtlTranslate?-1*n.translate:n.translate,t=Math.min(Math.max(e,n.maxTranslate()),n.minTranslate());n.setTranslate(t),n.updateActiveIndex(),n.updateSlidesClasses()}var n=this;if(n&&!n.destroyed){var i=n.snapGrid,o=n.params,r;
// Breakpoints
o.breakpoints&&n.setBreakpoint(),n.updateSize(),n.updateSlides(),n.updateProgress(),n.updateSlidesClasses(),n.params.freeMode?(t(),n.params.autoHeight&&n.updateAutoHeight()):(r=("auto"===n.params.slidesPerView||1<n.params.slidesPerView)&&n.isEnd&&!n.params.centeredSlides?n.slideTo(n.slides.length-1,0,!1,!0):n.slideTo(n.activeIndex,0,!1,!0))||t(),o.watchOverflow&&i!==n.snapGrid&&n.checkOverflow(),n.emit("update")}},d.prototype.init=function e(){var t=this;t.initialized||(t.emit("beforeInit"),
// Set breakpoint
...
t.initialized=!0,
// Emit
t.emit("init"))},d.prototype.destroy=function e(t,n){void 0===t&&(t=!0),void 0===n&&(n=!0);var i=this,o=i.params,r=i.$el,a=i.$wrapperEl,s=i.slides;return void 0===i.params||i.destroyed||(i.emit("beforeDestroy"),
// Init Flag
i.initialized=!1,
// Detach events
i.detachEvents(),
...
// Cleanup styles
n&&(i.removeClasses(),r.removeAttr("style"),a.removeAttr("style"),s&&s.length&&s.removeClass([o.slideVisibleClass,o.slideActiveClass,o.slideNextClass,o.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index").removeAttr("data-swiper-column").removeAttr("data-swiper-row")),i.emit("destroy"),
// Detach emitter events
Object.keys(i.eventsListeners).forEach(function(e){i.off(e)}),!1!==t&&(i.$el[0].swiper=null,i.$el.data("swiper",null),Ie.deleteProps(i)),i.destroyed=!0),null},d.extendDefaults=function e(t){Ie.extend(it,t)},e.extendedDefaults.get=function(){return it},e.defaults.get=function(){return tt},e.Class.get=function(){return c},e.$.get=function(){return P},Object.defineProperties(d,e),d}(qe),rt={name:"device",proto:{device:Xe},static:{device:Xe}},at={name:"support",proto:{support:He},static:{support:He}},st={name:"browser",proto:{browser:Qe},static:{browser:Qe}},lt={name:"resize",create:function e(){var t=this;Ie.extend(t,{resize:{resizeHandler:function e(){t&&!t.destroyed&&t.initialized&&(t.emit("beforeResize"),t.emit("resize"))},orientationChangeHandler:function e(){t&&!t.destroyed&&t.initialized&&t.emit("orientationchange")}}})},on:{init:function e(){var t=this;
// Emit resize
Le.addEventListener("resize",t.resize.resizeHandler),
// Emit orientationchange
Le.addEventListener("orientationchange",t.resize.orientationChangeHandler)},destroy:function e(){var t=this;Le.removeEventListener("resize",t.resize.resizeHandler),Le.removeEventListener("orientationchange",t.resize.orientationChangeHandler)}}},ut={func:Le.MutationObserver||Le.WebkitMutationObserver,attach:function e(t,n){void 0===n&&(n={});var i=this,o,r=new ut.func(function(t){
// The observerUpdate event should only be triggered
// once despite the number of mutations.  Additional
// triggers are redundant and are very costly
if(1!==t.length){var e=function e(){i.emit("observerUpdate",t[0])};Le.requestAnimationFrame?Le.requestAnimationFrame(e):Le.setTimeout(e,0)}else i.emit("observerUpdate",t[0])});r.observe(t,{attributes:void 0===n.attributes||n.attributes,childList:void 0===n.childList||n.childList,characterData:void 0===n.characterData||n.characterData}),i.observer.observers.push(r)},init:function e(){var t=this;if(He.observer&&t.params.observer){if(t.params.observeParents)for(var n=t.$el.parents(),i=0;i<n.length;i+=1)t.observer.attach(n[i]);
// Observe container
t.observer.attach(t.$el[0],{childList:t.params.observeSlideChildren}),
// Observe wrapper
t.observer.attach(t.$wrapperEl[0],{attributes:!1})}},destroy:function e(){var t=this;t.observer.observers.forEach(function(e){e.disconnect()}),t.observer.observers=[]}},ct={name:"observer",params:{observer:!1,observeParents:!1,observeSlideChildren:!1},create:function e(){var t=this;Ie.extend(t,{observer:{init:ut.init.bind(t),attach:ut.attach.bind(t),destroy:ut.destroy.bind(t),observers:[]}})},on:{init:function e(){var t;this.observer.init()},destroy:function e(){var t;this.observer.destroy()}}},dt={update:function e(t){function n(){i.updateSlides(),i.updateProgress(),i.updateSlidesClasses(),i.lazy&&i.params.lazy.enabled&&i.lazy.load()}var i=this,o=i.params,r=o.slidesPerView,a=o.slidesPerGroup,s=o.centeredSlides,l=i.params.virtual,u=l.addSlidesBefore,c=l.addSlidesAfter,d=i.virtual,f=d.from,p=d.to,h=d.slides,m=d.slidesGrid,v=d.renderSlide,g=d.offset;i.updateActiveIndex();var y=i.activeIndex||0,b,w,x;b=i.rtlTranslate?"right":i.isHorizontal()?"left":"top",x=s?(w=Math.floor(r/2)+a+u,Math.floor(r/2)+a+c):(w=r+(a-1)+u,a+c);var T=Math.max((y||0)-x,0),C=Math.min((y||0)+w,h.length-1),k=(i.slidesGrid[T]||0)-(i.slidesGrid[0]||0);if(Ie.extend(i.virtual,{from:T,to:C,offset:k,slidesGrid:i.slidesGrid}),f===T&&p===C&&!t)return i.slidesGrid!==m&&k!==g&&i.slides.css(b,k+"px"),void i.updateProgress();if(i.params.virtual.renderExternal)return i.params.virtual.renderExternal.call(i,{offset:k,from:T,to:C,slides:function e(){for(var t=[],n=T;n<=C;n+=1)t.push(h[n]);return t}()}),void n();var E=[],S=[];if(t)i.$wrapperEl.find("."+i.params.slideClass).remove();else for(var $=f;$<=p;$+=1)($<T||C<$)&&i.$wrapperEl.find("."+i.params.slideClass+'[data-swiper-slide-index="'+$+'"]').remove();for(var j=0;j<h.length;j+=1)T<=j&&j<=C&&(void 0===p||t?S.push(j):(p<j&&S.push(j),j<f&&E.push(j)));S.forEach(function(e){i.$wrapperEl.append(v(h[e],e))}),E.sort(function(e,t){return t-e}).forEach(function(e){i.$wrapperEl.prepend(v(h[e],e))}),i.$wrapperEl.children(".swiper-slide").css(b,k+"px"),n()},renderSlide:function e(t,n){var i=this,o=i.params.virtual;if(o.cache&&i.virtual.cache[n])return i.virtual.cache[n];var r=o.renderSlide?P(o.renderSlide.call(i,t,n)):P('<div class="'+i.params.slideClass+'" data-swiper-slide-index="'+n+'">'+t+"</div>");return r.attr("data-swiper-slide-index")||r.attr("data-swiper-slide-index",n),o.cache&&(i.virtual.cache[n]=r),r},appendSlide:function e(t){var n=this;n.virtual.slides.push(t),n.virtual.update(!0)},prependSlide:function e(t){var n=this;if(n.virtual.slides.unshift(t),n.params.virtual.cache){var i=n.virtual.cache,o={};Object.keys(i).forEach(function(e){o[e+1]=i[e]}),n.virtual.cache=o}n.virtual.update(!0),n.slideNext(0)}},ft={name:"virtual",params:{virtual:{enabled:!1,slides:[],cache:!0,renderSlide:null,renderExternal:null,addSlidesBefore:0,addSlidesAfter:0}},create:function e(){var t=this;Ie.extend(t,{virtual:{update:dt.update.bind(t),appendSlide:dt.appendSlide.bind(t),prependSlide:dt.prependSlide.bind(t),renderSlide:dt.renderSlide.bind(t),slides:t.params.virtual.slides,cache:{}}})},on:{beforeInit:function e(){var t=this;if(t.params.virtual.enabled){t.classNames.push(t.params.containerModifierClass+"virtual");var n={watchSlidesProgress:!0};Ie.extend(t.params,n),Ie.extend(t.originalParams,n),t.params.initialSlide||t.virtual.update()}},setTranslate:function e(){var t=this;t.params.virtual.enabled&&t.virtual.update()}}},pt={handle:function e(t){var n=this,i=n.rtlTranslate,o=t;o.originalEvent&&(o=o.originalEvent);// jquery fix
var r=o.keyCode||o.charCode;
// Directions locks
if(!n.allowSlideNext&&(n.isHorizontal()&&39===r||n.isVertical()&&40===r))return!1;if(!n.allowSlidePrev&&(n.isHorizontal()&&37===r||n.isVertical()&&38===r))return!1;if(!(o.shiftKey||o.altKey||o.ctrlKey||o.metaKey||Me.activeElement&&Me.activeElement.nodeName&&("input"===Me.activeElement.nodeName.toLowerCase()||"textarea"===Me.activeElement.nodeName.toLowerCase()))){if(n.params.keyboard.onlyInViewport&&(37===r||39===r||38===r||40===r)){var a=!1;
// Check that swiper should be inside of visible area of window
if(0<n.$el.parents("."+n.params.slideClass).length&&0===n.$el.parents("."+n.params.slideActiveClass).length)return;var s=Le.innerWidth,l=Le.innerHeight,u=n.$el.offset();i&&(u.left-=n.$el[0].scrollLeft);for(var c=[[u.left,u.top],[u.left+n.width,u.top],[u.left,u.top+n.height],[u.left+n.width,u.top+n.height]],d=0;d<c.length;d+=1){var f=c[d];0<=f[0]&&f[0]<=s&&0<=f[1]&&f[1]<=l&&(a=!0)}if(!a)return}n.isHorizontal()?(37!==r&&39!==r||(o.preventDefault?o.preventDefault():o.returnValue=!1),(39===r&&!i||37===r&&i)&&n.slideNext(),(37===r&&!i||39===r&&i)&&n.slidePrev()):(38!==r&&40!==r||(o.preventDefault?o.preventDefault():o.returnValue=!1),40===r&&n.slideNext(),38===r&&n.slidePrev()),n.emit("keyPress",r)}},enable:function e(){var t=this;t.keyboard.enabled||(P(Me).on("keydown",t.keyboard.handle),t.keyboard.enabled=!0)},disable:function e(){var t=this;t.keyboard.enabled&&(P(Me).off("keydown",t.keyboard.handle),t.keyboard.enabled=!1)}},ht={name:"keyboard",params:{keyboard:{enabled:!1,onlyInViewport:!0}},create:function e(){var t=this;Ie.extend(t,{keyboard:{enabled:!1,enable:pt.enable.bind(t),disable:pt.disable.bind(t),handle:pt.handle.bind(t)}})},on:{init:function e(){var t=this;t.params.keyboard.enabled&&t.keyboard.enable()},destroy:function e(){var t=this;t.keyboard.enabled&&t.keyboard.disable()}}},mt={lastScrollTime:Ie.now(),event:function e(){return-1<Le.navigator.userAgent.indexOf("firefox")?"DOMMouseScroll":Pe()?"wheel":"mousewheel"}(),normalize:function e(t){
// Reasonable defaults
var n=10,i=40,o=800,r=0,a=0,s=0,l=0;// pixelX, pixelY
// Legacy
return"detail"in t&&(a=t.detail),"wheelDelta"in t&&(a=-t.wheelDelta/120),"wheelDeltaY"in t&&(a=-t.wheelDeltaY/120),"wheelDeltaX"in t&&(r=-t.wheelDeltaX/120),
// side scrolling on FF with DOMMouseScroll
"axis"in t&&t.axis===t.HORIZONTAL_AXIS&&(r=a,a=0),s=10*r,l=10*a,"deltaY"in t&&(l=t.deltaY),"deltaX"in t&&(s=t.deltaX),(s||l)&&t.deltaMode&&(1===t.deltaMode?(// delta in LINE units
s*=40,l*=40):(// delta in PAGE units
s*=800,l*=800)),
// Fall-back if spin cannot be determined
s&&!r&&(r=s<1?-1:1),l&&!a&&(a=l<1?-1:1),{spinX:r,spinY:a,pixelX:s,pixelY:l}},handleMouseEnter:function e(){var t;this.mouseEntered=!0},handleMouseLeave:function e(){var t;this.mouseEntered=!1},handle:function e(t){var n=t,i=this,o=i.params.mousewheel;if(!i.mouseEntered&&!o.releaseOnEdges)return!0;n.originalEvent&&(n=n.originalEvent);// jquery fix
var r=0,a=i.rtlTranslate?-1:1,s=mt.normalize(n);if(o.forceToAxis)if(i.isHorizontal()){if(!(Math.abs(s.pixelX)>Math.abs(s.pixelY)))return!0;r=s.pixelX*a}else{if(!(Math.abs(s.pixelY)>Math.abs(s.pixelX)))return!0;r=s.pixelY}else r=Math.abs(s.pixelX)>Math.abs(s.pixelY)?-s.pixelX*a:-s.pixelY;if(0===r)return!0;if(o.invert&&(r=-r),i.params.freeMode){
// Freemode or scrollContainer:
i.params.loop&&i.loopFix();var l=i.getTranslate()+r*o.sensitivity,u=i.isBeginning,c=i.isEnd;
...
var t=this,n=t.params.navigation;if(!t.params.loop){var i=t.navigation,o=i.$nextEl,r=i.$prevEl;r&&0<r.length&&(t.isBeginning?r.addClass(n.disabledClass):r.removeClass(n.disabledClass),r[t.params.watchOverflow&&t.isLocked?"addClass":"removeClass"](n.lockClass)),o&&0<o.length&&(t.isEnd?o.addClass(n.disabledClass):o.removeClass(n.disabledClass),o[t.params.watchOverflow&&t.isLocked?"addClass":"removeClass"](n.lockClass))}},onPrevClick:function e(t){var n=this;t.preventDefault(),n.isBeginning&&!n.params.loop||n.slidePrev()},onNextClick:function e(t){var n=this;t.preventDefault(),n.isEnd&&!n.params.loop||n.slideNext()},init:function e(){var t=this,n=t.params.navigation,i,o;(n.nextEl||n.prevEl)&&(n.nextEl&&(i=P(n.nextEl),t.params.uniqueNavElements&&"string"==typeof n.nextEl&&1<i.length&&1===t.$el.find(n.nextEl).length&&(i=t.$el.find(n.nextEl))),n.prevEl&&(o=P(n.prevEl),t.params.uniqueNavElements&&"string"==typeof n.prevEl&&1<o.length&&1===t.$el.find(n.prevEl).length&&(o=t.$el.find(n.prevEl))),i&&0<i.length&&i.on("click",t.navigation.onNextClick),o&&0<o.length&&o.on("click",t.navigation.onPrevClick),Ie.extend(t.navigation,{$nextEl:i,nextEl:i&&i[0],$prevEl:o,prevEl:o&&o[0]}))},destroy:function e(){var t=this,n=t.navigation,i=n.$nextEl,o=n.$prevEl;i&&i.length&&(i.off("click",t.navigation.onNextClick),i.removeClass(t.params.navigation.disabledClass)),o&&o.length&&(o.off("click",t.navigation.onPrevClick),o.removeClass(t.params.navigation.disabledClass))}},yt,bt={update:function e(){
// Render || Update Pagination bullets/items
var t=this,n=t.rtl,o=t.params.pagination;if(o.el&&t.pagination.el&&t.pagination.$el&&0!==t.pagination.$el.length){var i=t.virtual&&t.params.virtual.enabled?t.virtual.slides.length:t.slides.length,r=t.pagination.$el,a,s=t.params.loop?Math.ceil((i-2*t.loopedSlides)/t.params.slidesPerGroup):t.snapGrid.length;
// Types
if(t.params.loop?((a=Math.ceil((t.activeIndex-t.loopedSlides)/t.params.slidesPerGroup))>i-1-2*t.loopedSlides&&(a-=i-2*t.loopedSlides),s-1<a&&(a-=s),a<0&&"bullets"!==t.params.paginationType&&(a=s+a)):a=void 0!==t.snapIndex?t.snapIndex:t.activeIndex||0,"bullets"===o.type&&t.pagination.bullets&&0<t.pagination.bullets.length){var l=t.pagination.bullets,u,c,d,f;if(o.dynamicBullets&&(t.pagination.bulletSize=l.eq(0)[t.isHorizontal()?"outerWidth":"outerHeight"](!0),r.css(t.isHorizontal()?"width":"height",t.pagination.bulletSize*(o.dynamicMainBullets+4)+"px"),1<o.dynamicMainBullets&&void 0!==t.previousIndex&&(t.pagination.dynamicBulletIndex+=a-t.previousIndex,t.pagination.dynamicBulletIndex>o.dynamicMainBullets-1?t.pagination.dynamicBulletIndex=o.dynamicMainBullets-1:t.pagination.dynamicBulletIndex<0&&(t.pagination.dynamicBulletIndex=0)),u=a-t.pagination.dynamicBulletIndex,d=((c=u+(Math.min(l.length,o.dynamicMainBullets)-1))+u)/2),l.removeClass(o.bulletActiveClass+" "+o.bulletActiveClass+"-next "+o.bulletActiveClass+"-next-next "+o.bulletActiveClass+"-prev "+o.bulletActiveClass+"-prev-prev "+o.bulletActiveClass+"-main"),1<r.length)l.each(function(e,t){var n=P(t),i=n.index();i===a&&n.addClass(o.bulletActiveClass),o.dynamicBullets&&(u<=i&&i<=c&&n.addClass(o.bulletActiveClass+"-main"),i===u&&n.prev().addClass(o.bulletActiveClass+"-prev").prev().addClass(o.bulletActiveClass+"-prev-prev"),i===c&&n.next().addClass(o.bulletActiveClass+"-next").next().addClass(o.bulletActiveClass+"-next-next"))});else if(l.eq(a).addClass(o.bulletActiveClass),o.dynamicBullets){for(var p=l.eq(u),h=l.eq(c),m=u;m<=c;m+=1)l.eq(m).addClass(o.bulletActiveClass+"-main");p.prev().addClass(o.bulletActiveClass+"-prev").prev().addClass(o.bulletActiveClass+"-prev-prev"),h.next().addClass(o.bulletActiveClass+"-next").next().addClass(o.bulletActiveClass+"-next-next")}if(o.dynamicBullets){var v=Math.min(l.length,o.dynamicMainBullets+4),g=(t.pagination.bulletSize*v-t.pagination.bulletSize)/2-d*t.pagination.bulletSize,y=n?"right":"left";l.css(t.isHorizontal()?y:"top",g+"px")}}if("fraction"===o.type&&(r.find("."+o.currentClass).text(o.formatFractionCurrent(a+1)),r.find("."+o.totalClass).text(o.formatFractionTotal(s))),"progressbar"===o.type){var b;b=o.progressbarOpposite?t.isHorizontal()?"vertical":"horizontal":t.isHorizontal()?"horizontal":"vertical";var w=(a+1)/s,x=1,T=1;"horizontal"===b?x=w:T=w,r.find("."+o.progressbarFillClass).transform("translate3d(0,0,0) scaleX("+x+") scaleY("+T+")").transition(t.params.speed)}"custom"===o.type&&o.renderCustom?(r.html(o.renderCustom(t,a+1,s)),t.emit("paginationRender",t,r[0])):t.emit("paginationUpdate",t,r[0]),r[t.params.watchOverflow&&t.isLocked?"addClass":"removeClass"](o.lockClass)}},render:function e(){
// Render Container
var t=this,n=t.params.pagination;if(n.el&&t.pagination.el&&t.pagination.$el&&0!==t.pagination.$el.length){var i=t.virtual&&t.params.virtual.enabled?t.virtual.slides.length:t.slides.length,o=t.pagination.$el,r="";if("bullets"===n.type){for(var a=t.params.loop?Math.ceil((i-2*t.loopedSlides)/t.params.slidesPerGroup):t.snapGrid.length,s=0;s<a;s+=1)n.renderBullet?r+=n.renderBullet.call(t,s,n.bulletClass):r+="<"+n.bulletElement+' class="'+n.bulletClass+'"></'+n.bulletElement+">";o.html(r),t.pagination.bullets=o.find("."+n.bulletClass)}"fraction"===n.type&&(r=n.renderFraction?n.renderFraction.call(t,n.currentClass,n.totalClass):'<span class="'+n.currentClass+'"></span> / <span class="'+n.totalClass+'"></span>',o.html(r)),"progressbar"===n.type&&(r=n.renderProgressbar?n.renderProgressbar.call(t,n.progressbarFillClass):'<span class="'+n.progressbarFillClass+'"></span>',o.html(r)),"custom"!==n.type&&t.emit("paginationRender",t.pagination.$el[0])}},init:function e(){var i=this,t=i.params.pagination;if(t.el){var n=P(t.el);0!==n.length&&(i.params.uniqueNavElements&&"string"==typeof t.el&&1<n.length&&1===i.$el.find(t.el).length&&(n=i.$el.find(t.el)),"bullets"===t.type&&t.clickable&&n.addClass(t.clickableClass),n.addClass(t.modifierClass+t.type),"bullets"===t.type&&t.dynamicBullets&&(n.addClass(""+t.modifierClass+t.type+"-dynamic"),i.pagination.dynamicBulletIndex=0,t.dynamicMainBullets<1&&(t.dynamicMainBullets=1)),"progressbar"===t.type&&t.progressbarOpposite&&n.addClass(t.progressbarOppositeClass),t.clickable&&n.on("click","."+t.bulletClass,function e(t){t.preventDefault();var n=P(this).index()*i.params.slidesPerGroup;i.params.loop&&(n+=i.loopedSlides),i.slideTo(n)}),Ie.extend(i.pagination,{$el:n,el:n[0]}))}},destroy:function e(){var t=this,n=t.params.pagination;if(n.el&&t.pagination.el&&t.pagination.$el&&0!==t.pagination.$el.length){var i=t.pagination.$el;i.removeClass(n.hiddenClass),i.removeClass(n.modifierClass+n.type),t.pagination.bullets&&t.pagination.bullets.removeClass(n.bulletActiveClass),n.clickable&&i.off("click","."+n.bulletClass)}}},wt,xt={setTranslate:function e(){var t=this;if(t.params.scrollbar.el&&t.scrollbar.el){var n=t.scrollbar,i=t.rtlTranslate,o=t.progress,r=n.dragSize,a=n.trackSize,s=n.$dragEl,l=n.$el,u=t.params.scrollbar,c=r,d=(a-r)*o;i?0<(d=-d)?(c=r-d,d=0):a<-d+r&&(c=a+d):d<0?(c=r+d,d=0):a<d+r&&(c=a-d),t.isHorizontal()?(He.transforms3d?s.transform("translate3d("+d+"px, 0, 0)"):s.transform("translateX("+d+"px)"),s[0].style.width=c+"px"):(He.transforms3d?s.transform("translate3d(0px, "+d+"px, 0)"):s.transform("translateY("+d+"px)"),s[0].style.height=c+"px"),u.hide&&(clearTimeout(t.scrollbar.timeout),l[0].style.opacity=1,t.scrollbar.timeout=setTimeout(function(){l[0].style.opacity=0,l.transition(400)},1e3))}},setTransition:function e(t){var n=this;n.params.scrollbar.el&&n.scrollbar.el&&n.scrollbar.$dragEl.transition(t)},updateSize:function e(){var t=this;if(t.params.scrollbar.el&&t.scrollbar.el){var n=t.scrollbar,i=n.$dragEl,o=n.$el;i[0].style.width="",i[0].style.height="";var r=t.isHorizontal()?o[0].offsetWidth:o[0].offsetHeight,a=t.size/t.virtualSize,s=a*(r/t.size),l;l="auto"===t.params.scrollbar.dragSize?r*a:parseInt(t.params.scrollbar.dragSize,10),t.isHorizontal()?i[0].style.width=l+"px":i[0].style.height=l+"px",o[0].style.display=1<=a?"none":"",t.params.scrollbarHide&&(o[0].style.opacity=0),Ie.extend(n,{trackSize:r,divider:a,moveDivider:s,dragSize:l}),n.$el[t.params.watchOverflow&&t.isLocked?"addClass":"removeClass"](t.params.scrollbar.lockClass)}},setDragPosition:function e(t){var n=this,i=n.scrollbar,o=n.rtlTranslate,r=i.$el,a=i.dragSize,s=i.trackSize,l,u;u=((l=n.isHorizontal()?"touchstart"===t.type||"touchmove"===t.type?t.targetTouches[0].pageX:t.pageX||t.clientX:"touchstart"===t.type||"touchmove"===t.type?t.targetTouches[0].pageY:t.pageY||t.clientY)-r.offset()[n.isHorizontal()?"left":"top"]-a/2)/(s-a),u=Math.max(Math.min(u,1),0),o&&(u=1-u);var c=n.minTranslate()+(n.maxTranslate()-n.minTranslate())*u;n.updateProgress(c),n.setTranslate(c),n.updateActiveIndex(),n.updateSlidesClasses()},onDragStart:function e(t){var n=this,i=n.params.scrollbar,o=n.scrollbar,r=n.$wrapperEl,a=o.$el,s=o.$dragEl;n.scrollbar.isTouched=!0,t.preventDefault(),t.stopPropagation(),r.transition(100),s.transition(100),o.setDragPosition(t),clearTimeout(n.scrollbar.dragTimeout),a.transition(0),i.hide&&a.css("opacity",1),n.emit("scrollbarDragStart",t)},onDragMove:function e(t){var n=this,i=n.scrollbar,o=n.$wrapperEl,r=i.$el,a=i.$dragEl;n.scrollbar.isTouched&&(t.preventDefault?t.preventDefault():t.returnValue=!1,i.setDragPosition(t),o.transition(0),r.transition(0),a.transition(0),n.emit("scrollbarDragMove",t))},onDragEnd:function e(t){var n=this,i=n.params.scrollbar,o,r=n.scrollbar.$el;n.scrollbar.isTouched&&(n.scrollbar.isTouched=!1,i.hide&&(clearTimeout(n.scrollbar.dragTimeout),n.scrollbar.dragTimeout=Ie.nextTick(function(){r.css("opacity",0),r.transition(400)},1e3)),n.emit("scrollbarDragEnd",t),i.snapOnRelease&&n.slideToClosest())},enableDraggable:function e(){var t=this;if(t.params.scrollbar.el){var n=t.scrollbar,i=t.touchEventsTouch,o=t.touchEventsDesktop,r=t.params,a,s=n.$el[0],l=!(!He.passiveListener||!r.passiveListeners)&&{passive:!1,capture:!1},u=!(!He.passiveListener||!r.passiveListeners)&&{passive:!0,capture:!1};He.touch?(s.addEventListener(i.start,t.scrollbar.onDragStart,l),s.addEventListener(i.move,t.scrollbar.onDragMove,l),s.addEventListener(i.end,t.scrollbar.onDragEnd,u)):(s.addEventListener(o.start,t.scrollbar.onDragStart,l),Me.addEventListener(o.move,t.scrollbar.onDragMove,l),Me.addEventListener(o.end,t.scrollbar.onDragEnd,u))}},disableDraggable:function e(){var t=this;if(t.params.scrollbar.el){var n=t.scrollbar,i=t.touchEventsTouch,o=t.touchEventsDesktop,r=t.params,a,s=n.$el[0],l=!(!He.passiveListener||!r.passiveListeners)&&{passive:!1,capture:!1},u=!(!He.passiveListener||!r.passiveListeners)&&{passive:!0,capture:!1};He.touch?(s.removeEventListener(i.start,t.scrollbar.onDragStart,l),s.removeEventListener(i.move,t.scrollbar.onDragMove,l),s.removeEventListener(i.end,t.scrollbar.onDragEnd,u)):(s.removeEventListener(o.start,t.scrollbar.onDragStart,l),Me.removeEventListener(o.move,t.scrollbar.onDragMove,l),Me.removeEventListener(o.end,t.scrollbar.onDragEnd,u))}},init:function e(){var t=this;if(t.params.scrollbar.el){var n=t.scrollbar,i=t.$el,o=t.params.scrollbar,r=P(o.el);t.params.uniqueNavElements&&"string"==typeof o.el&&1<r.length&&1===i.find(o.el).length&&(r=i.find(o.el));var a=r.find("."+t.params.scrollbar.dragClass);0===a.length&&(a=P('<div class="'+t.params.scrollbar.dragClass+'"></div>'),r.append(a)),Ie.extend(n,{$el:r,el:r[0],$dragEl:a,dragEl:a[0]}),o.draggable&&n.enableDraggable()}},destroy:function e(){var t;this.scrollbar.disableDraggable()}},Tt,Ct={setTransform:function e(t,n){var i=this,o=i.rtl,r=P(t),a=o?-1:1,s=r.attr("data-swiper-parallax")||"0",l=r.attr("data-swiper-parallax-x"),u=r.attr("data-swiper-parallax-y"),c=r.attr("data-swiper-parallax-scale"),d=r.attr("data-swiper-parallax-opacity");if(l||u?(l=l||"0",u=u||"0"):i.isHorizontal()?(l=s,u="0"):(u=s,l="0"),l=0<=l.indexOf("%")?parseInt(l,10)*n*a+"%":l*n*a+"px",u=0<=u.indexOf("%")?parseInt(u,10)*n+"%":u*n+"px",null!=d){var f=d-(d-1)*(1-Math.abs(n));r[0].style.opacity=f}if(null==c)r.transform("translate3d("+l+", "+u+", 0px)");else{var p=c-(c-1)*(1-Math.abs(n));r.transform("translate3d("+l+", "+u+", 0px) scale("+p+")")}},setTranslate:function e(){var i=this,t=i.$el,n=i.slides,o=i.progress,r=i.snapGrid;t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e,t){i.parallax.setTransform(t,o)}),n.each(function(e,t){var n=t.progress;1<i.params.slidesPerGroup&&"auto"!==i.params.slidesPerView&&(n+=Math.ceil(e/2)-o*(r.length-1)),n=Math.min(Math.max(n,-1),1),P(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e,t){i.parallax.setTransform(t,n)})})},setTransition:function e(o){var t,n;void 0===o&&(o=this.params.speed),this.$el.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function(e,t){var n=P(t),i=parseInt(n.attr("data-swiper-parallax-duration"),10)||o;0===o&&(i=0),n.transition(i)})}},kt,Et={
// Calc Scale From Multi-touches
getDistanceBetweenTouches:function e(t){if(t.targetTouches.length<2)return 1;var n=t.targetTouches[0].pageX,i=t.targetTouches[0].pageY,o=t.targetTouches[1].pageX,r=t.targetTouches[1].pageY,a;return Math.sqrt(Math.pow(o-n,2)+Math.pow(r-i,2))},
// Events
onGestureStart:function e(t){var n=this,i=n.params.zoom,o=n.zoom,r=o.gesture;if(o.fakeGestureTouched=!1,o.fakeGestureMoved=!1,!He.gestures){if("touchstart"!==t.type||"touchstart"===t.type&&t.targetTouches.length<2)return;o.fakeGestureTouched=!0,r.scaleStart=Et.getDistanceBetweenTouches(t)}r.$slideEl&&r.$slideEl.length||(r.$slideEl=P(t.target).closest(".swiper-slide"),0===r.$slideEl.length&&(r.$slideEl=n.slides.eq(n.activeIndex)),r.$imageEl=r.$slideEl.find("img, svg, canvas"),r.$imageWrapEl=r.$imageEl.parent("."+i.containerClass),r.maxRatio=r.$imageWrapEl.attr("data-swiper-zoom")||i.maxRatio,0!==r.$imageWrapEl.length)?(r.$imageEl.transition(0),n.zoom.isScaling=!0):r.$imageEl=void 0},onGestureChange:function e(t){var n=this,i=n.params.zoom,o=n.zoom,r=o.gesture;if(!He.gestures){if("touchmove"!==t.type||"touchmove"===t.type&&t.targetTouches.length<2)return;o.fakeGestureMoved=!0,r.scaleMove=Et.getDistanceBetweenTouches(t)}r.$imageEl&&0!==r.$imageEl.length&&(He.gestures?o.scale=t.scale*o.currentScale:o.scale=r.scaleMove/r.scaleStart*o.currentScale,o.scale>r.maxRatio&&(o.scale=r.maxRatio-1+Math.pow(o.scale-r.maxRatio+1,.5)),o.scale<i.minRatio&&(o.scale=i.minRatio+1-Math.pow(i.minRatio-o.scale+1,.5)),r.$imageEl.transform("translate3d(0,0,0) scale("+o.scale+")"))},onGestureEnd:function e(t){var n=this,i=n.params.zoom,o=n.zoom,r=o.gesture;if(!He.gestures){if(!o.fakeGestureTouched||!o.fakeGestureMoved)return;if("touchend"!==t.type||"touchend"===t.type&&t.changedTouches.length<2&&!Xe.android)return;o.fakeGestureTouched=!1,o.fakeGestureMoved=!1}r.$imageEl&&0!==r.$imageEl.length&&(o.scale=Math.max(Math.min(o.scale,r.maxRatio),i.minRatio),r.$imageEl.transition(n.params.speed).transform("translate3d(0,0,0) scale("+o.scale+")"),o.currentScale=o.scale,o.isScaling=!1,1===o.scale&&(r.$slideEl=void 0))},onTouchStart:function e(t){var n,i=this.zoom,o=i.gesture,r=i.image;o.$imageEl&&0!==o.$imageEl.length&&(r.isTouched||(Xe.android&&t.preventDefault(),r.isTouched=!0,r.touchesStart.x="touchstart"===t.type?t.targetTouches[0].pageX:t.pageX,r.touchesStart.y="touchstart"===t.type?t.targetTouches[0].pageY:t.pageY))},onTouchMove:function e(t){var n=this,i=n.zoom,o=i.gesture,r=i.image,a=i.velocity;if(o.$imageEl&&0!==o.$imageEl.length&&(n.allowClick=!1,r.isTouched&&o.$slideEl)){r.isMoved||(r.width=o.$imageEl[0].offsetWidth,r.height=o.$imageEl[0].offsetHeight,r.startX=Ie.getTranslate(o.$imageWrapEl[0],"x")||0,r.startY=Ie.getTranslate(o.$imageWrapEl[0],"y")||0,o.slideWidth=o.$slideEl[0].offsetWidth,o.slideHeight=o.$slideEl[0].offsetHeight,o.$imageWrapEl.transition(0),n.rtl&&(r.startX=-r.startX,r.startY=-r.startY));
// Define if we need image drag
var s=r.width*i.scale,l=r.height*i.scale;if(!(s<o.slideWidth&&l<o.slideHeight)){if(r.minX=Math.min(o.slideWidth/2-s/2,0),r.maxX=-r.minX,r.minY=Math.min(o.slideHeight/2-l/2,0),r.maxY=-r.minY,r.touchesCurrent.x="touchmove"===t.type?t.targetTouches[0].pageX:t.pageX,r.touchesCurrent.y="touchmove"===t.type?t.targetTouches[0].pageY:t.pageY,!r.isMoved&&!i.isScaling){if(n.isHorizontal()&&(Math.floor(r.minX)===Math.floor(r.startX)&&r.touchesCurrent.x<r.touchesStart.x||Math.floor(r.maxX)===Math.floor(r.startX)&&r.touchesCurrent.x>r.touchesStart.x))return void(r.isTouched=!1);if(!n.isHorizontal()&&(Math.floor(r.minY)===Math.floor(r.startY)&&r.touchesCurrent.y<r.touchesStart.y||Math.floor(r.maxY)===Math.floor(r.startY)&&r.touchesCurrent.y>r.touchesStart.y))return void(r.isTouched=!1)}t.preventDefault(),t.stopPropagation(),r.isMoved=!0,r.currentX=r.touchesCurrent.x-r.touchesStart.x+r.startX,r.currentY=r.touchesCurrent.y-r.touchesStart.y+r.startY,r.currentX<r.minX&&(r.currentX=r.minX+1-Math.pow(r.minX-r.currentX+1,.8)),r.currentX>r.maxX&&(r.currentX=r.maxX-1+Math.pow(r.currentX-r.maxX+1,.8)),r.currentY<r.minY&&(r.currentY=r.minY+1-Math.pow(r.minY-r.currentY+1,.8)),r.currentY>r.maxY&&(r.currentY=r.maxY-1+Math.pow(r.currentY-r.maxY+1,.8)),
// Velocity
a.prevPositionX||(a.prevPositionX=r.touchesCurrent.x),a.prevPositionY||(a.prevPositionY=r.touchesCurrent.y),a.prevTime||(a.prevTime=Date.now()),a.x=(r.touchesCurrent.x-a.prevPositionX)/(Date.now()-a.prevTime)/2,a.y=(r.touchesCurrent.y-a.prevPositionY)/(Date.now()-a.prevTime)/2,Math.abs(r.touchesCurrent.x-a.prevPositionX)<2&&(a.x=0),Math.abs(r.touchesCurrent.y-a.prevPositionY)<2&&(a.y=0),a.prevPositionX=r.touchesCurrent.x,a.prevPositionY=r.touchesCurrent.y,a.prevTime=Date.now(),o.$imageWrapEl.transform("translate3d("+r.currentX+"px, "+r.currentY+"px,0)")}}},onTouchEnd:function e(){var t,n=this.zoom,i=n.gesture,o=n.image,r=n.velocity;if(i.$imageEl&&0!==i.$imageEl.length){if(!o.isTouched||!o.isMoved)return o.isTouched=!1,void(o.isMoved=!1);o.isTouched=!1,o.isMoved=!1;var a=300,s=300,l=r.x*a,u=o.currentX+l,c=r.y*s,d=o.currentY+c;
// Fix duration
0!==r.x&&(a=Math.abs((u-o.currentX)/r.x)),0!==r.y&&(s=Math.abs((d-o.currentY)/r.y));var f=Math.max(a,s);o.currentX=u,o.currentY=d;
// Define if we need image drag
...
i.out():
// Zoom In
i.in(t)},in:function e(t){var n=this,i=n.zoom,o=n.params.zoom,r=i.gesture,a=i.image,s,l,u,c,d,f,p,h,m,v,g,y,b,w,x,T,C,k;(r.$slideEl||(r.$slideEl=n.clickedSlide?P(n.clickedSlide):n.slides.eq(n.activeIndex),r.$imageEl=r.$slideEl.find("img, svg, canvas"),r.$imageWrapEl=r.$imageEl.parent("."+o.containerClass)),r.$imageEl&&0!==r.$imageEl.length)&&(r.$slideEl.addClass(""+o.zoomedSlideClass),l=void 0===a.touchesStart.x&&t?(s="touchend"===t.type?t.changedTouches[0].pageX:t.pageX,"touchend"===t.type?t.changedTouches[0].pageY:t.pageY):(s=a.touchesStart.x,a.touchesStart.y),i.scale=r.$imageWrapEl.attr("data-swiper-zoom")||o.maxRatio,i.currentScale=r.$imageWrapEl.attr("data-swiper-zoom")||o.maxRatio,t?(C=r.$slideEl[0].offsetWidth,k=r.$slideEl[0].offsetHeight,d=(u=r.$slideEl.offset().left)+C/2-s,f=(c=r.$slideEl.offset().top)+k/2-l,m=r.$imageEl[0].offsetWidth,v=r.$imageEl[0].offsetHeight,g=m*i.scale,y=v*i.scale,x=-(b=Math.min(C/2-g/2,0)),T=-(w=Math.min(k/2-y/2,0)),(p=d*i.scale)<b&&(p=b),x<p&&(p=x),(h=f*i.scale)<w&&(h=w),T<h&&(h=T)):h=p=0,r.$imageWrapEl.transition(300).transform("translate3d("+p+"px, "+h+"px,0)"),r.$imageEl.transition(300).transform("translate3d(0,0,0) scale("+i.scale+")"))},out:function e(){var t=this,n=t.zoom,i=t.params.zoom,o=n.gesture;o.$slideEl||(o.$slideEl=t.clickedSlide?P(t.clickedSlide):t.slides.eq(t.activeIndex),o.$imageEl=o.$slideEl.find("img, svg, canvas"),o.$imageWrapEl=o.$imageEl.parent("."+i.containerClass)),o.$imageEl&&0!==o.$imageEl.length&&(n.scale=1,n.currentScale=1,o.$imageWrapEl.transition(300).transform("translate3d(0,0,0)"),o.$imageEl.transition(300).transform("translate3d(0,0,0) scale(1)"),o.$slideEl.removeClass(""+i.zoomedSlideClass),o.$slideEl=void 0)},
...
// Move image
t.$wrapperEl.off(t.touchEvents.move,"."+t.params.zoom.containerClass,n.onTouchMove)}}},St,$t={loadInSlide:function e(t,l){void 0===l&&(l=!0);var u=this,c=u.params.lazy;if(void 0!==t&&0!==u.slides.length){var n,d=u.virtual&&u.params.virtual.enabled?u.$wrapperEl.children("."+u.params.slideClass+'[data-swiper-slide-index="'+t+'"]'):u.slides.eq(t),i=d.find("."+c.elementClass+":not(."+c.loadedClass+"):not(."+c.loadingClass+")");!d.hasClass(c.elementClass)||d.hasClass(c.loadedClass)||d.hasClass(c.loadingClass)||(i=i.add(d[0])),0!==i.length&&i.each(function(e,t){var i=P(t);i.addClass(c.loadingClass);var o=i.attr("data-background"),r=i.attr("data-src"),a=i.attr("data-srcset"),s=i.attr("data-sizes");u.loadImage(i[0],r||o,a,s,!1,function(){if(null!=u&&u&&(!u||u.params)&&!u.destroyed){if(o?(i.css("background-image",'url("'+o+'")'),i.removeAttr("data-background")):(a&&(i.attr("srcset",a),i.removeAttr("data-srcset")),s&&(i.attr("sizes",s),i.removeAttr("data-sizes")),r&&(i.attr("src",r),i.removeAttr("data-src"))),i.addClass(c.loadedClass).removeClass(c.loadingClass),d.find("."+c.preloaderClass).remove(),u.params.loop&&l){var e=d.attr("data-swiper-slide-index");if(d.hasClass(u.params.slideDuplicateClass)){var t=u.$wrapperEl.children('[data-swiper-slide-index="'+e+'"]:not(.'+u.params.slideDuplicateClass+")");u.lazy.loadInSlide(t.index(),!1)}else{var n=u.$wrapperEl.children("."+u.params.slideDuplicateClass+'[data-swiper-slide-index="'+e+'"]');u.lazy.loadInSlide(n.index(),!1)}}u.emit("lazyImageReady",d[0],i[0])}}),u.emit("lazyImageLoad",d[0],i[0])})}},load:function e(){function t(e){if(l){if(o.children("."+r.slideClass+'[data-swiper-slide-index="'+e+'"]').length)return!0}else if(a[e])return!0;return!1}function n(e){return l?P(e).attr("data-swiper-slide-index"):P(e).index()}var i=this,o=i.$wrapperEl,r=i.params,a=i.slides,s=i.activeIndex,l=i.virtual&&r.virtual.enabled,u=r.lazy,c=r.slidesPerView;if("auto"===c&&(c=0),i.lazy.initialImageLoaded||(i.lazy.initialImageLoaded=!0),i.params.watchSlidesVisibility)o.children("."+r.slideVisibleClass).each(function(e,t){var n=l?P(t).attr("data-swiper-slide-index"):P(t).index();i.lazy.loadInSlide(n)});else if(1<c)for(var d=s;d<s+c;d+=1)t(d)&&i.lazy.loadInSlide(d);else i.lazy.loadInSlide(s);if(u.loadPrevNext)if(1<c||u.loadPrevNextAmount&&1<u.loadPrevNextAmount){
// Next Slides
for(var f=u.loadPrevNextAmount,p=c,h=Math.min(s+p+Math.max(f,p),a.length),m=Math.max(s-Math.max(p,f),0),v=s+c;v<h;v+=1)t(v)&&i.lazy.loadInSlide(v);
// Prev Slides
for(var g=m;g<s;g+=1)t(g)&&i.lazy.loadInSlide(g)}else{var y=o.children("."+r.slideNextClass);0<y.length&&i.lazy.loadInSlide(n(y));var b=o.children("."+r.slidePrevClass);0<b.length&&i.lazy.loadInSlide(n(b))}}},jt,Ot={LinearSpline:function e(t,n){var i=function e(){var n,i,o;return function(e,t){for(i=-1,n=e.length;1<n-i;)e[o=n+i>>1]<=t?i=o:n=o;return n}}(),o,r;return this.x=t,this.y=n,this.lastIndex=t.length-1,this.interpolate=function e(t){return t?(
// Get the indexes of x1 and x3 (the array indexes before and after given x2):
r=i(this.x,t),o=r-1,(t-this.x[o])*(this.y[r]-this.y[o])/(this.x[r]-this.x[o])+this.y[o]):0},this},
// xxx: for now i will just save one spline function to to
getInterpolateFunction:function e(t){var n=this;n.controller.spline||(n.controller.spline=n.params.loop?new Ot.LinearSpline(n.slidesGrid,t.slidesGrid):new Ot.LinearSpline(n.snapGrid,t.snapGrid))},setTranslate:function e(t,n){function i(e){
...
// Pagination
t.pagination&&t.params.pagination.clickable&&t.pagination.bullets&&t.pagination.bullets.length&&t.pagination.$el.off("keydown","."+t.params.pagination.bulletClass,t.a11y.onEnterKey)}},Pt,Mt={init:function e(){var t=this;if(t.params.history){if(!Le.history||!Le.history.pushState)return t.params.history.enabled=!1,void(t.params.hashNavigation.enabled=!0);var n=t.history;n.initialized=!0,n.paths=Mt.getPathValues(),(n.paths.key||n.paths.value)&&(n.scrollToSlide(0,n.paths.value,t.params.runCallbacksOnInit),t.params.history.replaceState||Le.addEventListener("popstate",t.history.setHistoryPopState))}},destroy:function e(){var t=this;t.params.history.replaceState||Le.removeEventListener("popstate",t.history.setHistoryPopState)},setHistoryPopState:function e(){var t=this;t.history.paths=Mt.getPathValues(),t.history.scrollToSlide(t.params.speed,t.history.paths.value,!1)},getPathValues:function e(){var t=Le.location.pathname.slice(1).split("/").filter(function(e){return""!==e}),n=t.length,i,o;return{key:t[n-2],value:t[n-1]}},setHistory:function e(t,n){var i=this;if(i.history.initialized&&i.params.history.enabled){var o=i.slides.eq(n),r=Mt.slugify(o.attr("data-history"));Le.location.pathname.includes(t)||(r=t+"/"+r);var a=Le.history.state;a&&a.value===r||(i.params.history.replaceState?Le.history.replaceState({value:r},null,r):Le.history.pushState({value:r},null,r))}},slugify:function e(t){return t.toString().toLowerCase().replace(/\s+/g,"-").replace(/[^\w-]+/g,"").replace(/--+/g,"-").replace(/^-+/,"").replace(/-+$/,"")},scrollToSlide:function e(t,n,i){var o=this;if(n)for(var r=0,a=o.slides.length;r<a;r+=1){var s=o.slides.eq(r),l;if(Mt.slugify(s.attr("data-history"))===n&&!s.hasClass(o.params.slideDuplicateClass)){var u=s.index();o.slideTo(u,t,i)}}else o.slideTo(0,t,i)}},Lt,At={onHashCange:function e(){var t=this,n=Me.location.hash.replace("#",""),i;if(n!==t.slides.eq(t.activeIndex).attr("data-hash")){var o=t.$wrapperEl.children("."+t.params.slideClass+'[data-hash="'+n+'"]').index();if(void 0===o)return;t.slideTo(o)}},setHash:function e(){var t=this;if(t.hashNavigation.initialized&&t.params.hashNavigation.enabled)if(t.params.hashNavigation.replaceState&&Le.history&&Le.history.replaceState)Le.history.replaceState(null,null,"#"+t.slides.eq(t.activeIndex).attr("data-hash")||"");else{var n=t.slides.eq(t.activeIndex),i=n.attr("data-hash")||n.attr("data-history");Me.location.hash=i||""}},init:function e(){var t=this;if(!(!t.params.hashNavigation.enabled||t.params.history&&t.params.history.enabled)){t.hashNavigation.initialized=!0;var n=Me.location.hash.replace("#","");if(n)for(var i=0,o=0,r=t.slides.length;o<r;o+=1){var a=t.slides.eq(o),s;if((a.attr("data-hash")||a.attr("data-history"))===n&&!a.hasClass(t.params.slideDuplicateClass)){var l=a.index();t.slideTo(l,0,t.params.runCallbacksOnInit,!0)}}t.params.hashNavigation.watchState&&P(Le).on("hashchange",t.hashNavigation.onHashCange)}},destroy:function e(){var t=this;t.params.hashNavigation.watchState&&P(Le).off("hashchange",t.hashNavigation.onHashCange)}},Dt,It={run:function e(){var t=this,n=t.slides.eq(t.activeIndex),i=t.params.autoplay.delay;n.attr("data-swiper-autoplay")&&(i=n.attr("data-swiper-autoplay")||t.params.autoplay.delay),t.autoplay.timeout=Ie.nextTick(function(){t.params.autoplay.reverseDirection?t.params.loop?(t.loopFix(),t.slidePrev(t.params.speed,!0,!0),t.emit("autoplay")):t.isBeginning?t.params.autoplay.stopOnLastSlide?t.autoplay.stop():(t.slideTo(t.slides.length-1,t.params.speed,!0,!0),t.emit("autoplay")):(t.slidePrev(t.params.speed,!0,!0),t.emit("autoplay")):t.params.loop?(t.loopFix(),t.slideNext(t.params.speed,!0,!0),t.emit("autoplay")):t.isEnd?t.params.autoplay.stopOnLastSlide?t.autoplay.stop():(t.slideTo(0,t.params.speed,!0,!0),t.emit("autoplay")):(t.slideNext(t.params.speed,!0,!0),t.emit("autoplay"))},i)},start:function e(){var t=this;return void 0===t.autoplay.timeout&&(!t.autoplay.running&&(t.autoplay.running=!0,t.emit("autoplayStart"),t.autoplay.run(),!0))},stop:function e(){var t=this;return!!t.autoplay.running&&(void 0!==t.autoplay.timeout&&(t.autoplay.timeout&&(clearTimeout(t.autoplay.timeout),t.autoplay.timeout=void 0),t.autoplay.running=!1,t.emit("autoplayStop"),!0))},pause:function e(t){var n=this;n.autoplay.running&&(n.autoplay.paused||(n.autoplay.timeout&&clearTimeout(n.autoplay.timeout),n.autoplay.paused=!0,0!==t&&n.params.autoplay.waitForTransition?(n.$wrapperEl[0].addEventListener("transitionend",n.autoplay.onTransitionEnd),n.$wrapperEl[0].addEventListener("webkitTransitionEnd",n.autoplay.onTransitionEnd)):(n.autoplay.paused=!1,n.autoplay.run())))}},Ht,qt={setTranslate:function e(){for(var t=this,n=t.slides,i=0;i<n.length;i+=1){var o=t.slides.eq(i),r,a=-o[0].swiperSlideOffset;t.params.virtualTranslate||(a-=t.translate);var s=0;t.isHorizontal()||(s=a,a=0);var l=t.params.fadeEffect.crossFade?Math.max(1-Math.abs(o[0].progress),0):1+Math.min(Math.max(o[0].progress,-1),0);o.css({opacity:l}).transform("translate3d("+a+"px, "+s+"px, 0px)")}},setTransition:function e(t){var n=this,i=n.slides,o=n.$wrapperEl;if(i.transition(t),n.params.virtualTranslate&&0!==t){var r=!1;i.transitionEnd(function(){if(!r&&n&&!n.destroyed){r=!0,n.animating=!1;for(var e=["webkitTransitionEnd","transitionend"],t=0;t<e.length;t+=1)o.trigger(e[t])}})}}},Rt,Nt={setTranslate:function e(){var t=this,n=t.$el,i=t.$wrapperEl,o=t.slides,r=t.width,a=t.height,s=t.rtlTranslate,l=t.size,u=t.params.cubeEffect,c=t.isHorizontal(),d=t.virtual&&t.params.virtual.enabled,f=0,p;u.shadow&&(c?(0===(p=i.find(".swiper-cube-shadow")).length&&(p=P('<div class="swiper-cube-shadow"></div>'),i.append(p)),p.css({height:r+"px"})):0===(p=n.find(".swiper-cube-shadow")).length&&(p=P('<div class="swiper-cube-shadow"></div>'),n.append(p)));for(var h=0;h<o.length;h+=1){var m=o.eq(h),v=h;d&&(v=parseInt(m.attr("data-swiper-slide-index"),10));var g=90*v,y=Math.floor(g/360);s&&(g=-g,y=Math.floor(-g/360));var b=Math.max(Math.min(m[0].progress,1),-1),w=0,x=0,T=0;v%4==0?(w=4*-y*l,T=0):(v-1)%4==0?(w=0,T=4*-y*l):(v-2)%4==0?(w=l+4*y*l,T=l):(v-3)%4==0&&(w=-l,T=3*l+4*l*y),s&&(w=-w),c||(x=w,w=0);var C="rotateX("+(c?0:-g)+"deg) rotateY("+(c?g:0)+"deg) translate3d("+w+"px, "+x+"px, "+T+"px)";if(b<=1&&-1<b&&(f=90*v+90*b,s&&(f=90*-v-90*b)),m.transform(C),u.slideShadows){
// Set shadows
var k=c?m.find(".swiper-slide-shadow-left"):m.find(".swiper-slide-shadow-top"),E=c?m.find(".swiper-slide-shadow-right"):m.find(".swiper-slide-shadow-bottom");0===k.length&&(k=P('<div class="swiper-slide-shadow-'+(c?"left":"top")+'"></div>'),m.append(k)),0===E.length&&(E=P('<div class="swiper-slide-shadow-'+(c?"right":"bottom")+'"></div>'),m.append(E)),k.length&&(k[0].style.opacity=Math.max(-b,0)),E.length&&(E[0].style.opacity=Math.max(b,0))}}if(i.css({"-webkit-transform-origin":"50% 50% -"+l/2+"px","-moz-transform-origin":"50% 50% -"+l/2+"px","-ms-transform-origin":"50% 50% -"+l/2+"px","transform-origin":"50% 50% -"+l/2+"px"}),u.shadow)if(c)p.transform("translate3d(0px, "+(r/2+u.shadowOffset)+"px, "+-r/2+"px) rotateX(90deg) rotateZ(0deg) scale("+u.shadowScale+")");else{var S=Math.abs(f)-90*Math.floor(Math.abs(f)/90),$=1.5-(Math.sin(2*S*Math.PI/360)/2+Math.cos(2*S*Math.PI/360)/2),j=u.shadowScale,O=u.shadowScale/$,_=u.shadowOffset;p.transform("scale3d("+j+", 1, "+O+") translate3d(0px, "+(a/2+_)+"px, "+-a/2/O+"px) rotateX(-90deg)")}var z=Qe.isSafari||Qe.isUiWebView?-l/2:0;i.transform("translate3d(0px,0,"+z+"px) rotateX("+(t.isHorizontal()?0:f)+"deg) rotateY("+(t.isHorizontal()?-f:0)+"deg)")},setTransition:function e(t){var n=this,i=n.$el,o;n.slides.transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t),n.params.cubeEffect.shadow&&!n.isHorizontal()&&i.find(".swiper-cube-shadow").transition(t)}},Ft,Bt={setTranslate:function e(){for(var t=this,n=t.slides,i=t.rtlTranslate,o=0;o<n.length;o+=1){var r=n.eq(o),a=r[0].progress;t.params.flipEffect.limitRotation&&(a=Math.max(Math.min(r[0].progress,1),-1));var s,l,u=-180*a,c=0,d=-r[0].swiperSlideOffset,f=0;if(t.isHorizontal()?i&&(u=-u):(f=d,c=-u,u=d=0),r[0].style.zIndex=-Math.abs(Math.round(a))+n.length,t.params.flipEffect.slideShadows){
// Set shadows
var p=t.isHorizontal()?r.find(".swiper-slide-shadow-left"):r.find(".swiper-slide-shadow-top"),h=t.isHorizontal()?r.find(".swiper-slide-shadow-right"):r.find(".swiper-slide-shadow-bottom");0===p.length&&(p=P('<div class="swiper-slide-shadow-'+(t.isHorizontal()?"left":"top")+'"></div>'),r.append(p)),0===h.length&&(h=P('<div class="swiper-slide-shadow-'+(t.isHorizontal()?"right":"bottom")+'"></div>'),r.append(h)),p.length&&(p[0].style.opacity=Math.max(-a,0)),h.length&&(h[0].style.opacity=Math.max(a,0))}r.transform("translate3d("+d+"px, "+f+"px, 0px) rotateX("+c+"deg) rotateY("+u+"deg)")}},setTransition:function e(t){var i=this,n=i.slides,o=i.activeIndex,r=i.$wrapperEl;if(n.transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t),i.params.virtualTranslate&&0!==t){var a=!1;
// eslint-disable-next-line
n.eq(o).transitionEnd(function e(){if(!a&&i&&!i.destroyed){
// if (!$(this).hasClass(swiper.params.slideActiveClass)) return;
a=!0,i.animating=!1;for(var t=["webkitTransitionEnd","transitionend"],n=0;n<t.length;n+=1)r.trigger(t[n])}})}}},Gt,Wt={setTranslate:function e(){
// Each slide offset from center
for(var t=this,n=t.width,i=t.height,o=t.slides,r=t.$wrapperEl,a=t.slidesSizesGrid,s=t.params.coverflowEffect,l=t.isHorizontal(),u=t.translate,c=l?n/2-u:i/2-u,d=l?s.rotate:-s.rotate,f=s.depth,p=0,h=o.length,m;p<h;p+=1){var v=o.eq(p),g=a[p],y,b=(c-v[0].swiperSlideOffset-g/2)/g*s.modifier,w=l?d*b:0,x=l?0:d*b,T=-f*Math.abs(b),C=l?0:s.stretch*b,k=l?s.stretch*b:0;
// Fix for ultra small values
Math.abs(k)<.001&&(k=0),Math.abs(C)<.001&&(C=0),Math.abs(T)<.001&&(T=0),Math.abs(w)<.001&&(w=0),Math.abs(x)<.001&&(x=0);var E="translate3d("+k+"px,"+C+"px,"+T+"px)  rotateX("+x+"deg) rotateY("+w+"deg)";if(v.transform(E),v[0].style.zIndex=1-Math.abs(Math.round(b)),s.slideShadows){
// Set shadows
var S=l?v.find(".swiper-slide-shadow-left"):v.find(".swiper-slide-shadow-top"),$=l?v.find(".swiper-slide-shadow-right"):v.find(".swiper-slide-shadow-bottom");0===S.length&&(S=P('<div class="swiper-slide-shadow-'+(l?"left":"top")+'"></div>'),v.append(S)),0===$.length&&($=P('<div class="swiper-slide-shadow-'+(l?"right":"bottom")+'"></div>'),v.append($)),S.length&&(S[0].style.opacity=0<b?b:0),$.length&&($[0].style.opacity=0<-b?-b:0)}}
// Set correct perspective for IE10
(He.pointerEvents||He.prefixedPointerEvents)&&(r[0].style.perspectiveOrigin=c+"px 50%")},setTransition:function e(t){var n;this.slides.transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t)}},Yt,Vt={init:function e(){var t=this,n,i=t.params.thumbs,o=t.constructor;i.swiper instanceof o?(t.thumbs.swiper=i.swiper,Ie.extend(t.thumbs.swiper.originalParams,{watchSlidesProgress:!0,slideToClickedSlide:!1}),Ie.extend(t.thumbs.swiper.params,{watchSlidesProgress:!0,slideToClickedSlide:!1})):Ie.isObject(i.swiper)&&(t.thumbs.swiper=new o(Ie.extend({},i.swiper,{watchSlidesVisibility:!0,watchSlidesProgress:!0,slideToClickedSlide:!1})),t.thumbs.swiperCreated=!0),t.thumbs.swiper.$el.addClass(t.params.thumbs.thumbsContainerClass),t.thumbs.swiper.on("tap",t.thumbs.onThumbClick)},onThumbClick:function e(){var t=this,n=t.thumbs.swiper;if(n){var i=n.clickedIndex,o=n.clickedSlide;if(!(o&&P(o).hasClass(t.params.thumbs.slideThumbActiveClass)||null==i)){var r;if(r=n.params.loop?parseInt(P(n.clickedSlide).attr("data-swiper-slide-index"),10):i,t.params.loop){var a=t.activeIndex;t.slides.eq(a).hasClass(t.params.slideDuplicateClass)&&(t.loopFix(),
// eslint-disable-next-line
t._clientLeft=t.$wrapperEl[0].clientLeft,a=t.activeIndex);var s=t.slides.eq(a).prevAll('[data-swiper-slide-index="'+r+'"]').eq(0).index(),l=t.slides.eq(a).nextAll('[data-swiper-slide-index="'+r+'"]').eq(0).index();r=void 0===s?l:void 0===l?s:l-a<a-s?l:s}t.slideTo(r)}}},update:function e(t){var n=this,i=n.thumbs.swiper;if(i){var o="auto"===i.params.slidesPerView?i.slidesPerViewDynamic():i.params.slidesPerView;if(n.realIndex!==i.realIndex){var r=i.activeIndex,a;if(i.params.loop){i.slides.eq(r).hasClass(i.params.slideDuplicateClass)&&(i.loopFix(),
// eslint-disable-next-line
i._clientLeft=i.$wrapperEl[0].clientLeft,r=i.activeIndex);
// Find actual thumbs index to slide to
var s=i.slides.eq(r).prevAll('[data-swiper-slide-index="'+n.realIndex+'"]').eq(0).index(),l=i.slides.eq(r).nextAll('[data-swiper-slide-index="'+n.realIndex+'"]').eq(0).index();a=void 0===s?l:void 0===l?s:l-r==r-s?r:l-r<r-s?l:s}else a=n.realIndex;i.visibleSlidesIndexes.indexOf(a)<0&&(i.params.centeredSlides?a=r<a?a-Math.floor(o/2)+1:a+Math.floor(o/2)-1:r<a&&(a=a-o+1),i.slideTo(a,t?0:void 0))}
// Activate thumbs
var u=1,c=n.params.thumbs.slideThumbActiveClass;if(1<n.params.slidesPerView&&!n.params.centeredSlides&&(u=n.params.slidesPerView),i.slides.removeClass(c),i.params.loop)for(var d=0;d<u;d+=1)i.$wrapperEl.children('[data-swiper-slide-index="'+(n.realIndex+d)+'"]').addClass(c);else for(var f=0;f<u;f+=1)i.slides.eq(n.realIndex+f).addClass(c)}}},Xt,Ut=[rt,at,st,lt,ct,ft,ht,{name:"mousewheel",params:{mousewheel:{enabled:!1,releaseOnEdges:!1,invert:!1,forceToAxis:!1,sensitivity:1,eventsTarged:"container"}},create:function e(){var t=this;Ie.extend(t,{mousewheel:{enabled:!1,enable:mt.enable.bind(t),disable:mt.disable.bind(t),handle:mt.handle.bind(t),handleMouseEnter:mt.handleMouseEnter.bind(t),handleMouseLeave:mt.handleMouseLeave.bind(t),lastScrollTime:Ie.now()}})},on:{init:function e(){var t=this;t.params.mousewheel.enabled&&t.mousewheel.enable()},destroy:function e(){var t=this;t.mousewheel.enabled&&t.mousewheel.disable()}}},{name:"navigation",params:{navigation:{nextEl:null,prevEl:null,hideOnClick:!1,disabledClass:"swiper-button-disabled",hiddenClass:"swiper-button-hidden",lockClass:"swiper-button-lock"}},create:function e(){var t=this;Ie.extend(t,{navigation:{init:gt.init.bind(t),update:gt.update.bind(t),destroy:gt.destroy.bind(t),onNextClick:gt.onNextClick.bind(t),onPrevClick:gt.onPrevClick.bind(t)}})},on:{init:function e(){var t=this;t.navigation.init(),t.navigation.update()},toEdge:function e(){var t;this.navigation.update()},fromEdge:function e(){var t;this.navigation.update()},destroy:function e(){var t;this.navigation.destroy()},click:function e(t){var n=this,i=n.navigation,o=i.$nextEl,r=i.$prevEl;!n.params.navigation.hideOnClick||P(t.target).is(r)||P(t.target).is(o)||(o&&o.toggleClass(n.params.navigation.hiddenClass),r&&r.toggleClass(n.params.navigation.hiddenClass))}}},{name:"pagination",params:{pagination:{el:null,bulletElement:"span",clickable:!1,hideOnClick:!1,renderBullet:null,renderProgressbar:null,renderFraction:null,renderCustom:null,progressbarOpposite:!1,type:"bullets",// 'bullets' or 'progressbar' or 'fraction' or 'custom'
...
// Read
for(var r=e?void 0:{},a=document.cookie?document.cookie.split("; "):[],s=0,l=a.length
// To prevent the for loop in the first place assign an empty array
// in case there are no cookies at all. Also prevents odd result when
// calling $.cookie().
;s<l;s++){var u=a[s].split("="),c=h(u.shift()),d=u.join("=");if(e&&e===c){
// If second argument (value) is a function it's a converter...
r=v(d,t);break}
// Prevent storing a cookie that we couldn't decode.
e||void 0===(d=v(d))||(r[c]=d)}return r};g.defaults={},f.removeCookie=function(e,t){return void 0!==f.cookie(e)&&(
